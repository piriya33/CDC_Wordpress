<div class="d4p-information">
    <div class="d4p-plugin" style="margin-top: 1em;">
        ...
        <a target="_blank" href="https://tools.dev4press.com/"><?php _e("Plugin Home Website", "gd-bbpress-tools"); ?></a><br/>
        <a target="_blank" href="https://plugins.dev4press.com/gd-press-tools/"><?php _e("Home on Dev4Press", "gd-bbpress-tools"); ?></a>
    </div>
    ...
    <div class="d4p-plugin" style="margin-top: 1em; border-bottom: none;">
        ...
        <a target="_blank" href="https://rating.dev4press.com/"><?php _e("Plugin Home Website", "gd-bbpress-tools"); ?></a><br/>
        <a target="_blank" href="https://plugins.dev4press.com/gd-rating-system/"><?php _e("Home on Dev4Press", "gd-bbpress-tools"); ?></a>
    </div>
</div>
