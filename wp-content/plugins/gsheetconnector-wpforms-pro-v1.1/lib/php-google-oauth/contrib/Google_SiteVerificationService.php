 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $siteVerificationService = new WPFGSC_Google_SiteVerificationService(...);
   *   $webResource = $siteVerificationService->webResource;
   *  </code>
   */
  class WPFGSC_Google_WebResourceServiceResource extends WPFGSC_Google_ServiceResource {
     ...
     * @param WPFGSC_Google_SiteVerificationWebResourceResource $postBody
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_SiteVerificationWebResourceResource
     */
    public function insert($verificationMethod, WPFGSC_Google_SiteVerificationWebResourceResource $postBody, $optParams = array()) {
      $params = array('verificationMethod' => $verificationMethod, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_SiteVerificationWebResourceResource($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_SiteVerificationWebResourceListResponse
     */
    public function listWebResource($optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new WPFGSC_Google_SiteVerificationWebResourceListResponse($data);
      } else {
        return $data;
      }
    }
     ...
     * @return WPFGSC_Google_SiteVerificationWebResourceResource
     */
    public function update($id, WPFGSC_Google_SiteVerificationWebResourceResource $postBody, $optParams = array()) {
     ...
     * @return WPFGSC_Google_SiteVerificationWebResourceResource
     */
    public function patch($id, WPFGSC_Google_SiteVerificationWebResourceResource $postBody, $optParams = array()) {
      $params = array('id' => $id, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
     ...
     *
     * @param WPFGSC_Google_SiteVerificationWebResourceGettokenRequest $postBody
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_SiteVerificationWebResourceGettokenResponse
     */
    public function getToken(WPFGSC_Google_SiteVerificationWebResourceGettokenRequest $postBody, $optParams = array()) {
      $params = array('postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('getToken', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_SiteVerificationWebResourceGettokenResponse($data);
      } else {
        return $data;
      }
    }
 ...
 * @author Google, Inc.
 */
class WPFGSC_Google_SiteVerificationService extends WPFGSC_Google_Service {
  public $webResource;
  /**
...
class WPFGSC_Google_SiteVerificationWebResourceGettokenRequest extends WPFGSC_Google_Model {
  ...
  public function setSite(WPFGSC_Google_SiteVerificationWebResourceGettokenRequestSite $site) {
    $this->site = $site;
  }
...
class WPFGSC_Google_SiteVerificationWebResourceGettokenRequestSite extends WPFGSC_Google_Model {
  public $identifier;
  public $type;
...
class WPFGSC_Google_SiteVerificationWebResourceGettokenResponse extends WPFGSC_Google_Model {
  public $token;
  public $method;
...
class WPFGSC_Google_SiteVerificationWebResourceListResponse extends WPFGSC_Google_Model {
  protected $__itemsType = 'WPFGSC_Google_SiteVerificationWebResourceResource';
  protected $__itemsDataType = 'array';
  public $items;
  public function setItems(/* array(WPFGSC_Google_SiteVerificationWebResourceResource) */ $items) {
    $this->assertIsArray($items, 'WPFGSC_Google_SiteVerificationWebResourceResource', __METHOD__);
    $this->items = $items;
  }
...
class WPFGSC_Google_SiteVerificationWebResourceResource extends WPFGSC_Google_Model {
  public $owners;
  public $id;
  protected $__siteType = 'WPFGSC_Google_SiteVerificationWebResourceResourceSite';
  protected $__siteDataType = '';
  public $site;
  ...
  public function setSite(WPFGSC_Google_SiteVerificationWebResourceResourceSite $site) {
    $this->site = $site;
  }
  public function getSite() {
    return $this->site;
...
class WPFGSC_Google_SiteVerificationWebResourceResourceSite extends WPFGSC_Google_Model {
  public $identifier;
  public $type;
  public function setIdentifier($identifier) {
    $this->identifier = $identifier;
