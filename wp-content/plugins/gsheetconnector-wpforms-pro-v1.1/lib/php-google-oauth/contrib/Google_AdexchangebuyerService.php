 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $adexchangebuyerService = new WPFGSC_Google_AdexchangebuyerService(...);
  ...
  class WPFGSC_Google_AccountsServiceResource extends WPFGSC_Google_ServiceResource {
     ...
     *
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_AccountsList
     */
    public function listAccounts($optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new WPFGSC_Google_AccountsList($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param int $id The account id
     * @param WPFGSC_Google_Account $postBody
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_Account
     */
    public function patch($id, WPFGSC_Google_Account $postBody, $optParams = array()) {
     ...
     * @return WPFGSC_Google_Account
     */
    public function update($id, WPFGSC_Google_Account $postBody, $optParams = array()) {
      $params = array('id' => $id, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class WPFGSC_Google_CreativesServiceResource extends WPFGSC_Google_ServiceResource {
    ...
    public function get($accountId, $buyerCreativeId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_Creative($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param WPFGSC_Google_Creative $postBody
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_Creative
     */
    public function insert( WPFGSC_Google_Creative $postBody, $optParams = array()) {
     ...
     * @return WPFGSC_Google_CreativesList
     */
    public function listCreatives($optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_CreativesList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class WPFGSC_Google_DirectDealsServiceResource extends WPFGSC_Google_ServiceResource {
     ...
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_DirectDeal
     */
    public function get($id, $optParams = array()) {
      $params = array('id' => $id);
      $params = array_merge($params, $optParams);
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_DirectDeal($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_DirectDealsList
     */
    public function listDirectDeals($optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_DirectDealsList($data);
      } else {
        return $data;
      }
    }
 ...
 * @author Google, Inc.
 */
class WPFGSC_Google_AdexchangebuyerService extends WPFGSC_Google_Service {
  public $accounts;
  public $creatives;
  public $directDeals;
  /**
...
class WPFGSC_Google_Account extends WPFGSC_Google_Model {
  ...
  public function setBidderLocation(/* array(WPFGSC_Google_AccountBidderLocation) */ $bidderLocation) {
    $this->assertIsArray($bidderLocation, 'WPFGSC_Google_AccountBidderLocation', __METHOD__);
...
class WPFGSC_Google_AccountBidderLocation extends WPFGSC_Google_Model {
  public $maximumQps;
  public $region;
  public $url;
...
class WPFGSC_Google_AccountsList extends WPFGSC_Google_Model {
...
class WPFGSC_Google_Creative extends WPFGSC_Google_Model {
  public $HTMLSnippet;
  public $accountId;
  public $advertiserId;
...
class WPFGSC_Google_CreativesList extends WPFGSC_Google_Model {
  protected $__itemsType = 'WPFGSC_Google_Creative';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $nextPageToken;
  public function setItems(/* array(WPFGSC_Google_Creative) */ $items) {
    $this->assertIsArray($items, 'WPFGSC_Google_Creative', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class WPFGSC_Google_DirectDeal extends WPFGSC_Google_Model {
  public $accountId;
  public $advertiser;
  public $currencyCode;
  public $endTime;
...
class WPFGSC_Google_DirectDealsList extends WPFGSC_Google_Model {
  protected $__directDealsType = 'WPFGSC_Google_DirectDeal';
  protected $__directDealsDataType = 'array';
  public $directDeals;
  public $kind;
  public function setDirectDeals(/* array(WPFGSC_Google_DirectDeal) */ $directDeals) {
    $this->assertIsArray($directDeals, 'WPFGSC_Google_DirectDeal', __METHOD__);
