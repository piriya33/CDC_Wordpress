 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $bloggerService = new WPFGSC_Google_BloggerService(...);
   *   $blogs = $bloggerService->blogs;
   *  </code>
   */
  class WPFGSC_Google_BlogsServiceResource extends WPFGSC_Google_ServiceResource {
    ...
    public function listByUser($userId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new WPFGSC_Google_BlogList($data);
      } else {
        return $data;
      }
    }
    ...
    public function getByUrl($optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new WPFGSC_Google_Blog($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class WPFGSC_Google_PostsServiceResource extends WPFGSC_Google_ServiceResource {
     ...
     * @param WPFGSC_Google_Post $postBody
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_Post
     */
    public function insert($blogId, WPFGSC_Google_Post $postBody, $optParams = array()) {
      $params = array('blogId' => $blogId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_Post($data);
      } else {
        return $data;
      }
    }
    ...
    public function search($blogId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new WPFGSC_Google_PostList($data);
      } else {
        return $data;
      }
    }
     ...
     * @return WPFGSC_Google_Post
     */
    public function update($blogId, $postId, WPFGSC_Google_Post $postBody, $optParams = array()) {
     ...
     * @return WPFGSC_Google_Post
     */
    public function patch($blogId, $postId, WPFGSC_Google_Post $postBody, $optParams = array()) {
      $params = array('blogId' => $blogId, 'postId' => $postId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class WPFGSC_Google_PagesServiceResource extends WPFGSC_Google_ServiceResource {
    ...
    public function listPages($blogId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_PageList($data);
      } else {
        return $data;
      }
    }
    ...
    public function get($blogId, $pageId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_Page($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class WPFGSC_Google_UsersServiceResource extends WPFGSC_Google_ServiceResource {
    ...
    public function get($userId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_User($data);
      } else {
        return $data;
      }
    }
 ...
 * @author Google, Inc.
 */
class WPFGSC_Google_BloggerService extends WPFGSC_Google_Service {
  public $blogs;
  public $posts;
  public $pages;
  public $comments;
  ...
  public function __construct(WPFGSC_Google_Client $client) {
    ...
    $this->users = new WPFGSC_Google_UsersServiceResource($this, $this->serviceName, 'users', json_decode('{"methods": {"get": {"scopes": ["https://www.googleapis.com/auth/blogger", "https://www.googleapis.com/auth/blogger.readonly"], "parameters": {"userId": {"required": true, "type": "string", "location": "path"}}, "id": "blogger.users.get", "httpMethod": "GET", "path": "users/{userId}", "response": {"$ref": "User"}}}}', true));

  }
}

class WPFGSC_Google_Blog extends WPFGSC_Google_Model {
  public $kind;
  public $description;
  protected $__localeType = 'WPFGSC_Google_BlogLocale';
  protected $__localeDataType = '';
  public $locale;
  protected $__postsType = 'WPFGSC_Google_BlogPosts';
  protected $__postsDataType = '';
  public $posts;
  public $customMetaData;
  public $updated;
  protected $__pagesType = 'WPFGSC_Google_BlogPages';
  ...
  public function setLocale(WPFGSC_Google_BlogLocale $locale) {
    $this->locale = $locale;
  }
  public function getLocale() {
    return $this->locale;
  }
  public function setPosts(WPFGSC_Google_BlogPosts $posts) {
    $this->posts = $posts;
  }
  ...
  public function setPages(WPFGSC_Google_BlogPages $pages) {
    $this->pages = $pages;
  }
...
class WPFGSC_Google_BlogList extends WPFGSC_Google_Model {
  protected $__itemsType = 'WPFGSC_Google_Blog';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(WPFGSC_Google_Blog) */ $items) {
    $this->assertIsArray($items, 'WPFGSC_Google_Blog', __METHOD__);
    $this->items = $items;
  }
...
class WPFGSC_Google_BlogLocale extends WPFGSC_Google_Model {
  public $country;
  public $variant;
  public $language;
...
class WPFGSC_Google_BlogPages extends WPFGSC_Google_Model {
  public $totalItems;
  public $selfLink;
...
class WPFGSC_Google_BlogPosts extends WPFGSC_Google_Model {
  public $totalItems;
  protected $__itemsType = 'WPFGSC_Google_Post';
  protected $__itemsDataType = 'array';
  public $items;
  public $selfLink;
  public function setTotalItems($totalItems) {
  ...
  public function setItems(/* array(WPFGSC_Google_Post) */ $items) {
    $this->assertIsArray($items, 'WPFGSC_Google_Post', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class WPFGSC_Google_Comment extends WPFGSC_Google_Model {
  ...
  public $inReplyTo;
  protected $__authorType = 'WPFGSC_Google_CommentAuthor';
  protected $__authorDataType = '';
  public $author;
  public $updated;
  protected $__blogType = 'WPFGSC_Google_CommentBlog';
  protected $__blogDataType = '';
  public $blog;
  public $published;
  protected $__postType = 'WPFGSC_Google_CommentPost';
  ...
  public function setAuthor(WPFGSC_Google_CommentAuthor $author) {
    $this->author = $author;
  }
  ...
  public function setBlog(WPFGSC_Google_CommentBlog $blog) {
    $this->blog = $blog;
  }
  ...
  public function setPost(WPFGSC_Google_CommentPost $post) {
    $this->post = $post;
  }
...
class WPFGSC_Google_CommentAuthor extends WPFGSC_Google_Model {
  public $url;
  protected $__imageType = 'WPFGSC_Google_CommentAuthorImage';
  ...
  public function setImage(WPFGSC_Google_CommentAuthorImage $image) {
    $this->image = $image;
  }
...
class WPFGSC_Google_CommentAuthorImage extends WPFGSC_Google_Model {
  public $url;
  public function setUrl($url) {
    $this->url = $url;
  }
...
class WPFGSC_Google_CommentBlog extends WPFGSC_Google_Model {
  public $id;
  public function setId($id) {
    $this->id = $id;
  }
...
class WPFGSC_Google_CommentPost extends WPFGSC_Google_Model {
  public $id;
  public function setId($id) {
    $this->id = $id;
  }
...
class WPFGSC_Google_Page extends WPFGSC_Google_Model {
  public $content;
  public $kind;
  protected $__authorType = 'WPFGSC_Google_PageAuthor';
  protected $__authorDataType = '';
  public $author;
  public $url;
  public $title;
  public $updated;
  protected $__blogType = 'WPFGSC_Google_PageBlog';
  protected $__blogDataType = '';
  public $blog;
  public $published;
  public $id;
  ...
  public function setAuthor(WPFGSC_Google_PageAuthor $author) {
    $this->author = $author;
  }
  public function getAuthor() {
    return $this->author;
  ...
  public function setBlog(WPFGSC_Google_PageBlog $blog) {
    $this->blog = $blog;
  }
  public function getBlog() {
    return $this->blog;
...
class WPFGSC_Google_PageAuthor extends WPFGSC_Google_Model {
  public $url;
  protected $__imageType = 'WPFGSC_Google_PageAuthorImage';
  protected $__imageDataType = '';
  public $image;
  public $displayName;
  public $id;
  ...
  public function setImage(WPFGSC_Google_PageAuthorImage $image) {
    $this->image = $image;
  }
  public function getImage() {
    return $this->image;
...
class WPFGSC_Google_PageAuthorImage extends WPFGSC_Google_Model {
  public $url;
  public function setUrl($url) {
    $this->url = $url;
  }
...
class WPFGSC_Google_PageBlog extends WPFGSC_Google_Model {
  public $id;
  public function setId($id) {
    $this->id = $id;
  }
...
class WPFGSC_Google_PageList extends WPFGSC_Google_Model {
  protected $__itemsType = 'WPFGSC_Google_Page';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(WPFGSC_Google_Page) */ $items) {
    $this->assertIsArray($items, 'WPFGSC_Google_Page', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class WPFGSC_Google_Post extends WPFGSC_Google_Model {
  public $content;
  public $kind;
  protected $__authorType = 'WPFGSC_Google_PostAuthor';
  protected $__authorDataType = '';
  public $author;
  protected $__repliesType = 'WPFGSC_Google_PostReplies';
  protected $__repliesDataType = '';
  public $replies;
  public $labels;
  public $customMetaData;
  public $updated;
  protected $__blogType = 'WPFGSC_Google_PostBlog';
  protected $__blogDataType = '';
  public $blog;
  public $url;
  protected $__locationType = 'WPFGSC_Google_PostLocation';
  ...
  public function setAuthor(WPFGSC_Google_PostAuthor $author) {
    $this->author = $author;
  }
  public function getAuthor() {
    return $this->author;
  }
  public function setReplies(WPFGSC_Google_PostReplies $replies) {
  ...
  public function setBlog(WPFGSC_Google_PostBlog $blog) {
    $this->blog = $blog;
  }
  public function getBlog() {
    return $this->blog;
  ...
  public function setLocation(WPFGSC_Google_PostLocation $location) {
...
class WPFGSC_Google_PostAuthor extends WPFGSC_Google_Model {
  public $url;
  protected $__imageType = 'WPFGSC_Google_PostAuthorImage';
  protected $__imageDataType = '';
  public $image;
  public $displayName;
  public $id;
  ...
  public function setImage(WPFGSC_Google_PostAuthorImage $image) {
    $this->image = $image;
  }
  public function getImage() {
    return $this->image;
...
class WPFGSC_Google_PostAuthorImage extends WPFGSC_Google_Model {
  public $url;
  public function setUrl($url) {
    $this->url = $url;
  }
...
class WPFGSC_Google_PostBlog extends WPFGSC_Google_Model {
  public $id;
  public function setId($id) {
    $this->id = $id;
  }
...
class WPFGSC_Google_PostList extends WPFGSC_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'WPFGSC_Google_Post';
  protected $__itemsDataType = 'array';
  public $items;
...
class WPFGSC_Google_PostLocation extends WPFGSC_Google_Model {
  public $lat;
  public $lng;
  public $span;
  public $name;
...
class WPFGSC_Google_PostReplies extends WPFGSC_Google_Model {
  public $totalItems;
  protected $__itemsType = 'WPFGSC_Google_Comment';
  protected $__itemsDataType = 'array';
  public $items;
...
class WPFGSC_Google_User extends WPFGSC_Google_Model {
  ...
  public $displayName;
  public $created;
  protected $__localeType = 'WPFGSC_Google_UserLocale';
  protected $__localeDataType = '';
  public $locale;
  protected $__blogsType = 'WPFGSC_Google_UserBlogs';
  ...
  public function setLocale(WPFGSC_Google_UserLocale $locale) {
    $this->locale = $locale;
  }
  public function getLocale() {
    return $this->locale;
  }
  public function setBlogs(WPFGSC_Google_UserBlogs $blogs) {
    $this->blogs = $blogs;
  }
...
class WPFGSC_Google_UserBlogs extends WPFGSC_Google_Model {
  public $selfLink;
  public function setSelfLink($selfLink) {
    $this->selfLink = $selfLink;
  }
...
class WPFGSC_Google_UserLocale extends WPFGSC_Google_Model {
  public $country;
  public $variant;
  public $language;
  public function setCountry($country) {
