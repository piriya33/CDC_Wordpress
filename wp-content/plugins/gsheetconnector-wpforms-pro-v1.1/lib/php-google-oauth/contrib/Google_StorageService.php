 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $storageService = new WPFGSC_Google_StorageService(...);
   *   $objectAccessControls = $storageService->objectAccessControls;
   *  </code>
   */
  class WPFGSC_Google_ObjectAccessControlsServiceResource extends WPFGSC_Google_ServiceResource {
     ...
     * @param WPFGSC_Google_ObjectAccessControl $postBody
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_ObjectAccessControl
     */
    public function insert($bucket, $object, WPFGSC_Google_ObjectAccessControl $postBody, $optParams = array()) {
      $params = array('bucket' => $bucket, 'object' => $object, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_ObjectAccessControl($data);
      } else {
        return $data;
      }
    }
     ...
     * @param string $object Name of the object.
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_ObjectAccessControls
     */
    public function listObjectAccessControls($bucket, $object, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new WPFGSC_Google_ObjectAccessControls($data);
      } else {
        return $data;
      }
    }
     ...
     * @return WPFGSC_Google_ObjectAccessControl
     */
    public function update($bucket, $object, $entity, WPFGSC_Google_ObjectAccessControl $postBody, $optParams = array()) {
     ...
     * @return WPFGSC_Google_ObjectAccessControl
     */
    public function patch($bucket, $object, $entity, WPFGSC_Google_ObjectAccessControl $postBody, $optParams = array()) {
      $params = array('bucket' => $bucket, 'object' => $object, 'entity' => $entity, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class WPFGSC_Google_BucketAccessControlsServiceResource extends WPFGSC_Google_ServiceResource {
     ...
     *
     * @param string $bucket Name of a bucket.
     * @param WPFGSC_Google_BucketAccessControl $postBody
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_BucketAccessControl
     */
    public function insert($bucket, WPFGSC_Google_BucketAccessControl $postBody, $optParams = array()) {
      $params = array('bucket' => $bucket, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_BucketAccessControl($data);
      } else {
        return $data;
      }
    }
     ...
     * @param string $bucket Name of a bucket.
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_BucketAccessControls
     */
    public function listBucketAccessControls($bucket, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_BucketAccessControls($data);
      } else {
        return $data;
      }
    }
     ...
     * @return WPFGSC_Google_BucketAccessControl
     */
    public function update($bucket, $entity, WPFGSC_Google_BucketAccessControl $postBody, $optParams = array()) {
     ...
     * @return WPFGSC_Google_BucketAccessControl
     */
    public function patch($bucket, $entity, WPFGSC_Google_BucketAccessControl $postBody, $optParams = array()) {
      $params = array('bucket' => $bucket, 'entity' => $entity, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
   ...
   *  </code>
   */
  class WPFGSC_Google_ObjectsServiceResource extends WPFGSC_Google_ServiceResource {
     ...
     * @param WPFGSC_Google_StorageObject $postBody
     * @param array $optParams Optional parameters.
     *
     ...
     * @return WPFGSC_Google_StorageObject
     */
    public function insert($bucket, WPFGSC_Google_StorageObject $postBody, $optParams = array()) {
      $params = array('bucket' => $bucket, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_StorageObject($data);
      } else {
        return $data;
      }
    }
    ...
    public function listObjects($bucket, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_Objects($data);
      } else {
        return $data;
      }
    }
     ...
     * @return WPFGSC_Google_StorageObject
     */
    public function update($bucket, $object, WPFGSC_Google_StorageObject $postBody, $optParams = array()) {
      $params = array('bucket' => $bucket, 'object' => $object, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('update', array($params));
      if ($this->useObjects()) {
     ...
     * @return WPFGSC_Google_StorageObject
     */
    public function patch($bucket, $object, WPFGSC_Google_StorageObject $postBody, $optParams = array()) {
      $params = array('bucket' => $bucket, 'object' => $object, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
   ...
   *  </code>
   */
  class WPFGSC_Google_BucketsServiceResource extends WPFGSC_Google_ServiceResource {


    /**
     * Creates a new bucket. (buckets.insert)
     *
     * @param WPFGSC_Google_Bucket $postBody
     * @param array $optParams Optional parameters.
     *
     ...
     * @return WPFGSC_Google_Bucket
     */
    public function insert(WPFGSC_Google_Bucket $postBody, $optParams = array()) {
      $params = array('postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_Bucket($data);
      } else {
        return $data;
      }
    }
    ...
    public function listBuckets($projectId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_Buckets($data);
      } else {
        return $data;
      }
    }
     ...
     * @return WPFGSC_Google_Bucket
     */
    public function update($bucket, WPFGSC_Google_Bucket $postBody, $optParams = array()) {
      $params = array('bucket' => $bucket, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('update', array($params));
      if ($this->useObjects()) {
     ...
     * @return WPFGSC_Google_Bucket
     */
    public function patch($bucket, WPFGSC_Google_Bucket $postBody, $optParams = array()) {
      $params = array('bucket' => $bucket, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
 ...
 * @author Google, Inc.
 */
class WPFGSC_Google_StorageService extends WPFGSC_Google_Service {
...
class WPFGSC_Google_Bucket extends WPFGSC_Google_Model {
  ...
  public function setAcl(/* array(WPFGSC_Google_BucketAccessControl) */ $acl) {
    $this->assertIsArray($acl, 'WPFGSC_Google_BucketAccessControl', __METHOD__);
    $this->acl = $acl;
  }
  public function getAcl() {
    return $this->acl;
  }
  public function setDefaultObjectAcl(/* array(WPFGSC_Google_ObjectAccessControl) */ $defaultObjectAcl) {
    $this->assertIsArray($defaultObjectAcl, 'WPFGSC_Google_ObjectAccessControl', __METHOD__);
  ...
  public function setOwner(WPFGSC_Google_BucketOwner $owner) {
    $this->owner = $owner;
  }
...
class WPFGSC_Google_BucketAccessControl extends WPFGSC_Google_Model {
  public $domain;
  public $bucket;
  public $kind;
  public $id;
...
class WPFGSC_Google_BucketAccessControls extends WPFGSC_Google_Model {
  protected $__itemsType = 'WPFGSC_Google_BucketAccessControl';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(WPFGSC_Google_BucketAccessControl) */ $items) {
    $this->assertIsArray($items, 'WPFGSC_Google_BucketAccessControl', __METHOD__);
    $this->items = $items;
  }
...
class WPFGSC_Google_BucketOwner extends WPFGSC_Google_Model {
  public $entityId;
  public $entity;
  public function setEntityId($entityId) {
    $this->entityId = $entityId;
...
class WPFGSC_Google_BucketWebsite extends WPFGSC_Google_Model {
  public $notFoundPage;
...
class WPFGSC_Google_Buckets extends WPFGSC_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'WPFGSC_Google_Bucket';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  ...
  public function setItems(/* array(WPFGSC_Google_Bucket) */ $items) {
    $this->assertIsArray($items, 'WPFGSC_Google_Bucket', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class WPFGSC_Google_ObjectAccessControl extends WPFGSC_Google_Model {
  public $domain;
  public $object;
  public $bucket;
  public $kind;
...
class WPFGSC_Google_ObjectAccessControls extends WPFGSC_Google_Model {
  protected $__itemsType = 'WPFGSC_Google_ObjectAccessControl';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(WPFGSC_Google_ObjectAccessControl) */ $items) {
    $this->assertIsArray($items, 'WPFGSC_Google_ObjectAccessControl', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class WPFGSC_Google_Objects extends WPFGSC_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'WPFGSC_Google_StorageObject';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $prefixes;
  ...
  public function setItems(/* array(WPFGSC_Google_StorageObject) */ $items) {
    $this->assertIsArray($items, 'WPFGSC_Google_StorageObject', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class WPFGSC_Google_StorageObject extends WPFGSC_Google_Model {
  public $kind;
  public $name;
  protected $__mediaType = 'WPFGSC_Google_StorageObjectMedia';
  protected $__mediaDataType = '';
  public $media;
  public $bucket;
  public $contentEncoding;
  public $selfLink;
  protected $__ownerType = 'WPFGSC_Google_StorageObjectOwner';
  protected $__ownerDataType = '';
  public $owner;
  public $cacheControl;
  protected $__aclType = 'WPFGSC_Google_ObjectAccessControl';
  protected $__aclDataType = 'array';
  public $acl;
  public $id;
  ...
  public function setMedia(WPFGSC_Google_StorageObjectMedia $media) {
    $this->media = $media;
  }
  ...
  public function setOwner(WPFGSC_Google_StorageObjectOwner $owner) {
    $this->owner = $owner;
  }
  public function getOwner() {
    return $this->owner;
  ...
  public function setAcl(/* array(WPFGSC_Google_ObjectAccessControl) */ $acl) {
    $this->assertIsArray($acl, 'WPFGSC_Google_ObjectAccessControl', __METHOD__);
    $this->acl = $acl;
  }
  public function getAcl() {
    return $this->acl;
...
class WPFGSC_Google_StorageObjectMedia extends WPFGSC_Google_Model {
  public $contentType;
  public $timeCreated;
  public $algorithm;
  public $length;
...
class WPFGSC_Google_StorageObjectOwner extends WPFGSC_Google_Model {
  public $entityId;
  public $entity;
  public function setEntityId($entityId) {
    $this->entityId = $entityId;
