 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $taskqueueService = new WPFGSC_Google_TaskqueueService(...);
   *   $taskqueues = $taskqueueService->taskqueues;
   *  </code>
   */
  class WPFGSC_Google_TaskqueuesServiceResource extends WPFGSC_Google_ServiceResource {
     ...
     * @return WPFGSC_Google_TaskQueue
     */
    public function get($project, $taskqueue, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new WPFGSC_Google_TaskQueue($data);
      } else {
        return $data;
      }
    }
  ...
  class WPFGSC_Google_TasksServiceResource extends WPFGSC_Google_ServiceResource {
     ...
     */
    public function insert($project, $taskqueue, WPFGSC_Google_Task $postBody, $optParams = array()) {
    ...
    public function listTasks($project, $taskqueue, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new WPFGSC_Google_Tasks2($data);
      } else {
        return $data;
      }
    }
     ...
     * @return WPFGSC_Google_Task
     */
    public function update($project, $taskqueue, $task, $newLeaseSeconds, WPFGSC_Google_Task $postBody, $optParams = array()) {
     ...
     * @return WPFGSC_Google_Task
     */
    public function patch($project, $taskqueue, $task, $newLeaseSeconds, WPFGSC_Google_Task $postBody, $optParams = array()) {
      $params = array('project' => $project, 'taskqueue' => $taskqueue, 'task' => $task, 'newLeaseSeconds' => $newLeaseSeconds, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
...
/**
 * Service definition for WPFGSC_Google_TaskQueue (v1beta2).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class WPFGSC_Google_TaskqueueService extends WPFGSC_Google_Service {
  public $taskqueues;
  public $tasks;
  /**
...
class WPFGSC_Google_TaskQueue extends WPFGSC_Google_Model {
  public $kind;
  protected $__statsType = 'WPFGSC_Google_TaskQueueStats';
  protected $__statsDataType = '';
  public $stats;
  public $id;
  public $maxLeases;
  protected $__aclType = 'WPFGSC_Google_TaskQueueAcl';
  ...
  public function setStats(WPFGSC_Google_TaskQueueStats $stats) {
    $this->stats = $stats;
  }
  ...
  public function setAcl(WPFGSC_Google_TaskQueueAcl $acl) {
    $this->acl = $acl;
  }
...
class WPFGSC_Google_TaskQueueAcl extends WPFGSC_Google_Model {
...
class WPFGSC_Google_TaskQueueStats extends WPFGSC_Google_Model {
  public $oldestTask;
...
class WPFGSC_Google_Tasks2 extends WPFGSC_Google_Model {
  protected $__itemsType = 'WPFGSC_Google_Task';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
