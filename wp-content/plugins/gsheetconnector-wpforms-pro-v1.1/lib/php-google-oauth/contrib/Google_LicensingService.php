 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $licensingService = new WPFGSC_Google_LicensingService(...);
   *   $licenseAssignments = $licensingService->licenseAssignments;
   *  </code>
   */
  class WPFGSC_Google_LicenseAssignmentsServiceResource extends WPFGSC_Google_ServiceResource {
     ...
     * @param WPFGSC_Google_LicenseAssignmentInsert $postBody
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_LicenseAssignment
     */
    public function insert($productId, $skuId, WPFGSC_Google_LicenseAssignmentInsert $postBody, $optParams = array()) {
      $params = array('productId' => $productId, 'skuId' => $skuId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_LicenseAssignment($data);
      } else {
        return $data;
      }
    }
     ...
     * @return WPFGSC_Google_LicenseAssignmentList
     */
    public function listForProductAndSku($productId, $skuId, $customerId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new WPFGSC_Google_LicenseAssignmentList($data);
      } else {
        return $data;
      }
    }
     ...
     * @param string $userId email id or unique Id of the user
     * @param WPFGSC_Google_LicenseAssignment $postBody
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_LicenseAssignment
     */
    public function update($productId, $skuId, $userId, WPFGSC_Google_LicenseAssignment $postBody, $optParams = array()) {
     ...
     * @return WPFGSC_Google_LicenseAssignment
     */
    public function patch($productId, $skuId, $userId, WPFGSC_Google_LicenseAssignment $postBody, $optParams = array()) {
      $params = array('productId' => $productId, 'skuId' => $skuId, 'userId' => $userId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
 ...
 * @author Google, Inc.
 */
class WPFGSC_Google_LicensingService extends WPFGSC_Google_Service {
...
class WPFGSC_Google_LicenseAssignmentInsert extends WPFGSC_Google_Model {
  public $userId;
  public function setUserId($userId) {
    $this->userId = $userId;
  }
...
class WPFGSC_Google_LicenseAssignmentList extends WPFGSC_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'WPFGSC_Google_LicenseAssignment';
  ...
  public function setItems(/* array(WPFGSC_Google_LicenseAssignment) */ $items) {
    $this->assertIsArray($items, 'WPFGSC_Google_LicenseAssignment', __METHOD__);
    $this->items = $items;
  }
