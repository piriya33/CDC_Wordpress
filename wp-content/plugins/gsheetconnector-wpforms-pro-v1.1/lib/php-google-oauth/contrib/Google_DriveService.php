 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $driveService = new WPFGSC_Google_DriveService(...);
   *   $about = $driveService->about;
   *  </code>
   */
  class WPFGSC_Google_AboutServiceResource extends WPFGSC_Google_ServiceResource {
    ...
    public function get($optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new WPFGSC_Google_About($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class WPFGSC_Google_AppsServiceResource extends WPFGSC_Google_ServiceResource {
    ...
    public function get($appId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_App($data);
      } else {
        return $data;
      }
    }
    ...
    public function listApps($optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new WPFGSC_Google_AppList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class WPFGSC_Google_ChangesServiceResource extends WPFGSC_Google_ServiceResource {
    ...
    public function get($changeId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_Change($data);
      } else {
        return $data;
      }
    }
     ...
     * @return WPFGSC_Google_ChangeList
     */
    public function listChanges($optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_ChangeList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class WPFGSC_Google_ChildrenServiceResource extends WPFGSC_Google_ServiceResource {
     ...
     * @param string $childId The ID of the child.
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_ChildReference
     */
    public function get($folderId, $childId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_ChildReference($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param string $folderId The ID of the folder.
     * @param WPFGSC_Google_ChildReference $postBody
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_ChildReference
     */
    public function insert($folderId, WPFGSC_Google_ChildReference $postBody, $optParams = array()) {
     ...
     * @return WPFGSC_Google_ChildList
     */
    public function listChildren($folderId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_ChildList($data);
      } else {
        return $data;
      }
    }
  ...
  class WPFGSC_Google_CommentsServiceResource extends WPFGSC_Google_ServiceResource {
     ...
     * @return WPFGSC_Google_Comment
     */
    public function insert($fileId, WPFGSC_Google_Comment $postBody, $optParams = array()) {
     ...
     * @return WPFGSC_Google_Comment
     */
    public function patch($fileId, $commentId, WPFGSC_Google_Comment $postBody, $optParams = array()) {
     ...
     * @return WPFGSC_Google_Comment
     */
    public function update($fileId, $commentId, WPFGSC_Google_Comment $postBody, $optParams = array()) {
      $params = array('fileId' => $fileId, 'commentId' => $commentId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
  ...
  class WPFGSC_Google_FilesServiceResource extends WPFGSC_Google_ServiceResource {
     ...
     * @param WPFGSC_Google_DriveFile $postBody
     * @param array $optParams Optional parameters.
     *
     ...
     * @return WPFGSC_Google_DriveFile
     */
    public function copy($fileId, WPFGSC_Google_DriveFile $postBody, $optParams = array()) {
      $params = array('fileId' => $fileId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('copy', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_DriveFile($data);
      } else {
        return $data;
      }
    }
     ...
     * @return WPFGSC_Google_DriveFile
     */
    public function insert(WPFGSC_Google_DriveFile $postBody, $optParams = array()) {
     ...
     * @return WPFGSC_Google_DriveFile
     */
    public function patch($fileId, WPFGSC_Google_DriveFile $postBody, $optParams = array()) {
      $params = array('fileId' => $fileId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
     ...
     * @return WPFGSC_Google_DriveFile
     */
    public function update($fileId, WPFGSC_Google_DriveFile $postBody, $optParams = array()) {
      $params = array('fileId' => $fileId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('update', array($params));
      if ($this->useObjects()) {
   ...
   *  </code>
   */
  class WPFGSC_Google_ParentsServiceResource extends WPFGSC_Google_ServiceResource {
     ...
     * @param string $parentId The ID of the parent.
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_ParentReference
     */
    public function get($fileId, $parentId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_ParentReference($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param string $fileId The ID of the file.
     * @param WPFGSC_Google_ParentReference $postBody
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_ParentReference
     */
    public function insert($fileId, WPFGSC_Google_ParentReference $postBody, $optParams = array()) {
      $params = array('fileId' => $fileId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
     ...
     * @param string $fileId The ID of the file.
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_ParentList
     */
    public function listParents($fileId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_ParentList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class WPFGSC_Google_PermissionsServiceResource extends WPFGSC_Google_ServiceResource {
     ...
     * @param string $permissionId The ID for the permission.
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_Permission
     */
    public function get($fileId, $permissionId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_Permission($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param string $fileId The ID for the file.
     * @param WPFGSC_Google_Permission $postBody
     * @param array $optParams Optional parameters.
     *
     * @opt_param bool sendNotificationEmails Whether to send notification emails.
     * @return WPFGSC_Google_Permission
     */
    public function insert($fileId, WPFGSC_Google_Permission $postBody, $optParams = array()) {
      $params = array('fileId' => $fileId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
     ...
     * @param string $fileId The ID for the file.
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_PermissionList
     */
    public function listPermissions($fileId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_PermissionList($data);
      } else {
        return $data;
      }
    }
     ...
     * @return WPFGSC_Google_Permission
     */
    public function patch($fileId, $permissionId, WPFGSC_Google_Permission $postBody, $optParams = array()) {
     ...
     * @return WPFGSC_Google_Permission
     */
    public function update($fileId, $permissionId, WPFGSC_Google_Permission $postBody, $optParams = array()) {
      $params = array('fileId' => $fileId, 'permissionId' => $permissionId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('update', array($params));
      if ($this->useObjects()) {
   ...
   *  </code>
   */
  class WPFGSC_Google_RepliesServiceResource extends WPFGSC_Google_ServiceResource {
     ...
     * @return WPFGSC_Google_CommentReply
     */
    public function get($fileId, $commentId, $replyId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_CommentReply($data);
      } else {
        return $data;
      }
    }
     ...
     * @param string $fileId The ID of the file.
     * @param string $commentId The ID of the comment.
     * @param WPFGSC_Google_CommentReply $postBody
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_CommentReply
     */
    public function insert($fileId, $commentId, WPFGSC_Google_CommentReply $postBody, $optParams = array()) {
      $params = array('fileId' => $fileId, 'commentId' => $commentId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
     ...
     * @opt_param string pageToken The continuation token, used to page through large result sets. To get the next page of results, set this parameter to the value of "nextPageToken" from the previous response.
     * @return WPFGSC_Google_CommentReplyList
     */
    public function listReplies($fileId, $commentId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_CommentReplyList($data);
      } else {
        return $data;
      }
    }
     ...
     * @return WPFGSC_Google_CommentReply
     */
    public function patch($fileId, $commentId, $replyId, WPFGSC_Google_CommentReply $postBody, $optParams = array()) {
     ...
     * @return WPFGSC_Google_CommentReply
     */
    public function update($fileId, $commentId, $replyId, WPFGSC_Google_CommentReply $postBody, $optParams = array()) {
      $params = array('fileId' => $fileId, 'commentId' => $commentId, 'replyId' => $replyId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('update', array($params));
      if ($this->useObjects()) {
   ...
   *  </code>
   */
  class WPFGSC_Google_RevisionsServiceResource extends WPFGSC_Google_ServiceResource {
    ...
    public function get($fileId, $revisionId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_Revision($data);
      } else {
        return $data;
      }
    }
     ...
     * @param string $fileId The ID of the file.
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_RevisionList
     */
    public function listRevisions($fileId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_RevisionList($data);
      } else {
        return $data;
      }
    }
     ...
     * @param WPFGSC_Google_Revision $postBody
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_Revision
     */
    public function patch($fileId, $revisionId, WPFGSC_Google_Revision $postBody, $optParams = array()) {
     ...
     * @return WPFGSC_Google_Revision
     */
    public function update($fileId, $revisionId, WPFGSC_Google_Revision $postBody, $optParams = array()) {
      $params = array('fileId' => $fileId, 'revisionId' => $revisionId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('update', array($params));
      if ($this->useObjects()) {
 ...
 * @author Google, Inc.
 */
class WPFGSC_Google_DriveService extends WPFGSC_Google_Service {
  public $about;
  public $apps;
  public $changes;
  public $children;
...
class WPFGSC_Google_About extends WPFGSC_Google_Model {
  ...
  public $rootFolderId;
  public $selfLink;
  protected $__userType = 'WPFGSC_Google_User';
  protected $__userDataType = '';
  public $user;
  public function setAdditionalRoleInfo(/* array(WPFGSC_Google_AboutAdditionalRoleInfo) */ $additionalRoleInfo) {
    $this->assertIsArray($additionalRoleInfo, 'WPFGSC_Google_AboutAdditionalRoleInfo', __METHOD__);
  ...
  public function setExportFormats(/* array(WPFGSC_Google_AboutExportFormats) */ $exportFormats) {
    $this->assertIsArray($exportFormats, 'WPFGSC_Google_AboutExportFormats', __METHOD__);
    $this->exportFormats = $exportFormats;
  }
  public function getExportFormats() {
    return $this->exportFormats;
  }
  public function setFeatures(/* array(WPFGSC_Google_AboutFeatures) */ $features) {
    $this->assertIsArray($features, 'WPFGSC_Google_AboutFeatures', __METHOD__);
    $this->features = $features;
  }
  public function getFeatures() {
    return $this->features;
  }
  public function setImportFormats(/* array(WPFGSC_Google_AboutImportFormats) */ $importFormats) {
    $this->assertIsArray($importFormats, 'WPFGSC_Google_AboutImportFormats', __METHOD__);
  ...
  public function setMaxUploadSizes(/* array(WPFGSC_Google_AboutMaxUploadSizes) */ $maxUploadSizes) {
    $this->assertIsArray($maxUploadSizes, 'WPFGSC_Google_AboutMaxUploadSizes', __METHOD__);
  ...
  public function setUser(WPFGSC_Google_User $user) {
    $this->user = $user;
  }
...
class WPFGSC_Google_AboutAdditionalRoleInfo extends WPFGSC_Google_Model {
  protected $__roleSetsType = 'WPFGSC_Google_AboutAdditionalRoleInfoRoleSets';
  protected $__roleSetsDataType = 'array';
  public $roleSets;
  public $type;
  public function setRoleSets(/* array(WPFGSC_Google_AboutAdditionalRoleInfoRoleSets) */ $roleSets) {
    $this->assertIsArray($roleSets, 'WPFGSC_Google_AboutAdditionalRoleInfoRoleSets', __METHOD__);
...
class WPFGSC_Google_AboutAdditionalRoleInfoRoleSets extends WPFGSC_Google_Model {
...
class WPFGSC_Google_AboutExportFormats extends WPFGSC_Google_Model {
  public $source;
  public $targets;
...
class WPFGSC_Google_AboutFeatures extends WPFGSC_Google_Model {
  public $featureName;
  public $featureRate;
...
class WPFGSC_Google_AboutImportFormats extends WPFGSC_Google_Model {
  public $source;
  public $targets;
  public function setSource($source) {
    $this->source = $source;
...
class WPFGSC_Google_AboutMaxUploadSizes extends WPFGSC_Google_Model {
  public $size;
  public $type;
...
class WPFGSC_Google_App extends WPFGSC_Google_Model {
  public $authorized;
  protected $__iconsType = 'WPFGSC_Google_AppIcons';
  ...
  public function setIcons(/* array(WPFGSC_Google_AppIcons) */ $icons) {
    $this->assertIsArray($icons, 'WPFGSC_Google_AppIcons', __METHOD__);
    $this->icons = $icons;
  }
...
class WPFGSC_Google_AppIcons extends WPFGSC_Google_Model {
  public $category;
  public $iconUrl;
  public $size;
...
class WPFGSC_Google_AppList extends WPFGSC_Google_Model {
  public $etag;
  protected $__itemsType = 'WPFGSC_Google_App';
  ...
  public function setItems(/* array(WPFGSC_Google_App) */ $items) {
    $this->assertIsArray($items, 'WPFGSC_Google_App', __METHOD__);
    $this->items = $items;
  }
...
class WPFGSC_Google_Change extends WPFGSC_Google_Model {
  public $deleted;
  protected $__fileType = 'WPFGSC_Google_DriveFile';
  ...
  public function setFile(WPFGSC_Google_DriveFile $file) {
    $this->file = $file;
  }
...
class WPFGSC_Google_ChangeList extends WPFGSC_Google_Model {
  public $etag;
  protected $__itemsType = 'WPFGSC_Google_Change';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $largestChangeId;
  ...
  public function setItems(/* array(WPFGSC_Google_Change) */ $items) {
    $this->assertIsArray($items, 'WPFGSC_Google_Change', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class WPFGSC_Google_ChildList extends WPFGSC_Google_Model {
  public $etag;
  protected $__itemsType = 'WPFGSC_Google_ChildReference';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $nextLink;
  ...
  public function setItems(/* array(WPFGSC_Google_ChildReference) */ $items) {
    $this->assertIsArray($items, 'WPFGSC_Google_ChildReference', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class WPFGSC_Google_ChildReference extends WPFGSC_Google_Model {
  public $childLink;
  public $id;
  public $kind;
  public $selfLink;
...
class WPFGSC_Google_Comment extends WPFGSC_Google_Model {
  public $anchor;
  protected $__authorType = 'WPFGSC_Google_User';
  protected $__authorDataType = '';
  public $author;
  public $commentId;
  public $content;
  protected $__contextType = 'WPFGSC_Google_CommentContext';
  ...
  public $kind;
  public $modifiedDate;
  protected $__repliesType = 'WPFGSC_Google_CommentReply';
  ...
  public function setAuthor(WPFGSC_Google_User $author) {
    $this->author = $author;
  }
  ...
  public function setContext(WPFGSC_Google_CommentContext $context) {
  ...
  public function setReplies(/* array(WPFGSC_Google_CommentReply) */ $replies) {
    $this->assertIsArray($replies, 'WPFGSC_Google_CommentReply', __METHOD__);
...
class WPFGSC_Google_CommentContext extends WPFGSC_Google_Model {
  public $type;
  public $value;
  public function setType($type) {
    $this->type = $type;
...
class WPFGSC_Google_CommentReply extends WPFGSC_Google_Model {
  protected $__authorType = 'WPFGSC_Google_User';
  protected $__authorDataType = '';
  public $author;
  public $content;
...
class WPFGSC_Google_CommentReplyList extends WPFGSC_Google_Model {
  protected $__itemsType = 'WPFGSC_Google_CommentReply';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $nextPageToken;
  public function setItems(/* array(WPFGSC_Google_CommentReply) */ $items) {
    $this->assertIsArray($items, 'WPFGSC_Google_CommentReply', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class WPFGSC_Google_DriveFile extends WPFGSC_Google_Model {
  ...
  public $iconLink;
  public $id;
  protected $__imageMediaMetadataType = 'WPFGSC_Google_DriveFileImageMediaMetadata';
  protected $__imageMediaMetadataDataType = '';
  public $imageMediaMetadata;
  protected $__indexableTextType = 'WPFGSC_Google_DriveFileIndexableText';
  protected $__indexableTextDataType = '';
  public $indexableText;
  public $kind;
  protected $__labelsType = 'WPFGSC_Google_DriveFileLabels';
  ...
  public $ownerNames;
  protected $__parentsType = 'WPFGSC_Google_ParentReference';
  protected $__parentsDataType = 'array';
  public $parents;
  public $quotaBytesUsed;
  public $selfLink;
  public $sharedWithMeDate;
  protected $__thumbnailType = 'WPFGSC_Google_DriveFileThumbnail';
  protected $__thumbnailDataType = '';
  public $thumbnail;
  public $thumbnailLink;
  public $title;
  protected $__userPermissionType = 'WPFGSC_Google_Permission';
  ...
  public function setImageMediaMetadata(WPFGSC_Google_DriveFileImageMediaMetadata $imageMediaMetadata) {
    $this->imageMediaMetadata = $imageMediaMetadata;
  }
  public function getImageMediaMetadata() {
    return $this->imageMediaMetadata;
  }
  public function setIndexableText(WPFGSC_Google_DriveFileIndexableText $indexableText) {
  ...
  public function setLabels(WPFGSC_Google_DriveFileLabels $labels) {
    $this->labels = $labels;
  }
  ...
  public function setParents(/* array(WPFGSC_Google_ParentReference) */ $parents) {
    $this->assertIsArray($parents, 'WPFGSC_Google_ParentReference', __METHOD__);
  ...
  public function setThumbnail(WPFGSC_Google_DriveFileThumbnail $thumbnail) {
  ...
  public function setUserPermission(WPFGSC_Google_Permission $userPermission) {
...
class WPFGSC_Google_DriveFileImageMediaMetadata extends WPFGSC_Google_Model {
  public $aperture;
  public $cameraMake;
  public $cameraModel;
  public $colorSpace;
  ...
  public $isoSpeed;
  public $lens;
  protected $__locationType = 'WPFGSC_Google_DriveFileImageMediaMetadataLocation';
  ...
  public function setLocation(WPFGSC_Google_DriveFileImageMediaMetadataLocation $location) {
...
class WPFGSC_Google_DriveFileImageMediaMetadataLocation extends WPFGSC_Google_Model {
  public $altitude;
  public $latitude;
  public $longitude;
...
class WPFGSC_Google_DriveFileIndexableText extends WPFGSC_Google_Model {
  public $text;
...
class WPFGSC_Google_DriveFileLabels extends WPFGSC_Google_Model {
  public $hidden;
  public $restricted;
  public $starred;
  public $trashed;
...
class WPFGSC_Google_DriveFileThumbnail extends WPFGSC_Google_Model {
  public $image;
  public $mimeType;
...
class WPFGSC_Google_FileList extends WPFGSC_Google_Model {
  public $etag;
  protected $__itemsType = 'WPFGSC_Google_DriveFile';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $nextLink;
  ...
  public function setItems(/* array(WPFGSC_Google_DriveFile) */ $items) {
    $this->assertIsArray($items, 'WPFGSC_Google_DriveFile', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class WPFGSC_Google_ParentList extends WPFGSC_Google_Model {
  public $etag;
  protected $__itemsType = 'WPFGSC_Google_ParentReference';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $selfLink;
  ...
  public function setItems(/* array(WPFGSC_Google_ParentReference) */ $items) {
    $this->assertIsArray($items, 'WPFGSC_Google_ParentReference', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class WPFGSC_Google_ParentReference extends WPFGSC_Google_Model {
  public $id;
  public $isRoot;
  public $kind;
  public $parentLink;
...
class WPFGSC_Google_Permission extends WPFGSC_Google_Model {
  public $additionalRoles;
  public $authKey;
  public $etag;
  public $id;
...
class WPFGSC_Google_PermissionList extends WPFGSC_Google_Model {
  public $etag;
  protected $__itemsType = 'WPFGSC_Google_Permission';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $selfLink;
  ...
  public function setItems(/* array(WPFGSC_Google_Permission) */ $items) {
    $this->assertIsArray($items, 'WPFGSC_Google_Permission', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class WPFGSC_Google_Revision extends WPFGSC_Google_Model {
  public $downloadUrl;
  public $etag;
  public $exportLinks;
  public $fileSize;
...
class WPFGSC_Google_RevisionList extends WPFGSC_Google_Model {
  public $etag;
  protected $__itemsType = 'WPFGSC_Google_Revision';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $selfLink;
  ...
  public function setItems(/* array(WPFGSC_Google_Revision) */ $items) {
    $this->assertIsArray($items, 'WPFGSC_Google_Revision', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class WPFGSC_Google_User extends WPFGSC_Google_Model {
  public $displayName;
  public $isAuthenticatedUser;
  public $kind;
  protected $__pictureType = 'WPFGSC_Google_UserPicture';
  ...
  public function setPicture(WPFGSC_Google_UserPicture $picture) {
...
class WPFGSC_Google_UserPicture extends WPFGSC_Google_Model {
  public $url;
