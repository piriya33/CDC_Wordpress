...
class WPFGSC_Google_Model {
   ...
   * @throws WPFGSC_Google_Exceptions Thrown if $obj isn't an array.
  ...
  public function assertIsArray($obj, $type, $method) {
    if ($obj && !is_array($obj)) {
      throw new WPFGSC_Google_Exceptions("Incorrect parameter type passed to $method(), expected an"
