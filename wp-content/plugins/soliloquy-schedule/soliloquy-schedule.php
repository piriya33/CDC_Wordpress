...
class Soliloquy_Schedule {
     ...
     * @var string
     */
    public $plugin_name = 'Soliloquy Schedule';
     ...
     * @var string
     */
    public $plugin_slug = 'soliloquy-schedule';
     ...
     * @since 2.2.0
     *
     * @return object The Soliloquy_Schedule object.
     */
    public static function get_instance() {

        if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Soliloquy_Schedule ) ) {
            self::$instance = new Soliloquy_Schedule();
        }
...
$soliloquy_schedule = Soliloquy_Schedule::get_instance();