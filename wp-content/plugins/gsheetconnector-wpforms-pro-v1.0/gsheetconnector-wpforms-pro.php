...
define('WPFORMS_GOOGLESHEET_PRO_VERSION', '1.0');
define('WPFORMS_GOOGLESHEET_PRO_DB_VERSION', '1.0');
...
class WPforms_Gsheet_Connector_Init {
   ...
   public function load_all_classes() {
      ...
      if (!class_exists('WPforms_Googlesheet_Services')) {
         include( WPFORMS_GOOGLESHEET_PRO_PATH . 'includes/class-wpforms-integration.php' );
      }
   }
