 ...
 */
class WPFGSC_Google_Client {
  /**
   * @static
   * @var WPFGSC_Google_Auth $auth
   */
  static $auth;

  /**
   * @static
   * @var WPFGSC_Google_IO $io
   */
  static $io;

  /**
   * @static
   * @var WPFGSC_Google_Cache $cache
   */
  static $cache;
  ...
  public function addService($service, $version = false) {
    ...
    if ($this->authenticated) {
      throw new WPFGSC_Google_Exceptions('Cant add services after having authenticated');
    }
   ...
   * or WPFGSC_Google_Client#getAccessToken().
   ...
   * @return WPFGSC_Google_LoginTicket Returns an apiLoginTicket if the verification was
   * successful.
   */
  ...
  /**
   * @param WPFGSC_Google_AssertionCredentials $creds
   * @return void
   */
  ...
  /**
   * @static
   * @return WPFGSC_Google_Auth the implementation of apiAuth.
   */
  public static function getAuth() {
    return WPFGSC_Google_Client::$auth;
  }

  /**
   * @static
   * @return WPFGSC_Google_IO the implementation of apiIo.
   */
  public static function getIo() {
    return WPFGSC_Google_Client::$io;
  }

  /**
   * @return WPFGSC_Google_Cache the implementation of apiCache.
   */
  public function getCache() {
    return WPFGSC_Google_Client::$cache;
  }
}

// Exceptions that the Google PHP API Library can throw
class WPFGSC_Google_Exceptions extends Exception {}
class WPFGSC_Google_AuthException extends WPFGSC_Google_Exceptions {}
class WPFGSC_Google_CacheException extends WPFGSC_Google_Exceptions {}
class WPFGSC_Google_IOException extends WPFGSC_Google_Exceptions {}
class WPFGSC_Google_ServiceException extends WPFGSC_Google_Exceptions {
  /**
