...
class WPFGSC_Google_REST {
   ...
   *
   * @param WPFGSC_Google_HttpRequest $req
   * @return array decoded result
   * @throws WPFGSC_Google_ServiceException on server side error (ie: not authenticated,
   *  invalid or malformed post body, invalid url)
   */
  static public function execute(WPFGSC_Google_HttpRequest $req) {
    $httpRequest = WPFGSC_Google_Client::$io->makeRequest($req);
   ...
   * @static
   * @throws WPFGSC_Google_ServiceException
   * @param WPFGSC_Google_HttpRequest $response The http response to be decoded.
   * @return mixed|null
   */
  public static function decodeHttpResponse($response) {
    ...
    if ($code != '200' && $code != '201' && $code != '204') {
      ...
      throw new WPFGSC_Google_ServiceException($err, $code, null, $decoded['error']['errors']);
    }
    ...
    if ($code != '204') {
      ...
      if ($decoded === null || $decoded === "") {
        throw new WPFGSC_Google_ServiceException("Invalid json in service response: $body");
      }
    }
    return $decoded;
  }
  ...
  static function createRequestUri($servicePath, $restPath, $params) {
    ...
    if (count($uriTemplateVars)) {
      $uriTemplateParser = new WPFGSC_URI_Template_Parser($requestUrl);
