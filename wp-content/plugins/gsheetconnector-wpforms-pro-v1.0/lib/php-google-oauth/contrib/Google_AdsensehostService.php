 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $adsensehostService = new WPFGSC_Google_AdSenseHostService(...);
  ...
  class WPFGSC_Google_AccountsAdclientsServiceResource extends WPFGSC_Google_ServiceResource {
    ...
    public function get($accountId, $adClientId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_AdClient($data);
      } else {
        return $data;
      }
    }
  ...
  class WPFGSC_Google_AccountsAdunitsServiceResource extends WPFGSC_Google_ServiceResource {
    ...
    public function getAdCode($accountId, $adClientId, $adUnitId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new WPFGSC_Google_AdCode($data);
      } else {
        return $data;
      }
    }
     ...
     * @param WPFGSC_Google_AdUnit $postBody
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_AdUnit
     */
    public function insert($accountId, $adClientId, WPFGSC_Google_AdUnit $postBody, $optParams = array()) {
     ...
     * @return WPFGSC_Google_AdUnit
     */
    public function patch($accountId, $adClientId, $adUnitId, WPFGSC_Google_AdUnit $postBody, $optParams = array()) {
     ...
     * @return WPFGSC_Google_AdUnit
     */
    public function update($accountId, $adClientId, WPFGSC_Google_AdUnit $postBody, $optParams = array()) {
      $params = array('accountId' => $accountId, 'adClientId' => $adClientId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class WPFGSC_Google_AssociationSessionsServiceResource extends WPFGSC_Google_ServiceResource {
     ...
     * @return WPFGSC_Google_AssociationSession
     */
    public function start($productCode, $websiteUrl, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new WPFGSC_Google_AssociationSession($data);
      } else {
        return $data;
      }
    }
  ...
  class WPFGSC_Google_CustomchannelsServiceResource extends WPFGSC_Google_ServiceResource {
     ...
     * @param WPFGSC_Google_CustomChannel $postBody
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_CustomChannel
     */
    public function insert($adClientId, WPFGSC_Google_CustomChannel $postBody, $optParams = array()) {
     ...
     * @return WPFGSC_Google_CustomChannel
     */
    public function patch($adClientId, $customChannelId, WPFGSC_Google_CustomChannel $postBody, $optParams = array()) {
     ...
     * @return WPFGSC_Google_CustomChannel
     */
    public function update($adClientId, WPFGSC_Google_CustomChannel $postBody, $optParams = array()) {
      $params = array('adClientId' => $adClientId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('update', array($params));
      if ($this->useObjects()) {
  ...
  class WPFGSC_Google_UrlchannelsServiceResource extends WPFGSC_Google_ServiceResource {
     ...
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_UrlChannel
     */
    public function delete($adClientId, $urlChannelId, $optParams = array()) {
      ...
      $data = $this->__call('delete', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_UrlChannel($data);
      } else {
        return $data;
      }
    }
     ...
     * @param WPFGSC_Google_UrlChannel $postBody
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_UrlChannel
     */
    public function insert($adClientId, WPFGSC_Google_UrlChannel $postBody, $optParams = array()) {
      $params = array('adClientId' => $adClientId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
 ...
 * @author Google, Inc.
 */
class WPFGSC_Google_AdSenseHostService extends WPFGSC_Google_Service {
  public $accounts;
...
class WPFGSC_Google_AdCode extends WPFGSC_Google_Model {
  public $adCode;
  public $kind;
...
class WPFGSC_Google_AssociationSession extends WPFGSC_Google_Model {
  public $accountId;
  public $id;
  public $kind;
  public $productCodes;
...
class WPFGSC_Google_Report extends WPFGSC_Google_Model {
  public $averages;
  protected $__headersType = 'WPFGSC_Google_ReportHeaders';
  ...
  public function setHeaders(/* array(WPFGSC_Google_ReportHeaders) */ $headers) {
    $this->assertIsArray($headers, 'WPFGSC_Google_ReportHeaders', __METHOD__);
...
class WPFGSC_Google_ReportHeaders extends WPFGSC_Google_Model {
  public $currency;
  public $name;
  public $type;
