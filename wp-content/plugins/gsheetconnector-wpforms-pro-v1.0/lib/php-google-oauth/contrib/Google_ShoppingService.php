 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $shoppingService = new WPFGSC_Google_ShoppingService(...);
   *   $products = $shoppingService->products;
   *  </code>
   */
  class WPFGSC_Google_ProductsServiceResource extends WPFGSC_Google_ServiceResource {
    ...
    public function listProducts($source, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new WPFGSC_Google_Products($data);
      } else {
        return $data;
      }
    }
    ...
    public function get($source, $accountId, $productIdType, $productId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new WPFGSC_Google_Product($data);
      } else {
        return $data;
      }
    }
 ...
 * @author Google, Inc.
 */
class WPFGSC_Google_ShoppingService extends WPFGSC_Google_Service {
  public $products;
  /**
...
class WPFGSC_Google_Product extends WPFGSC_Google_Model {
  public $selfLink;
  public $kind;
  protected $__productType = 'WPFGSC_Google_ShoppingModelProductJsonV1';
  protected $__productDataType = '';
  public $product;
  public $requestId;
  protected $__recommendationsType = 'WPFGSC_Google_ShoppingModelRecommendationsJsonV1';
  protected $__recommendationsDataType = 'array';
  public $recommendations;
  protected $__debugType = 'WPFGSC_Google_ShoppingModelDebugJsonV1';
  protected $__debugDataType = '';
  public $debug;
  public $id;
  protected $__categoriesType = 'WPFGSC_Google_ShoppingModelCategoryJsonV1';
  ...
  public function setProduct(WPFGSC_Google_ShoppingModelProductJsonV1 $product) {
  ...
  public function setRecommendations(/* array(WPFGSC_Google_ShoppingModelRecommendationsJsonV1) */ $recommendations) {
    $this->assertIsArray($recommendations, 'WPFGSC_Google_ShoppingModelRecommendationsJsonV1', __METHOD__);
    $this->recommendations = $recommendations;
  }
  public function getRecommendations() {
    return $this->recommendations;
  }
  public function setDebug(WPFGSC_Google_ShoppingModelDebugJsonV1 $debug) {
    $this->debug = $debug;
  }
  ...
  public function setCategories(/* array(WPFGSC_Google_ShoppingModelCategoryJsonV1) */ $categories) {
    $this->assertIsArray($categories, 'WPFGSC_Google_ShoppingModelCategoryJsonV1', __METHOD__);
...
class WPFGSC_Google_Products extends WPFGSC_Google_Model {
  protected $__promotionsType = 'WPFGSC_Google_ProductsPromotions';
  protected $__promotionsDataType = 'array';
  public $promotions;
  public $selfLink;
  public $kind;
  protected $__storesType = 'WPFGSC_Google_ProductsStores';
  protected $__storesDataType = 'array';
  public $stores;
  public $currentItemCount;
  protected $__itemsType = 'WPFGSC_Google_Product';
  protected $__itemsDataType = 'array';
  public $items;
  protected $__facetsType = 'WPFGSC_Google_ProductsFacets';
  ...
  public $etag;
  public $requestId;
  protected $__categoryRecommendationsType = 'WPFGSC_Google_ShoppingModelRecommendationsJsonV1';
  protected $__categoryRecommendationsDataType = 'array';
  public $categoryRecommendations;
  protected $__debugType = 'WPFGSC_Google_ShoppingModelDebugJsonV1';
  protected $__debugDataType = '';
  public $debug;
  protected $__spellingType = 'WPFGSC_Google_ProductsSpelling';
  ...
  protected $__categoriesDataType = 'array';
  public $categories;
  public function setPromotions(/* array(WPFGSC_Google_ProductsPromotions) */ $promotions) {
    $this->assertIsArray($promotions, 'WPFGSC_Google_ProductsPromotions', __METHOD__);
  ...
  public function setStores(/* array(WPFGSC_Google_ProductsStores) */ $stores) {
    $this->assertIsArray($stores, 'WPFGSC_Google_ProductsStores', __METHOD__);
    $this->stores = $stores;
  }
  ...
  public function setItems(/* array(WPFGSC_Google_Product) */ $items) {
    $this->assertIsArray($items, 'WPFGSC_Google_Product', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
  }
  public function setFacets(/* array(WPFGSC_Google_ProductsFacets) */ $facets) {
    $this->assertIsArray($facets, 'WPFGSC_Google_ProductsFacets', __METHOD__);
    $this->facets = $facets;
  }
  ...
  public function setCategoryRecommendations(/* array(WPFGSC_Google_ShoppingModelRecommendationsJsonV1) */ $categoryRecommendations) {
    $this->assertIsArray($categoryRecommendations, 'WPFGSC_Google_ShoppingModelRecommendationsJsonV1', __METHOD__);
  ...
  public function setSpelling(WPFGSC_Google_ProductsSpelling $spelling) {
...
class WPFGSC_Google_ProductsFacets extends WPFGSC_Google_Model {
  public $count;
  public $displayName;
  public $name;
  protected $__bucketsType = 'WPFGSC_Google_ProductsFacetsBuckets';
  ...
  public function setBuckets(/* array(WPFGSC_Google_ProductsFacetsBuckets) */ $buckets) {
    $this->assertIsArray($buckets, 'WPFGSC_Google_ProductsFacetsBuckets', __METHOD__);
...
class WPFGSC_Google_ProductsFacetsBuckets extends WPFGSC_Google_Model {
  public $count;
  public $minExclusive;
  public $min;
  public $max;
...
class WPFGSC_Google_ProductsPromotions extends WPFGSC_Google_Model {
  protected $__productType = 'WPFGSC_Google_ShoppingModelProductJsonV1';
  protected $__productDataType = '';
  public $product;
  public $description;
  ...
  public $destLink;
  public $customHtml;
  protected $__customFieldsType = 'WPFGSC_Google_ProductsPromotionsCustomFields';
  ...
  public function setCustomFields(/* array(WPFGSC_Google_ProductsPromotionsCustomFields) */ $customFields) {
    $this->assertIsArray($customFields, 'WPFGSC_Google_ProductsPromotionsCustomFields', __METHOD__);
...
class WPFGSC_Google_ProductsPromotionsCustomFields extends WPFGSC_Google_Model {
  public $name;
  public $value;
  public function setName($name) {
    $this->name = $name;
...
class WPFGSC_Google_ProductsSpelling extends WPFGSC_Google_Model {
  public $suggestion;
...
class WPFGSC_Google_ProductsStores extends WPFGSC_Google_Model {
  public $storeCode;
  public $name;
  public $storeName;
  public $storeId;
...
class WPFGSC_Google_ShoppingModelCategoryJsonV1 extends WPFGSC_Google_Model {
  public $url;
  public $shortName;
  public $parents;
  public $id;
...
class WPFGSC_Google_ShoppingModelDebugJsonV1 extends WPFGSC_Google_Model {
  ...
  protected $__backendTimesType = 'WPFGSC_Google_ShoppingModelDebugJsonV1BackendTimes';
  ...
  public function setBackendTimes(/* array(WPFGSC_Google_ShoppingModelDebugJsonV1BackendTimes) */ $backendTimes) {
    $this->assertIsArray($backendTimes, 'WPFGSC_Google_ShoppingModelDebugJsonV1BackendTimes', __METHOD__);
...
class WPFGSC_Google_ShoppingModelDebugJsonV1BackendTimes extends WPFGSC_Google_Model {
  public $serverMillis;
  public $hostName;
  public $name;
  public $elapsedMillis;
...
class WPFGSC_Google_ShoppingModelProductJsonV1 extends WPFGSC_Google_Model {
  public $queryMatched;
  public $gtin;
  protected $__imagesType = 'WPFGSC_Google_ShoppingModelProductJsonV1Images';
  protected $__imagesDataType = 'array';
  public $images;
  protected $__inventoriesType = 'WPFGSC_Google_ShoppingModelProductJsonV1Inventories';
  protected $__inventoriesDataType = 'array';
  public $inventories;
  protected $__authorType = 'WPFGSC_Google_ShoppingModelProductJsonV1Author';
  ...
  public $brand;
  public $internal3;
  protected $__internal4Type = 'WPFGSC_Google_ShoppingModelProductJsonV1Internal4';
  ...
  public $link;
  public $mpns;
  protected $__attributesType = 'WPFGSC_Google_ShoppingModelProductJsonV1Attributes';
  protected $__attributesDataType = 'array';
  public $attributes;
  public $totalMatchingVariants;
  protected $__variantsType = 'WPFGSC_Google_ShoppingModelProductJsonV1Variants';
  ...
  public function setImages(/* array(WPFGSC_Google_ShoppingModelProductJsonV1Images) */ $images) {
    $this->assertIsArray($images, 'WPFGSC_Google_ShoppingModelProductJsonV1Images', __METHOD__);
    $this->images = $images;
  }
  public function getImages() {
    return $this->images;
  }
  public function setInventories(/* array(WPFGSC_Google_ShoppingModelProductJsonV1Inventories) */ $inventories) {
    $this->assertIsArray($inventories, 'WPFGSC_Google_ShoppingModelProductJsonV1Inventories', __METHOD__);
    $this->inventories = $inventories;
  }
  public function getInventories() {
    return $this->inventories;
  }
  public function setAuthor(WPFGSC_Google_ShoppingModelProductJsonV1Author $author) {
    $this->author = $author;
  }
  ...
  public function setInternal4(/* array(WPFGSC_Google_ShoppingModelProductJsonV1Internal4) */ $internal4) {
    $this->assertIsArray($internal4, 'WPFGSC_Google_ShoppingModelProductJsonV1Internal4', __METHOD__);
  ...
  public function setAttributes(/* array(WPFGSC_Google_ShoppingModelProductJsonV1Attributes) */ $attributes) {
    $this->assertIsArray($attributes, 'WPFGSC_Google_ShoppingModelProductJsonV1Attributes', __METHOD__);
  ...
  public function setVariants(/* array(WPFGSC_Google_ShoppingModelProductJsonV1Variants) */ $variants) {
    $this->assertIsArray($variants, 'WPFGSC_Google_ShoppingModelProductJsonV1Variants', __METHOD__);
...
class WPFGSC_Google_ShoppingModelProductJsonV1Attributes extends WPFGSC_Google_Model {
  public $type;
  public $value;
  public $displayName;
  public $name;
...
class WPFGSC_Google_ShoppingModelProductJsonV1Author extends WPFGSC_Google_Model {
  public $name;
  public $accountId;
  public function setName($name) {
    $this->name = $name;
...
class WPFGSC_Google_ShoppingModelProductJsonV1Images extends WPFGSC_Google_Model {
  public $status;
  public $link;
  protected $__thumbnailsType = 'WPFGSC_Google_ShoppingModelProductJsonV1ImagesThumbnails';
  ...
  public function setThumbnails(/* array(WPFGSC_Google_ShoppingModelProductJsonV1ImagesThumbnails) */ $thumbnails) {
    $this->assertIsArray($thumbnails, 'WPFGSC_Google_ShoppingModelProductJsonV1ImagesThumbnails', __METHOD__);
...
class WPFGSC_Google_ShoppingModelProductJsonV1ImagesThumbnails extends WPFGSC_Google_Model {
  public $content;
  public $width;
  public $link;
  public $height;
...
class WPFGSC_Google_ShoppingModelProductJsonV1Internal4 extends WPFGSC_Google_Model {
  public $node;
  public $confidence;
...
class WPFGSC_Google_ShoppingModelProductJsonV1Inventories extends WPFGSC_Google_Model {
...
class WPFGSC_Google_ShoppingModelProductJsonV1Variants extends WPFGSC_Google_Model {
  protected $__variantType = 'WPFGSC_Google_ShoppingModelProductJsonV1';
  protected $__variantDataType = '';
  public $variant;
  public function setVariant(WPFGSC_Google_ShoppingModelProductJsonV1 $variant) {
...
class WPFGSC_Google_ShoppingModelRecommendationsJsonV1 extends WPFGSC_Google_Model {
  protected $__recommendationListType = 'WPFGSC_Google_ShoppingModelRecommendationsJsonV1RecommendationList';
  protected $__recommendationListDataType = 'array';
  public $recommendationList;
  public $type;
  public function setRecommendationList(/* array(WPFGSC_Google_ShoppingModelRecommendationsJsonV1RecommendationList) */ $recommendationList) {
    $this->assertIsArray($recommendationList, 'WPFGSC_Google_ShoppingModelRecommendationsJsonV1RecommendationList', __METHOD__);
...
class WPFGSC_Google_ShoppingModelRecommendationsJsonV1RecommendationList extends WPFGSC_Google_Model {
  protected $__productType = 'WPFGSC_Google_ShoppingModelProductJsonV1';
  protected $__productDataType = '';
  public $product;
  public function setProduct(WPFGSC_Google_ShoppingModelProductJsonV1 $product) {
