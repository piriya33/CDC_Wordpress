 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $freebaseService = new WPFGSC_Google_FreebaseService(...);
   *   $text = $freebaseService->text;
   *  </code>
   */
  class WPFGSC_Google_TextServiceResource extends WPFGSC_Google_ServiceResource {
     ...
     * @return WPFGSC_Google_ContentserviceGet
     */
    public function get($id, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new WPFGSC_Google_ContentserviceGet($data);
      } else {
        return $data;
      }
    }
 ...
 * @author Google, Inc.
 */
class WPFGSC_Google_FreebaseService extends WPFGSC_Google_Service {
  public $text;
  /**
