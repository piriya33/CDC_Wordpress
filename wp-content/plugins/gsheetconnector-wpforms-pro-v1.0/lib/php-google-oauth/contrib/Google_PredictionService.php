 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $predictionService = new WPFGSC_Google_PredictionService(...);
   *   $trainedmodels = $predictionService->trainedmodels;
   *  </code>
   */
  class WPFGSC_Google_TrainedmodelsServiceResource extends WPFGSC_Google_ServiceResource {
     ...
     * @param WPFGSC_Google_Input $postBody
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_Output
     */
    public function predict($id, WPFGSC_Google_Input $postBody, $optParams = array()) {
      $params = array('id' => $id, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('predict', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_Output($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param WPFGSC_Google_Training $postBody
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_Training
     */
    public function insert(WPFGSC_Google_Training $postBody, $optParams = array()) {
      $params = array('postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_Training($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param string $id The unique name for the predictive model.
     * @param WPFGSC_Google_Update $postBody
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_Training
     */
    public function update($id, WPFGSC_Google_Update $postBody, $optParams = array()) {
      $params = array('id' => $id, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class WPFGSC_Google_HostedmodelsServiceResource extends WPFGSC_Google_ServiceResource {
     ...
     * @return WPFGSC_Google_Output
     */
    public function predict($hostedModelName, WPFGSC_Google_Input $postBody, $optParams = array()) {
 ...
 * @author Google, Inc.
 */
class WPFGSC_Google_PredictionService extends WPFGSC_Google_Service {
...
class WPFGSC_Google_InputInput extends WPFGSC_Google_Model {
  public $csvInstance;
...
class WPFGSC_Google_Output extends WPFGSC_Google_Model {
  public $kind;
  public $outputLabel;
  public $id;
  protected $__outputMultiType = 'WPFGSC_Google_OutputOutputMulti';
  ...
  public function setOutputMulti(/* array(WPFGSC_Google_OutputOutputMulti) */ $outputMulti) {
    $this->assertIsArray($outputMulti, 'WPFGSC_Google_OutputOutputMulti', __METHOD__);
...
class WPFGSC_Google_OutputOutputMulti extends WPFGSC_Google_Model {
  public $score;
  public $label;
...
class WPFGSC_Google_Training extends WPFGSC_Google_Model {
  public $kind;
  public $storageDataLocation;
  public $storagePMMLModelLocation;
  protected $__dataAnalysisType = 'WPFGSC_Google_TrainingDataAnalysis';
  protected $__dataAnalysisDataType = '';
  public $dataAnalysis;
  public $trainingStatus;
  protected $__modelInfoType = 'WPFGSC_Google_TrainingModelInfo';
  ...
  public function setDataAnalysis(WPFGSC_Google_TrainingDataAnalysis $dataAnalysis) {
  ...
  public function setModelInfo(WPFGSC_Google_TrainingModelInfo $modelInfo) {
...
class WPFGSC_Google_TrainingDataAnalysis extends WPFGSC_Google_Model {
  public $warnings;
...
class WPFGSC_Google_TrainingModelInfo extends WPFGSC_Google_Model {
...
class WPFGSC_Google_Update extends WPFGSC_Google_Model {
  public $csvInstance;
  public $label;
  public function setCsvInstance(/* array(Google_object) */ $csvInstance) {
    $this->assertIsArray($csvInstance, 'Google_object', __METHOD__);
