 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $fusiontablesService = new WPFGSC_Google_FusiontablesService(...);
   *   $column = $fusiontablesService->column;
   *  </code>
   */
  class WPFGSC_Google_ColumnServiceResource extends WPFGSC_Google_ServiceResource {
     ...
     * @param WPFGSC_Google_Column $postBody
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_Column
     */
    public function insert($tableId, WPFGSC_Google_Column $postBody, $optParams = array()) {
      $params = array('tableId' => $tableId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_Column($data);
      } else {
        return $data;
      }
    }
     ...
     * @return WPFGSC_Google_ColumnList
     */
    public function listColumn($tableId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new WPFGSC_Google_ColumnList($data);
      } else {
        return $data;
      }
    }
     ...
     * @return WPFGSC_Google_Column
     */
    public function update($tableId, $columnId, WPFGSC_Google_Column $postBody, $optParams = array()) {
     ...
     * @return WPFGSC_Google_Column
     */
    public function patch($tableId, $columnId, WPFGSC_Google_Column $postBody, $optParams = array()) {
      $params = array('tableId' => $tableId, 'columnId' => $columnId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class WPFGSC_Google_QueryServiceResource extends WPFGSC_Google_ServiceResource {
     ...
     * @return WPFGSC_Google_Sqlresponse
     */
    public function sqlGet($sql, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new WPFGSC_Google_Sqlresponse($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class WPFGSC_Google_StyleServiceResource extends WPFGSC_Google_ServiceResource {
     ...
     * @param WPFGSC_Google_StyleSetting $postBody
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_StyleSetting
     */
    public function insert($tableId, WPFGSC_Google_StyleSetting $postBody, $optParams = array()) {
      $params = array('tableId' => $tableId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_StyleSetting($data);
      } else {
        return $data;
      }
    }
     ...
     * @return WPFGSC_Google_StyleSettingList
     */
    public function listStyle($tableId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_StyleSettingList($data);
      } else {
        return $data;
      }
    }
     ...
     * @return WPFGSC_Google_StyleSetting
     */
    public function update($tableId, $styleId, WPFGSC_Google_StyleSetting $postBody, $optParams = array()) {
     ...
     * @return WPFGSC_Google_StyleSetting
     */
    public function patch($tableId, $styleId, WPFGSC_Google_StyleSetting $postBody, $optParams = array()) {
      $params = array('tableId' => $tableId, 'styleId' => $styleId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
   ...
   *  </code>
   */
  class WPFGSC_Google_TemplateServiceResource extends WPFGSC_Google_ServiceResource {
     ...
     * @param WPFGSC_Google_Template $postBody
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_Template
     */
    public function insert($tableId, WPFGSC_Google_Template $postBody, $optParams = array()) {
      $params = array('tableId' => $tableId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_Template($data);
      } else {
        return $data;
      }
    }
     ...
     * @return WPFGSC_Google_TemplateList
     */
    public function listTemplate($tableId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_TemplateList($data);
      } else {
        return $data;
      }
    }
     ...
     * @return WPFGSC_Google_Template
     */
    public function update($tableId, $templateId, WPFGSC_Google_Template $postBody, $optParams = array()) {
     ...
     * @return WPFGSC_Google_Template
     */
    public function patch($tableId, $templateId, WPFGSC_Google_Template $postBody, $optParams = array()) {
      $params = array('tableId' => $tableId, 'templateId' => $templateId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
   ...
   *  </code>
   */
  class WPFGSC_Google_TableServiceResource extends WPFGSC_Google_ServiceResource {
     ...
     */
    public function insert(WPFGSC_Google_Table $postBody, $optParams = array()) {
     ...
     * @return WPFGSC_Google_Table
     */
    public function update($tableId, WPFGSC_Google_Table $postBody, $optParams = array()) {
      $params = array('tableId' => $tableId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('update', array($params));
      if ($this->useObjects()) {
     ...
     * @return WPFGSC_Google_Table
     */
    public function patch($tableId, WPFGSC_Google_Table $postBody, $optParams = array()) {
      $params = array('tableId' => $tableId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
 ...
 * @author Google, Inc.
 */
class WPFGSC_Google_FusiontablesService extends WPFGSC_Google_Service {
  public $column;
  public $query;
  public $style;
  public $template;
...
class WPFGSC_Google_Column extends WPFGSC_Google_Model {
  public $kind;
  public $type;
  public $columnId;
  public $name;
  protected $__baseColumnType = 'WPFGSC_Google_ColumnBaseColumn';
  ...
  public function setBaseColumn(WPFGSC_Google_ColumnBaseColumn $baseColumn) {
...
class WPFGSC_Google_ColumnBaseColumn extends WPFGSC_Google_Model {
  public $tableIndex;
  public $columnId;
...
class WPFGSC_Google_ColumnList extends WPFGSC_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'WPFGSC_Google_Column';
  ...
  public function setItems(/* array(WPFGSC_Google_Column) */ $items) {
    $this->assertIsArray($items, 'WPFGSC_Google_Column', __METHOD__);
    $this->items = $items;
  }
...
class WPFGSC_Google_Geometry extends WPFGSC_Google_Model {
  public $geometry;
  public $type;
  public $geometries;
...
class WPFGSC_Google_Line extends WPFGSC_Google_Model {
  public $type;
  public $coordinates;
  public function setType($type) {
    $this->type = $type;
...
class WPFGSC_Google_LineStyle extends WPFGSC_Google_Model {
  public $strokeWeight;
  protected $__strokeWeightStylerType = 'WPFGSC_Google_StyleFunction';
  protected $__strokeWeightStylerDataType = '';
  public $strokeWeightStyler;
  public $strokeColor;
  public $strokeOpacity;
  protected $__strokeColorStylerType = 'WPFGSC_Google_StyleFunction';
  ...
  public function setStrokeWeightStyler(WPFGSC_Google_StyleFunction $strokeWeightStyler) {
  ...
  public function setStrokeColorStyler(WPFGSC_Google_StyleFunction $strokeColorStyler) {
...
class WPFGSC_Google_Point extends WPFGSC_Google_Model {
  public $type;
  public $coordinates;
  public function setType($type) {
    $this->type = $type;
...
class WPFGSC_Google_PointStyle extends WPFGSC_Google_Model {
  protected $__iconStylerType = 'WPFGSC_Google_StyleFunction';
  protected $__iconStylerDataType = '';
  public $iconStyler;
  public $iconName;
  public function setIconStyler(WPFGSC_Google_StyleFunction $iconStyler) {
...
class WPFGSC_Google_Polygon extends WPFGSC_Google_Model {
  public $type;
  public $coordinates;
  public function setType($type) {
    $this->type = $type;
...
class WPFGSC_Google_PolygonStyle extends WPFGSC_Google_Model {
  protected $__strokeColorStylerType = 'WPFGSC_Google_StyleFunction';
  protected $__strokeColorStylerDataType = '';
  public $strokeColorStyler;
  public $strokeWeight;
  ...
  protected $__strokeWeightStylerDataType = '';
  public $strokeWeightStyler;
  protected $__fillColorStylerType = 'WPFGSC_Google_StyleFunction';
  ...
  public function setFillColorStyler(WPFGSC_Google_StyleFunction $fillColorStyler) {
...
class WPFGSC_Google_Sqlresponse extends WPFGSC_Google_Model {
  public $kind;
  public $rows;
  public $columns;
  public function setKind($kind) {
...
class WPFGSC_Google_StyleFunction extends WPFGSC_Google_Model {
  protected $__gradientType = 'WPFGSC_Google_StyleFunctionGradient';
  protected $__gradientDataType = '';
  public $gradient;
  public $columnName;
  protected $__bucketsType = 'WPFGSC_Google_Bucket';
  protected $__bucketsDataType = 'array';
  public $buckets;
  public $kind;
  public function setGradient(WPFGSC_Google_StyleFunctionGradient $gradient) {
  ...
  public function setBuckets(/* array(WPFGSC_Google_Bucket) */ $buckets) {
    $this->assertIsArray($buckets, 'WPFGSC_Google_Bucket', __METHOD__);
...
class WPFGSC_Google_StyleFunctionGradient extends WPFGSC_Google_Model {
  public $max;
  protected $__colorsType = 'WPFGSC_Google_StyleFunctionGradientColors';
  ...
  public function setColors(/* array(WPFGSC_Google_StyleFunctionGradientColors) */ $colors) {
    $this->assertIsArray($colors, 'WPFGSC_Google_StyleFunctionGradientColors', __METHOD__);
    $this->colors = $colors;
  }
...
class WPFGSC_Google_StyleFunctionGradientColors extends WPFGSC_Google_Model {
  public $color;
  public $opacity;
  public function setColor($color) {
    $this->color = $color;
...
class WPFGSC_Google_StyleSetting extends WPFGSC_Google_Model {
  protected $__markerOptionsType = 'WPFGSC_Google_PointStyle';
  protected $__markerOptionsDataType = '';
  public $markerOptions;
  public $kind;
  public $name;
  protected $__polygonOptionsType = 'WPFGSC_Google_PolygonStyle';
  protected $__polygonOptionsDataType = '';
  public $polygonOptions;
  public $isDefaultForTable;
  protected $__polylineOptionsType = 'WPFGSC_Google_LineStyle';
  protected $__polylineOptionsDataType = '';
  public $polylineOptions;
  public $tableId;
  public $styleId;
  public function setMarkerOptions(WPFGSC_Google_PointStyle $markerOptions) {
  ...
  public function setPolygonOptions(WPFGSC_Google_PolygonStyle $polygonOptions) {
  ...
  public function setPolylineOptions(WPFGSC_Google_LineStyle $polylineOptions) {
...
class WPFGSC_Google_StyleSettingList extends WPFGSC_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'WPFGSC_Google_StyleSetting';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $totalItems;
  ...
  public function setItems(/* array(WPFGSC_Google_StyleSetting) */ $items) {
    $this->assertIsArray($items, 'WPFGSC_Google_StyleSetting', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class WPFGSC_Google_Table extends WPFGSC_Google_Model {
  ...
  public $sql;
  public $tableId;
  protected $__columnsType = 'WPFGSC_Google_Column';
  ...
  public function setColumns(/* array(WPFGSC_Google_Column) */ $columns) {
    $this->assertIsArray($columns, 'WPFGSC_Google_Column', __METHOD__);
    $this->columns = $columns;
  }
  public function getColumns() {
    return $this->columns;
...
class WPFGSC_Google_TableList extends WPFGSC_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'WPFGSC_Google_Table';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setNextPageToken($nextPageToken) {
  ...
  public function setItems(/* array(WPFGSC_Google_Table) */ $items) {
    $this->assertIsArray($items, 'WPFGSC_Google_Table', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class WPFGSC_Google_Template extends WPFGSC_Google_Model {
  public $body;
  public $kind;
  public $name;
...
class WPFGSC_Google_TemplateList extends WPFGSC_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'WPFGSC_Google_Template';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $totalItems;
  ...
  public function setItems(/* array(WPFGSC_Google_Template) */ $items) {
    $this->assertIsArray($items, 'WPFGSC_Google_Template', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
