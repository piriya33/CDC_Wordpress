 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $latitudeService = new WPFGSC_Google_LatitudeService(...);
   *   $currentLocation = $latitudeService->currentLocation;
   *  </code>
   */
  class WPFGSC_Google_CurrentLocationServiceResource extends WPFGSC_Google_ServiceResource {


    /**
     * Updates or creates the user's current location. (currentLocation.insert)
     *
     * @param WPFGSC_Google_Location $postBody
     * @param array $optParams Optional parameters.
     * @return WPFGSC_Google_Location
     */
    public function insert(WPFGSC_Google_Location $postBody, $optParams = array()) {
      $params = array('postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new WPFGSC_Google_Location($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class WPFGSC_Google_LocationServiceResource extends WPFGSC_Google_ServiceResource {
     ...
     * @return WPFGSC_Google_LocationFeed
     */
    public function listLocation($optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new WPFGSC_Google_LocationFeed($data);
      } else {
        return $data;
      }
    }
 ...
 * @author Google, Inc.
 */
class WPFGSC_Google_LatitudeService extends WPFGSC_Google_Service {
...
class WPFGSC_Google_LocationFeed extends WPFGSC_Google_Model {
  protected $__itemsType = 'WPFGSC_Google_Location';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(WPFGSC_Google_Location) */ $items) {
    $this->assertIsArray($items, 'WPFGSC_Google_Location', __METHOD__);
    $this->items = $items;
  }
