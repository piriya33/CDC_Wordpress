<div class="as3cf-remove-local-files-prompt" style="display: none;">
	...
	<p><?php _e( 'You\'ve enabled the "Remove Files From Server" option. Do you want to remove all existing files from the server that have already been offloaded to S3?', 'amazon-s3-and-cloudfront' ); ?></p>
