...
class AS3CF_Settings_Change_Background_Process extends AS3CF_Background_Process {
	...
	protected function complete() {
		...
		$message = __( '<strong>WP Offload S3 Find & Replace Complete</strong> &mdash; %s URLs have been updated in your content to reflect the new URL settings.', 'amazon-s3-and-cloudfront' );
