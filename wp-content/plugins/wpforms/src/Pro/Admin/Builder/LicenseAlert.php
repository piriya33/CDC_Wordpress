...
class LicenseAlert {
	...
	public function get_alert_data() {
		...
		if ( $this->license_is_expired && ! empty( $this->license_type ) ) {
			...
			$data['description']          = \__( 'An active license is needed to create new forms and edit existing forms. It also provides access to new features & addons, plugin updates (including security improvements), and our world class support!', 'wpforms' );
