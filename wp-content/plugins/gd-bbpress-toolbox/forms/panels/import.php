<div class="d4p-group d4p-group-import d4p-group-important">
    ...
    <div class="d4p-group-inner">
        <?php _e("With this tool you import all plugin settings from plain text file made using the Export tool. If you made changes to this file, it is very likely that import will fail.", "gd-bbpress-toolbox"); ?>
    </div>
</div>
