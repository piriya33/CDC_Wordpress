...
define('wc_version_direct_checkout', '1.2.0');
...
if (!class_exists('WooCommerce_Direct_Checkout')) {
  ...
  class WooCommerce_Direct_Checkout {
    ...
    function admin_notice() {
      ...
      if ($current->id == 'woocommerce_page_wc-direct-checkout') {
        ?>
        <div class="notice notice-success is-dismissible"> 
          <p>Hello we're <a target="_blank" href="https://quadlayers.com/portfolio/woocommerce-express-checkout/?utm_source=wdc_admin">QuadLayers</a>! We've recently acquired the WooCommerce Direct Checkout plugin for WordPress and we will prepare a huge update to bring you some new features.</p>
    ...
    function add_action_links($links) {
      ...
      $links[] = '<a target="_blank" href="https://quadlayers.com/portfolio/woocommerce-express-checkout/?utm_source=wdc_admin">' . esc_html__('Coming soon', $this->textdomain) . '</a>';

      $links[] = '<a href="' . admin_url('admin.php?page=wc-direct-checkout') . '">' . esc_html__('Settings', $this->textdomain) . '</a>';
