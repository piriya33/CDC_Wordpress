...
class CF7GSC_Google_Client {
  /**
   * @static
   * @var CF7GSC_Google_Auth $auth
   */
  static $auth;

  /**
   * @static
   * @var CF7GSC_Google_IO $io
   */
  static $io;

  /**
   * @static
   * @var CF7GSC_Google_Cache $cache
   */
  static $cache;
  ...
  public function addService($service, $version = false) {
    ...
    if ($this->authenticated) {
      throw new CF7GSC_Google_Exceptions('Cant add services after having authenticated');
    }
   ...
   * @return CF7GSC_Google_LoginTicket Returns an apiLoginTicket if the verification was
   * successful.
   */
  ...
  /**
   * @param CF7GSC_Google_AssertionCredentials $creds
   * @return void
   */
  ...
  /**
   * @static
   * @return CF7GSC_Google_Auth the implementation of apiAuth.
   */
  ...
  /**
   * @static
   * @return CF7GSC_Google_IO the implementation of apiIo.
   */
  ...
  /**
   * @return CF7GSC_Google_Cache the implementation of apiCache.
   */
...
class CF7GSC_Google_Exceptions extends Exception {}
class CF7GSC_Google_AuthException extends CF7GSC_Google_Exceptions {}
class CF7GSC_Google_CacheException extends CF7GSC_Google_Exceptions {}
class CF7GSC_Google_IOException extends CF7GSC_Google_Exceptions {}
class CF7GSC_Google_ServiceException extends CF7GSC_Google_Exceptions {
  /**
