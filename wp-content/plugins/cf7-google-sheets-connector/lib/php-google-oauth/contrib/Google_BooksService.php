 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $booksService = new CF7GSC_Google_BooksService(...);
   *   $layers = $booksService->layers;
   *  </code>
   */
  class CF7GSC_Google_LayersServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @return CF7GSC_Google_Layersummaries
     */
    public function listLayers($volumeId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CF7GSC_Google_Layersummaries($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string source String to identify the originator of this request.
     * @opt_param string contentVersion The content version for the requested volume.
     * @return CF7GSC_Google_Layersummary
     */
    public function get($volumeId, $summaryId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CF7GSC_Google_Layersummary($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_LayersAnnotationDataServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @return CF7GSC_Google_Annotationsdata
     */
    public function listLayersAnnotationData($volumeId, $layerId, $contentVersion, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_Annotationsdata($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string source String to identify the originator of this request.
     * @opt_param int w The requested pixel width for any images. If width is provided height must also be provided.
     * @return CF7GSC_Google_Annotationdata
     */
    public function get($volumeId, $layerId, $annotationDataId, $contentVersion, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_Annotationdata($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_LayersVolumeAnnotationsServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @return CF7GSC_Google_Volumeannotations
     */
    public function listLayersVolumeAnnotations($volumeId, $layerId, $contentVersion, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_Volumeannotations($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string locale The locale information for the data. ISO-639-1 language and ISO-3166-1 country code. Ex: 'en_US'.
     * @opt_param string source String to identify the originator of this request.
     * @return CF7GSC_Google_Volumeannotation
     */
    public function get($volumeId, $layerId, $annotationId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_Volumeannotation($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_BookshelvesServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     *
     * @opt_param string source String to identify the originator of this request.
     * @return CF7GSC_Google_Bookshelves
     */
    public function listBookshelves($userId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_Bookshelves($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @opt_param string source String to identify the originator of this request.
     * @return CF7GSC_Google_Bookshelf
     */
    public function get($userId, $shelf, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_Bookshelf($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_BookshelvesVolumesServiceResource extends CF7GSC_Google_ServiceResource {
    ...
    public function listBookshelvesVolumes($userId, $shelf, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_Volumes($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_MyconfigServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @opt_param string source String to identify the originator of this request.
     * @return CF7GSC_Google_DownloadAccesses
     */
    public function releaseDownloadAccess($volumeIds, $cpksver, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CF7GSC_Google_DownloadAccesses($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @opt_param string locale ISO-639-1, ISO-3166-1 codes for message localization, i.e. en_US.
     * @return CF7GSC_Google_RequestAccess
     */
    public function requestAccess($source, $volumeId, $nonce, $cpksver, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CF7GSC_Google_RequestAccess($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_VolumesServiceResource extends CF7GSC_Google_ServiceResource {
    ...
    public function get($volumeId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_Volume($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_VolumesAssociatedServiceResource extends CF7GSC_Google_ServiceResource {
   ...
   *  </code>
   */
  class CF7GSC_Google_MylibraryServiceResource extends CF7GSC_Google_ServiceResource {
   ...
   *  </code>
   */
  class CF7GSC_Google_MylibraryBookshelvesServiceResource extends CF7GSC_Google_ServiceResource {
   ...
   *  </code>
   */
  class CF7GSC_Google_MylibraryBookshelvesVolumesServiceResource extends CF7GSC_Google_ServiceResource {
   ...
   *  </code>
   */
  class CF7GSC_Google_MylibraryReadingpositionsServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @return CF7GSC_Google_ReadingPosition
     */
    public function get($volumeId, $optParams = array()) {
      $params = array('volumeId' => $volumeId);
      $params = array_merge($params, $optParams);
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_ReadingPosition($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_MylibraryAnnotationsServiceResource extends CF7GSC_Google_ServiceResource {


    /**
     * Inserts a new annotation. (annotations.insert)
     *
     * @param CF7GSC_Google_Annotation $postBody
     * @param array $optParams Optional parameters.
     *
     * @opt_param string source String to identify the originator of this request.
     * @return CF7GSC_Google_Annotation
     */
    public function insert(CF7GSC_Google_Annotation $postBody, $optParams = array()) {
      $params = array('postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_Annotation($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CF7GSC_Google_Annotations
     */
    public function listMylibraryAnnotations($optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_Annotations($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CF7GSC_Google_Annotation
     */
    public function update($annotationId, CF7GSC_Google_Annotation $postBody, $optParams = array()) {
 ...
 * @author Google, Inc.
 */
class CF7GSC_Google_BooksService extends CF7GSC_Google_Service {
  public $layers;
...
class CF7GSC_Google_Annotation extends CF7GSC_Google_Model {
  ...
  public function setCurrentVersionRanges(CF7GSC_Google_AnnotationCurrentVersionRanges $currentVersionRanges) {
  ...
  public function setClientVersionRanges(CF7GSC_Google_AnnotationClientVersionRanges $clientVersionRanges) {
...
class CF7GSC_Google_AnnotationClientVersionRanges extends CF7GSC_Google_Model {
  public $contentVersion;
  protected $__gbTextRangeType = 'CF7GSC_Google_BooksAnnotationsRange';
  protected $__gbTextRangeDataType = '';
  public $gbTextRange;
  protected $__cfiRangeType = 'CF7GSC_Google_BooksAnnotationsRange';
  protected $__cfiRangeDataType = '';
  public $cfiRange;
  protected $__gbImageRangeType = 'CF7GSC_Google_BooksAnnotationsRange';
  ...
  public function setGbTextRange(CF7GSC_Google_BooksAnnotationsRange $gbTextRange) {
    $this->gbTextRange = $gbTextRange;
  }
  public function getGbTextRange() {
    return $this->gbTextRange;
  }
  public function setCfiRange(CF7GSC_Google_BooksAnnotationsRange $cfiRange) {
    $this->cfiRange = $cfiRange;
  }
  public function getCfiRange() {
    return $this->cfiRange;
  }
  public function setGbImageRange(CF7GSC_Google_BooksAnnotationsRange $gbImageRange) {
...
class CF7GSC_Google_AnnotationCurrentVersionRanges extends CF7GSC_Google_Model {
  public $contentVersion;
  protected $__gbTextRangeType = 'CF7GSC_Google_BooksAnnotationsRange';
  protected $__gbTextRangeDataType = '';
  public $gbTextRange;
...
class CF7GSC_Google_Annotationdata extends CF7GSC_Google_Model {
  ...
  public $encoded_data;
  public $layerId;
  protected $__dataType = 'CF7GSC_Google_BooksLayerGeoData';
  ...
  public function setData(CF7GSC_Google_BooksLayerGeoData $data) {
    $this->data = $data;
  }
  public function getData() {
    return $this->data;
...
class CF7GSC_Google_Annotations extends CF7GSC_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CF7GSC_Google_Annotation';
  ...
  public function setItems(/* array(CF7GSC_Google_Annotation) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_Annotation', __METHOD__);
    $this->items = $items;
  }
...
class CF7GSC_Google_Annotationsdata extends CF7GSC_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CF7GSC_Google_Annotationdata';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $totalItems;
  ...
  public function setItems(/* array(CF7GSC_Google_Annotationdata) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_Annotationdata', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CF7GSC_Google_BooksAnnotationsRange extends CF7GSC_Google_Model {
...
class CF7GSC_Google_BooksLayerGeoData extends CF7GSC_Google_Model {
  protected $__geoType = 'CF7GSC_Google_BooksLayerGeoDataGeo';
  protected $__geoDataType = '';
  public $geo;
  protected $__commonType = 'CF7GSC_Google_BooksLayerGeoDataCommon';
  protected $__commonDataType = '';
  public $common;
  public function setGeo(CF7GSC_Google_BooksLayerGeoDataGeo $geo) {
    $this->geo = $geo;
  }
  public function getGeo() {
    return $this->geo;
  }
  public function setCommon(CF7GSC_Google_BooksLayerGeoDataCommon $common) {
    $this->common = $common;
  }
...
class CF7GSC_Google_BooksLayerGeoDataCommon extends CF7GSC_Google_Model {
  public $lang;
...
class CF7GSC_Google_BooksLayerGeoDataGeo extends CF7GSC_Google_Model {
  public $countryCode;
  public $title;
  public $zoom;
  public $longitude;
  public $mapType;
  public $latitude;
  protected $__boundaryType = 'CF7GSC_Google_BooksLayerGeoDataGeoBoundary';
  protected $__boundaryDataType = 'array';
  public $boundary;
  protected $__viewportType = 'CF7GSC_Google_BooksLayerGeoDataGeoViewport';
  ...
  public function setBoundary(/* array(CF7GSC_Google_BooksLayerGeoDataGeoBoundary) */ $boundary) {
    $this->assertIsArray($boundary, 'CF7GSC_Google_BooksLayerGeoDataGeoBoundary', __METHOD__);
    $this->boundary = $boundary;
  }
  public function getBoundary() {
    return $this->boundary;
  }
  public function setViewport(CF7GSC_Google_BooksLayerGeoDataGeoViewport $viewport) {
...
class CF7GSC_Google_BooksLayerGeoDataGeoBoundary extends CF7GSC_Google_Model {
  public $latitude;
  public $longitude;
  public function setLatitude($latitude) {
    $this->latitude = $latitude;
...
class CF7GSC_Google_BooksLayerGeoDataGeoViewport extends CF7GSC_Google_Model {
  protected $__loType = 'CF7GSC_Google_BooksLayerGeoDataGeoViewportLo';
  protected $__loDataType = '';
  public $lo;
  protected $__hiType = 'CF7GSC_Google_BooksLayerGeoDataGeoViewportHi';
  protected $__hiDataType = '';
  public $hi;
  public function setLo(CF7GSC_Google_BooksLayerGeoDataGeoViewportLo $lo) {
    $this->lo = $lo;
  }
  public function getLo() {
    return $this->lo;
  }
  public function setHi(CF7GSC_Google_BooksLayerGeoDataGeoViewportHi $hi) {
    $this->hi = $hi;
  }
...
class CF7GSC_Google_BooksLayerGeoDataGeoViewportHi extends CF7GSC_Google_Model {
  public $latitude;
  public $longitude;
  public function setLatitude($latitude) {
    $this->latitude = $latitude;
...
class CF7GSC_Google_BooksLayerGeoDataGeoViewportLo extends CF7GSC_Google_Model {
  public $latitude;
  public $longitude;
  public function setLatitude($latitude) {
    $this->latitude = $latitude;
...
class CF7GSC_Google_Bookshelf extends CF7GSC_Google_Model {
  public $kind;
  public $description;
  public $created;
  public $volumeCount;
...
class CF7GSC_Google_Bookshelves extends CF7GSC_Google_Model {
  protected $__itemsType = 'CF7GSC_Google_Bookshelf';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(CF7GSC_Google_Bookshelf) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_Bookshelf', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CF7GSC_Google_ConcurrentAccessRestriction extends CF7GSC_Google_Model {
  public $nonce;
  public $kind;
  public $restricted;
  public $volumeId;
...
class CF7GSC_Google_DownloadAccessRestriction extends CF7GSC_Google_Model {
  public $nonce;
  public $kind;
  public $justAcquired;
...
class CF7GSC_Google_DownloadAccesses extends CF7GSC_Google_Model {
  protected $__downloadAccessListType = 'CF7GSC_Google_DownloadAccessRestriction';
  protected $__downloadAccessListDataType = 'array';
  public $downloadAccessList;
  public $kind;
  public function setDownloadAccessList(/* array(CF7GSC_Google_DownloadAccessRestriction) */ $downloadAccessList) {
    $this->assertIsArray($downloadAccessList, 'CF7GSC_Google_DownloadAccessRestriction', __METHOD__);
...
class CF7GSC_Google_Layersummaries extends CF7GSC_Google_Model {
  public $totalItems;
  protected $__itemsType = 'CF7GSC_Google_Layersummary';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setTotalItems($totalItems) {
  ...
  public function setItems(/* array(CF7GSC_Google_Layersummary) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_Layersummary', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CF7GSC_Google_Layersummary extends CF7GSC_Google_Model {
  public $kind;
...
class CF7GSC_Google_ReadingPosition extends CF7GSC_Google_Model {
  public $kind;
...
class CF7GSC_Google_RequestAccess extends CF7GSC_Google_Model {
  protected $__downloadAccessType = 'CF7GSC_Google_DownloadAccessRestriction';
  protected $__downloadAccessDataType = '';
  public $downloadAccess;
  public $kind;
  protected $__concurrentAccessType = 'CF7GSC_Google_ConcurrentAccessRestriction';
  protected $__concurrentAccessDataType = '';
  public $concurrentAccess;
  public function setDownloadAccess(CF7GSC_Google_DownloadAccessRestriction $downloadAccess) {
  ...
  public function setConcurrentAccess(CF7GSC_Google_ConcurrentAccessRestriction $concurrentAccess) {
...
class CF7GSC_Google_Review extends CF7GSC_Google_Model {
  public $rating;
  public $kind;
  protected $__authorType = 'CF7GSC_Google_ReviewAuthor';
  protected $__authorDataType = '';
  public $author;
  public $title;
  public $volumeId;
  public $content;
  protected $__sourceType = 'CF7GSC_Google_ReviewSource';
  ...
  public function setAuthor(CF7GSC_Google_ReviewAuthor $author) {
    $this->author = $author;
  }
  ...
  public function setSource(CF7GSC_Google_ReviewSource $source) {
    $this->source = $source;
  }
  public function getSource() {
    return $this->source;
...
class CF7GSC_Google_ReviewAuthor extends CF7GSC_Google_Model {
  public $displayName;
...
class CF7GSC_Google_ReviewSource extends CF7GSC_Google_Model {
...
class CF7GSC_Google_Volume extends CF7GSC_Google_Model {
  public $kind;
  protected $__accessInfoType = 'CF7GSC_Google_VolumeAccessInfo';
  protected $__accessInfoDataType = '';
  public $accessInfo;
  protected $__searchInfoType = 'CF7GSC_Google_VolumeSearchInfo';
  protected $__searchInfoDataType = '';
  public $searchInfo;
  protected $__saleInfoType = 'CF7GSC_Google_VolumeSaleInfo';
  protected $__saleInfoDataType = '';
  public $saleInfo;
  public $etag;
  protected $__userInfoType = 'CF7GSC_Google_VolumeUserInfo';
  protected $__userInfoDataType = '';
  public $userInfo;
  protected $__volumeInfoType = 'CF7GSC_Google_VolumeVolumeInfo';
  ...
  public function setAccessInfo(CF7GSC_Google_VolumeAccessInfo $accessInfo) {
    $this->accessInfo = $accessInfo;
  }
  public function getAccessInfo() {
    return $this->accessInfo;
  }
  public function setSearchInfo(CF7GSC_Google_VolumeSearchInfo $searchInfo) {
    $this->searchInfo = $searchInfo;
  }
  public function getSearchInfo() {
    return $this->searchInfo;
  }
  public function setSaleInfo(CF7GSC_Google_VolumeSaleInfo $saleInfo) {
  ...
  public function setUserInfo(CF7GSC_Google_VolumeUserInfo $userInfo) {
    $this->userInfo = $userInfo;
  }
  public function getUserInfo() {
    return $this->userInfo;
  }
  public function setVolumeInfo(CF7GSC_Google_VolumeVolumeInfo $volumeInfo) {
...
class CF7GSC_Google_VolumeAccessInfo extends CF7GSC_Google_Model {
  ...
  protected $__pdfType = 'CF7GSC_Google_VolumeAccessInfoPdf';
  protected $__pdfDataType = '';
  public $pdf;
  public $viewability;
  protected $__epubType = 'CF7GSC_Google_VolumeAccessInfoEpub';
  ...
  public function setPdf(CF7GSC_Google_VolumeAccessInfoPdf $pdf) {
    $this->pdf = $pdf;
  }
  ...
  public function setEpub(CF7GSC_Google_VolumeAccessInfoEpub $epub) {
    $this->epub = $epub;
  }
...
class CF7GSC_Google_VolumeAccessInfoEpub extends CF7GSC_Google_Model {
  public $isAvailable;
  public $downloadLink;
  public $acsTokenLink;
...
class CF7GSC_Google_VolumeAccessInfoPdf extends CF7GSC_Google_Model {
  public $isAvailable;
  public $downloadLink;
  public $acsTokenLink;
  public function setIsAvailable($isAvailable) {
...
class CF7GSC_Google_VolumeSaleInfo extends CF7GSC_Google_Model {
  public $country;
  protected $__retailPriceType = 'CF7GSC_Google_VolumeSaleInfoRetailPrice';
  ...
  public $buyLink;
  public $onSaleDate;
  protected $__listPriceType = 'CF7GSC_Google_VolumeSaleInfoListPrice';
  ...
  public function setRetailPrice(CF7GSC_Google_VolumeSaleInfoRetailPrice $retailPrice) {
  ...
  public function setListPrice(CF7GSC_Google_VolumeSaleInfoListPrice $listPrice) {
...
class CF7GSC_Google_VolumeSaleInfoListPrice extends CF7GSC_Google_Model {
  public $amount;
  public $currencyCode;
...
class CF7GSC_Google_VolumeSaleInfoRetailPrice extends CF7GSC_Google_Model {
  public $amount;
  public $currencyCode;
  public function setAmount($amount) {
    $this->amount = $amount;
...
class CF7GSC_Google_VolumeSearchInfo extends CF7GSC_Google_Model {
  public $textSnippet;
...
class CF7GSC_Google_VolumeUserInfo extends CF7GSC_Google_Model {
  public $isInMyBooks;
  public $updated;
  protected $__reviewType = 'CF7GSC_Google_Review';
  protected $__reviewDataType = '';
  public $review;
  public $isPurchased;
  protected $__readingPositionType = 'CF7GSC_Google_ReadingPosition';
  ...
  public function setReview(CF7GSC_Google_Review $review) {
    $this->review = $review;
  }
  ...
  public function setReadingPosition(CF7GSC_Google_ReadingPosition $readingPosition) {
...
class CF7GSC_Google_VolumeVolumeInfo extends CF7GSC_Google_Model {
  public $publisher;
  public $subtitle;
  public $description;
  public $language;
  public $pageCount;
  protected $__imageLinksType = 'CF7GSC_Google_VolumeVolumeInfoImageLinks';
  ...
  public $ratingsCount;
  public $mainCategory;
  protected $__dimensionsType = 'CF7GSC_Google_VolumeVolumeInfoDimensions';
  protected $__dimensionsDataType = '';
  public $dimensions;
  public $contentVersion;
  protected $__industryIdentifiersType = 'CF7GSC_Google_VolumeVolumeInfoIndustryIdentifiers';
  ...
  public function setImageLinks(CF7GSC_Google_VolumeVolumeInfoImageLinks $imageLinks) {
  ...
  public function setDimensions(CF7GSC_Google_VolumeVolumeInfoDimensions $dimensions) {
  ...
  public function setIndustryIdentifiers(/* array(CF7GSC_Google_VolumeVolumeInfoIndustryIdentifiers) */ $industryIdentifiers) {
    $this->assertIsArray($industryIdentifiers, 'CF7GSC_Google_VolumeVolumeInfoIndustryIdentifiers', __METHOD__);
...
class CF7GSC_Google_VolumeVolumeInfoDimensions extends CF7GSC_Google_Model {
  public $width;
  public $thickness;
  public $height;
...
class CF7GSC_Google_VolumeVolumeInfoImageLinks extends CF7GSC_Google_Model {
  public $medium;
...
class CF7GSC_Google_VolumeVolumeInfoIndustryIdentifiers extends CF7GSC_Google_Model {
  public $identifier;
  public $type;
...
class CF7GSC_Google_Volumeannotation extends CF7GSC_Google_Model {
  public $annotationType;
  public $kind;
  public $updated;
  public $deleted;
  protected $__contentRangesType = 'CF7GSC_Google_VolumeannotationContentRanges';
  ...
  public function setContentRanges(CF7GSC_Google_VolumeannotationContentRanges $contentRanges) {
...
class CF7GSC_Google_VolumeannotationContentRanges extends CF7GSC_Google_Model {
  public $contentVersion;
  protected $__gbTextRangeType = 'CF7GSC_Google_BooksAnnotationsRange';
  protected $__gbTextRangeDataType = '';
  public $gbTextRange;
...
class CF7GSC_Google_Volumeannotations extends CF7GSC_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CF7GSC_Google_Volumeannotation';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $totalItems;
  ...
  public function setItems(/* array(CF7GSC_Google_Volumeannotation) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_Volumeannotation', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CF7GSC_Google_Volumes extends CF7GSC_Google_Model {
  public $totalItems;
  protected $__itemsType = 'CF7GSC_Google_Volume';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setTotalItems($totalItems) {
  ...
  public function setItems(/* array(CF7GSC_Google_Volume) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_Volume', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
