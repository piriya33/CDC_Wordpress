 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $siteVerificationService = new CF7GSC_Google_SiteVerificationService(...);
   *   $webResource = $siteVerificationService->webResource;
   *  </code>
   */
  class CF7GSC_Google_WebResourceServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @param CF7GSC_Google_SiteVerificationWebResourceResource $postBody
     * @param array $optParams Optional parameters.
     * @return CF7GSC_Google_SiteVerificationWebResourceResource
     */
    public function insert($verificationMethod, CF7GSC_Google_SiteVerificationWebResourceResource $postBody, $optParams = array()) {
      $params = array('verificationMethod' => $verificationMethod, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_SiteVerificationWebResourceResource($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param array $optParams Optional parameters.
     * @return CF7GSC_Google_SiteVerificationWebResourceListResponse
     */
    public function listWebResource($optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CF7GSC_Google_SiteVerificationWebResourceListResponse($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CF7GSC_Google_SiteVerificationWebResourceResource
     */
    public function update($id, CF7GSC_Google_SiteVerificationWebResourceResource $postBody, $optParams = array()) {
     ...
     * @return CF7GSC_Google_SiteVerificationWebResourceResource
     */
    public function patch($id, CF7GSC_Google_SiteVerificationWebResourceResource $postBody, $optParams = array()) {
      $params = array('id' => $id, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
     ...
     *
     * @param CF7GSC_Google_SiteVerificationWebResourceGettokenRequest $postBody
     * @param array $optParams Optional parameters.
     * @return CF7GSC_Google_SiteVerificationWebResourceGettokenResponse
     */
    public function getToken(CF7GSC_Google_SiteVerificationWebResourceGettokenRequest $postBody, $optParams = array()) {
      $params = array('postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('getToken', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_SiteVerificationWebResourceGettokenResponse($data);
      } else {
        return $data;
      }
    }
 ...
 * @author Google, Inc.
 */
class CF7GSC_Google_SiteVerificationService extends CF7GSC_Google_Service {
  public $webResource;
  /**
...
class CF7GSC_Google_SiteVerificationWebResourceGettokenRequest extends CF7GSC_Google_Model {
  ...
  public function setSite(CF7GSC_Google_SiteVerificationWebResourceGettokenRequestSite $site) {
    $this->site = $site;
  }
...
class CF7GSC_Google_SiteVerificationWebResourceGettokenRequestSite extends CF7GSC_Google_Model {
  public $identifier;
  public $type;
...
class CF7GSC_Google_SiteVerificationWebResourceGettokenResponse extends CF7GSC_Google_Model {
  public $token;
  public $method;
...
class CF7GSC_Google_SiteVerificationWebResourceListResponse extends CF7GSC_Google_Model {
  protected $__itemsType = 'CF7GSC_Google_SiteVerificationWebResourceResource';
  protected $__itemsDataType = 'array';
  public $items;
  public function setItems(/* array(CF7GSC_Google_SiteVerificationWebResourceResource) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_SiteVerificationWebResourceResource', __METHOD__);
    $this->items = $items;
  }
...
class CF7GSC_Google_SiteVerificationWebResourceResource extends CF7GSC_Google_Model {
  public $owners;
  public $id;
  protected $__siteType = 'CF7GSC_Google_SiteVerificationWebResourceResourceSite';
  protected $__siteDataType = '';
  public $site;
  ...
  public function setSite(CF7GSC_Google_SiteVerificationWebResourceResourceSite $site) {
    $this->site = $site;
  }
  public function getSite() {
    return $this->site;
...
class CF7GSC_Google_SiteVerificationWebResourceResourceSite extends CF7GSC_Google_Model {
  public $identifier;
  public $type;
  public function setIdentifier($identifier) {
    $this->identifier = $identifier;
