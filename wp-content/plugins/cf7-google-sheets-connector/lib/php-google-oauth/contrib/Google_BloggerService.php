 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $bloggerService = new CF7GSC_Google_BloggerService(...);
   *   $blogs = $bloggerService->blogs;
   *  </code>
   */
  class CF7GSC_Google_BlogsServiceResource extends CF7GSC_Google_ServiceResource {
    ...
    public function listByUser($userId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CF7GSC_Google_BlogList($data);
      } else {
        return $data;
      }
    }
    ...
    public function getByUrl($optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CF7GSC_Google_Blog($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_PostsServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @param CF7GSC_Google_Post $postBody
     * @param array $optParams Optional parameters.
     * @return CF7GSC_Google_Post
     */
    public function insert($blogId, CF7GSC_Google_Post $postBody, $optParams = array()) {
      $params = array('blogId' => $blogId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_Post($data);
      } else {
        return $data;
      }
    }
    ...
    public function search($blogId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CF7GSC_Google_PostList($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CF7GSC_Google_Post
     */
    public function update($blogId, $postId, CF7GSC_Google_Post $postBody, $optParams = array()) {
     ...
     * @return CF7GSC_Google_Post
     */
    public function patch($blogId, $postId, CF7GSC_Google_Post $postBody, $optParams = array()) {
      $params = array('blogId' => $blogId, 'postId' => $postId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class CF7GSC_Google_PagesServiceResource extends CF7GSC_Google_ServiceResource {
    ...
    public function listPages($blogId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_PageList($data);
      } else {
        return $data;
      }
    }
    ...
    public function get($blogId, $pageId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_Page($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_UsersServiceResource extends CF7GSC_Google_ServiceResource {
    ...
    public function get($userId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_User($data);
      } else {
        return $data;
      }
    }
 ...
 * @author Google, Inc.
 */
class CF7GSC_Google_BloggerService extends CF7GSC_Google_Service {
  public $blogs;
  public $posts;
  public $pages;
  public $comments;
  ...
  public function __construct(CF7GSC_Google_Client $client) {
    ...
    $this->users = new CF7GSC_Google_UsersServiceResource($this, $this->serviceName, 'users', json_decode('{"methods": {"get": {"scopes": ["https://www.googleapis.com/auth/blogger", "https://www.googleapis.com/auth/blogger.readonly"], "parameters": {"userId": {"required": true, "type": "string", "location": "path"}}, "id": "blogger.users.get", "httpMethod": "GET", "path": "users/{userId}", "response": {"$ref": "User"}}}}', true));

  }
}

class CF7GSC_Google_Blog extends CF7GSC_Google_Model {
  public $kind;
  public $description;
  protected $__localeType = 'CF7GSC_Google_BlogLocale';
  protected $__localeDataType = '';
  public $locale;
  protected $__postsType = 'CF7GSC_Google_BlogPosts';
  protected $__postsDataType = '';
  public $posts;
  public $customMetaData;
  public $updated;
  protected $__pagesType = 'CF7GSC_Google_BlogPages';
  ...
  public function setLocale(CF7GSC_Google_BlogLocale $locale) {
    $this->locale = $locale;
  }
  public function getLocale() {
    return $this->locale;
  }
  public function setPosts(CF7GSC_Google_BlogPosts $posts) {
    $this->posts = $posts;
  }
  ...
  public function setPages(CF7GSC_Google_BlogPages $pages) {
    $this->pages = $pages;
  }
...
class CF7GSC_Google_BlogList extends CF7GSC_Google_Model {
  protected $__itemsType = 'CF7GSC_Google_Blog';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(CF7GSC_Google_Blog) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_Blog', __METHOD__);
    $this->items = $items;
  }
...
class CF7GSC_Google_BlogLocale extends CF7GSC_Google_Model {
  public $country;
  public $variant;
  public $language;
...
class CF7GSC_Google_BlogPages extends CF7GSC_Google_Model {
  public $totalItems;
  public $selfLink;
...
class CF7GSC_Google_BlogPosts extends CF7GSC_Google_Model {
  public $totalItems;
  protected $__itemsType = 'CF7GSC_Google_Post';
  protected $__itemsDataType = 'array';
  public $items;
  public $selfLink;
  public function setTotalItems($totalItems) {
  ...
  public function setItems(/* array(CF7GSC_Google_Post) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_Post', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CF7GSC_Google_Comment extends CF7GSC_Google_Model {
  ...
  public $inReplyTo;
  protected $__authorType = 'CF7GSC_Google_CommentAuthor';
  protected $__authorDataType = '';
  public $author;
  public $updated;
  protected $__blogType = 'CF7GSC_Google_CommentBlog';
  protected $__blogDataType = '';
  public $blog;
  public $published;
  protected $__postType = 'CF7GSC_Google_CommentPost';
  ...
  public function setAuthor(CF7GSC_Google_CommentAuthor $author) {
    $this->author = $author;
  }
  ...
  public function setBlog(CF7GSC_Google_CommentBlog $blog) {
    $this->blog = $blog;
  }
  ...
  public function setPost(CF7GSC_Google_CommentPost $post) {
    $this->post = $post;
  }
...
class CF7GSC_Google_CommentAuthor extends CF7GSC_Google_Model {
  public $url;
  protected $__imageType = 'CF7GSC_Google_CommentAuthorImage';
  ...
  public function setImage(CF7GSC_Google_CommentAuthorImage $image) {
    $this->image = $image;
  }
...
class CF7GSC_Google_CommentAuthorImage extends CF7GSC_Google_Model {
  public $url;
  public function setUrl($url) {
    $this->url = $url;
  }
...
class CF7GSC_Google_CommentBlog extends CF7GSC_Google_Model {
  public $id;
  public function setId($id) {
    $this->id = $id;
  }
...
class CF7GSC_Google_CommentPost extends CF7GSC_Google_Model {
  public $id;
  public function setId($id) {
    $this->id = $id;
  }
...
class CF7GSC_Google_Page extends CF7GSC_Google_Model {
  public $content;
  public $kind;
  protected $__authorType = 'CF7GSC_Google_PageAuthor';
  protected $__authorDataType = '';
  public $author;
  public $url;
  public $title;
  public $updated;
  protected $__blogType = 'CF7GSC_Google_PageBlog';
  protected $__blogDataType = '';
  public $blog;
  public $published;
  public $id;
  ...
  public function setAuthor(CF7GSC_Google_PageAuthor $author) {
    $this->author = $author;
  }
  public function getAuthor() {
    return $this->author;
  ...
  public function setBlog(CF7GSC_Google_PageBlog $blog) {
    $this->blog = $blog;
  }
  public function getBlog() {
    return $this->blog;
...
class CF7GSC_Google_PageAuthor extends CF7GSC_Google_Model {
  public $url;
  protected $__imageType = 'CF7GSC_Google_PageAuthorImage';
  protected $__imageDataType = '';
  public $image;
  public $displayName;
  public $id;
  ...
  public function setImage(CF7GSC_Google_PageAuthorImage $image) {
    $this->image = $image;
  }
  public function getImage() {
    return $this->image;
...
class CF7GSC_Google_PageAuthorImage extends CF7GSC_Google_Model {
  public $url;
  public function setUrl($url) {
    $this->url = $url;
  }
...
class CF7GSC_Google_PageBlog extends CF7GSC_Google_Model {
  public $id;
  public function setId($id) {
    $this->id = $id;
  }
...
class CF7GSC_Google_PageList extends CF7GSC_Google_Model {
  protected $__itemsType = 'CF7GSC_Google_Page';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(CF7GSC_Google_Page) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_Page', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CF7GSC_Google_Post extends CF7GSC_Google_Model {
  public $content;
  public $kind;
  protected $__authorType = 'CF7GSC_Google_PostAuthor';
  protected $__authorDataType = '';
  public $author;
  protected $__repliesType = 'CF7GSC_Google_PostReplies';
  protected $__repliesDataType = '';
  public $replies;
  public $labels;
  public $customMetaData;
  public $updated;
  protected $__blogType = 'CF7GSC_Google_PostBlog';
  protected $__blogDataType = '';
  public $blog;
  public $url;
  protected $__locationType = 'CF7GSC_Google_PostLocation';
  ...
  public function setAuthor(CF7GSC_Google_PostAuthor $author) {
    $this->author = $author;
  }
  public function getAuthor() {
    return $this->author;
  }
  public function setReplies(CF7GSC_Google_PostReplies $replies) {
  ...
  public function setBlog(CF7GSC_Google_PostBlog $blog) {
    $this->blog = $blog;
  }
  public function getBlog() {
    return $this->blog;
  ...
  public function setLocation(CF7GSC_Google_PostLocation $location) {
...
class CF7GSC_Google_PostAuthor extends CF7GSC_Google_Model {
  public $url;
  protected $__imageType = 'CF7GSC_Google_PostAuthorImage';
  protected $__imageDataType = '';
  public $image;
  public $displayName;
  public $id;
  ...
  public function setImage(CF7GSC_Google_PostAuthorImage $image) {
    $this->image = $image;
  }
  public function getImage() {
    return $this->image;
...
class CF7GSC_Google_PostAuthorImage extends CF7GSC_Google_Model {
  public $url;
  public function setUrl($url) {
    $this->url = $url;
  }
...
class CF7GSC_Google_PostBlog extends CF7GSC_Google_Model {
  public $id;
  public function setId($id) {
    $this->id = $id;
  }
...
class CF7GSC_Google_PostList extends CF7GSC_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CF7GSC_Google_Post';
  protected $__itemsDataType = 'array';
  public $items;
...
class CF7GSC_Google_PostLocation extends CF7GSC_Google_Model {
  public $lat;
  public $lng;
  public $span;
  public $name;
...
class CF7GSC_Google_PostReplies extends CF7GSC_Google_Model {
  public $totalItems;
  protected $__itemsType = 'CF7GSC_Google_Comment';
  protected $__itemsDataType = 'array';
  public $items;
...
class CF7GSC_Google_User extends CF7GSC_Google_Model {
  ...
  public $displayName;
  public $created;
  protected $__localeType = 'CF7GSC_Google_UserLocale';
  protected $__localeDataType = '';
  public $locale;
  protected $__blogsType = 'CF7GSC_Google_UserBlogs';
  ...
  public function setLocale(CF7GSC_Google_UserLocale $locale) {
    $this->locale = $locale;
  }
  public function getLocale() {
    return $this->locale;
  }
  public function setBlogs(CF7GSC_Google_UserBlogs $blogs) {
    $this->blogs = $blogs;
  }
...
class CF7GSC_Google_UserBlogs extends CF7GSC_Google_Model {
  public $selfLink;
  public function setSelfLink($selfLink) {
    $this->selfLink = $selfLink;
  }
...
class CF7GSC_Google_UserLocale extends CF7GSC_Google_Model {
  public $country;
  public $variant;
  public $language;
  public function setCountry($country) {
