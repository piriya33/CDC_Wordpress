 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $taskqueueService = new CF7GSC_Google_TaskqueueService(...);
   *   $taskqueues = $taskqueueService->taskqueues;
   *  </code>
   */
  class CF7GSC_Google_TaskqueuesServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @return CF7GSC_Google_TaskQueue
     */
    public function get($project, $taskqueue, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CF7GSC_Google_TaskQueue($data);
      } else {
        return $data;
      }
    }
  ...
  class CF7GSC_Google_TasksServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     */
    public function insert($project, $taskqueue, CF7GSC_Google_Task $postBody, $optParams = array()) {
    ...
    public function listTasks($project, $taskqueue, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CF7GSC_Google_Tasks2($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CF7GSC_Google_Task
     */
    public function update($project, $taskqueue, $task, $newLeaseSeconds, CF7GSC_Google_Task $postBody, $optParams = array()) {
     ...
     * @return CF7GSC_Google_Task
     */
    public function patch($project, $taskqueue, $task, $newLeaseSeconds, CF7GSC_Google_Task $postBody, $optParams = array()) {
      $params = array('project' => $project, 'taskqueue' => $taskqueue, 'task' => $task, 'newLeaseSeconds' => $newLeaseSeconds, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
...
/**
 * Service definition for CF7GSC_Google_TaskQueue (v1beta2).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class CF7GSC_Google_TaskqueueService extends CF7GSC_Google_Service {
  public $taskqueues;
  public $tasks;
  /**
...
class CF7GSC_Google_TaskQueue extends CF7GSC_Google_Model {
  public $kind;
  protected $__statsType = 'CF7GSC_Google_TaskQueueStats';
  protected $__statsDataType = '';
  public $stats;
  public $id;
  public $maxLeases;
  protected $__aclType = 'CF7GSC_Google_TaskQueueAcl';
  ...
  public function setStats(CF7GSC_Google_TaskQueueStats $stats) {
    $this->stats = $stats;
  }
  ...
  public function setAcl(CF7GSC_Google_TaskQueueAcl $acl) {
    $this->acl = $acl;
  }
...
class CF7GSC_Google_TaskQueueAcl extends CF7GSC_Google_Model {
...
class CF7GSC_Google_TaskQueueStats extends CF7GSC_Google_Model {
  public $oldestTask;
...
class CF7GSC_Google_Tasks2 extends CF7GSC_Google_Model {
  protected $__itemsType = 'CF7GSC_Google_Task';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
