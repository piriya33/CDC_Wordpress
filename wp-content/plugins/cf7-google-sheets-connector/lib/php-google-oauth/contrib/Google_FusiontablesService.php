 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $fusiontablesService = new CF7GSC_Google_FusiontablesService(...);
   *   $column = $fusiontablesService->column;
   *  </code>
   */
  class CF7GSC_Google_ColumnServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @param CF7GSC_Google_Column $postBody
     * @param array $optParams Optional parameters.
     * @return CF7GSC_Google_Column
     */
    public function insert($tableId, CF7GSC_Google_Column $postBody, $optParams = array()) {
      $params = array('tableId' => $tableId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_Column($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CF7GSC_Google_ColumnList
     */
    public function listColumn($tableId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CF7GSC_Google_ColumnList($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CF7GSC_Google_Column
     */
    public function update($tableId, $columnId, CF7GSC_Google_Column $postBody, $optParams = array()) {
     ...
     * @return CF7GSC_Google_Column
     */
    public function patch($tableId, $columnId, CF7GSC_Google_Column $postBody, $optParams = array()) {
      $params = array('tableId' => $tableId, 'columnId' => $columnId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class CF7GSC_Google_QueryServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @return CF7GSC_Google_Sqlresponse
     */
    public function sqlGet($sql, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CF7GSC_Google_Sqlresponse($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_StyleServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @param CF7GSC_Google_StyleSetting $postBody
     * @param array $optParams Optional parameters.
     * @return CF7GSC_Google_StyleSetting
     */
    public function insert($tableId, CF7GSC_Google_StyleSetting $postBody, $optParams = array()) {
      $params = array('tableId' => $tableId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_StyleSetting($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CF7GSC_Google_StyleSettingList
     */
    public function listStyle($tableId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_StyleSettingList($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CF7GSC_Google_StyleSetting
     */
    public function update($tableId, $styleId, CF7GSC_Google_StyleSetting $postBody, $optParams = array()) {
     ...
     * @return CF7GSC_Google_StyleSetting
     */
    public function patch($tableId, $styleId, CF7GSC_Google_StyleSetting $postBody, $optParams = array()) {
      $params = array('tableId' => $tableId, 'styleId' => $styleId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
   ...
   *  </code>
   */
  class CF7GSC_Google_TemplateServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @param CF7GSC_Google_Template $postBody
     * @param array $optParams Optional parameters.
     * @return CF7GSC_Google_Template
     */
    public function insert($tableId, CF7GSC_Google_Template $postBody, $optParams = array()) {
      $params = array('tableId' => $tableId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_Template($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CF7GSC_Google_TemplateList
     */
    public function listTemplate($tableId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_TemplateList($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CF7GSC_Google_Template
     */
    public function update($tableId, $templateId, CF7GSC_Google_Template $postBody, $optParams = array()) {
     ...
     * @return CF7GSC_Google_Template
     */
    public function patch($tableId, $templateId, CF7GSC_Google_Template $postBody, $optParams = array()) {
      $params = array('tableId' => $tableId, 'templateId' => $templateId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
   ...
   *  </code>
   */
  class CF7GSC_Google_TableServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     */
    public function insert(CF7GSC_Google_Table $postBody, $optParams = array()) {
     ...
     * @return CF7GSC_Google_Table
     */
    public function update($tableId, CF7GSC_Google_Table $postBody, $optParams = array()) {
      $params = array('tableId' => $tableId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('update', array($params));
      if ($this->useObjects()) {
     ...
     * @return CF7GSC_Google_Table
     */
    public function patch($tableId, CF7GSC_Google_Table $postBody, $optParams = array()) {
      $params = array('tableId' => $tableId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
 ...
 * @author Google, Inc.
 */
class CF7GSC_Google_FusiontablesService extends CF7GSC_Google_Service {
  public $column;
  public $query;
  public $style;
  public $template;
...
class CF7GSC_Google_Column extends CF7GSC_Google_Model {
  public $kind;
  public $type;
  public $columnId;
  public $name;
  protected $__baseColumnType = 'CF7GSC_Google_ColumnBaseColumn';
  ...
  public function setBaseColumn(CF7GSC_Google_ColumnBaseColumn $baseColumn) {
...
class CF7GSC_Google_ColumnBaseColumn extends CF7GSC_Google_Model {
  public $tableIndex;
  public $columnId;
...
class CF7GSC_Google_ColumnList extends CF7GSC_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CF7GSC_Google_Column';
  ...
  public function setItems(/* array(CF7GSC_Google_Column) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_Column', __METHOD__);
    $this->items = $items;
  }
...
class CF7GSC_Google_Geometry extends CF7GSC_Google_Model {
  public $geometry;
  public $type;
  public $geometries;
...
class CF7GSC_Google_Line extends CF7GSC_Google_Model {
  public $type;
  public $coordinates;
  public function setType($type) {
    $this->type = $type;
...
class CF7GSC_Google_LineStyle extends CF7GSC_Google_Model {
  public $strokeWeight;
  protected $__strokeWeightStylerType = 'CF7GSC_Google_StyleFunction';
  protected $__strokeWeightStylerDataType = '';
  public $strokeWeightStyler;
  public $strokeColor;
  public $strokeOpacity;
  protected $__strokeColorStylerType = 'CF7GSC_Google_StyleFunction';
  ...
  public function setStrokeWeightStyler(CF7GSC_Google_StyleFunction $strokeWeightStyler) {
  ...
  public function setStrokeColorStyler(CF7GSC_Google_StyleFunction $strokeColorStyler) {
...
class CF7GSC_Google_Point extends CF7GSC_Google_Model {
  public $type;
  public $coordinates;
  public function setType($type) {
    $this->type = $type;
...
class CF7GSC_Google_PointStyle extends CF7GSC_Google_Model {
  protected $__iconStylerType = 'CF7GSC_Google_StyleFunction';
  protected $__iconStylerDataType = '';
  public $iconStyler;
  public $iconName;
  public function setIconStyler(CF7GSC_Google_StyleFunction $iconStyler) {
...
class CF7GSC_Google_Polygon extends CF7GSC_Google_Model {
  public $type;
  public $coordinates;
  public function setType($type) {
    $this->type = $type;
...
class CF7GSC_Google_PolygonStyle extends CF7GSC_Google_Model {
  protected $__strokeColorStylerType = 'CF7GSC_Google_StyleFunction';
  protected $__strokeColorStylerDataType = '';
  public $strokeColorStyler;
  public $strokeWeight;
  ...
  protected $__strokeWeightStylerDataType = '';
  public $strokeWeightStyler;
  protected $__fillColorStylerType = 'CF7GSC_Google_StyleFunction';
  ...
  public function setFillColorStyler(CF7GSC_Google_StyleFunction $fillColorStyler) {
...
class CF7GSC_Google_Sqlresponse extends CF7GSC_Google_Model {
  public $kind;
  public $rows;
  public $columns;
  public function setKind($kind) {
...
class CF7GSC_Google_StyleFunction extends CF7GSC_Google_Model {
  protected $__gradientType = 'CF7GSC_Google_StyleFunctionGradient';
  protected $__gradientDataType = '';
  public $gradient;
  public $columnName;
  protected $__bucketsType = 'CF7GSC_Google_Bucket';
  protected $__bucketsDataType = 'array';
  public $buckets;
  public $kind;
  public function setGradient(CF7GSC_Google_StyleFunctionGradient $gradient) {
  ...
  public function setBuckets(/* array(CF7GSC_Google_Bucket) */ $buckets) {
    $this->assertIsArray($buckets, 'CF7GSC_Google_Bucket', __METHOD__);
...
class CF7GSC_Google_StyleFunctionGradient extends CF7GSC_Google_Model {
  public $max;
  protected $__colorsType = 'CF7GSC_Google_StyleFunctionGradientColors';
  ...
  public function setColors(/* array(CF7GSC_Google_StyleFunctionGradientColors) */ $colors) {
    $this->assertIsArray($colors, 'CF7GSC_Google_StyleFunctionGradientColors', __METHOD__);
    $this->colors = $colors;
  }
...
class CF7GSC_Google_StyleFunctionGradientColors extends CF7GSC_Google_Model {
  public $color;
  public $opacity;
  public function setColor($color) {
    $this->color = $color;
...
class CF7GSC_Google_StyleSetting extends CF7GSC_Google_Model {
  protected $__markerOptionsType = 'CF7GSC_Google_PointStyle';
  protected $__markerOptionsDataType = '';
  public $markerOptions;
  public $kind;
  public $name;
  protected $__polygonOptionsType = 'CF7GSC_Google_PolygonStyle';
  protected $__polygonOptionsDataType = '';
  public $polygonOptions;
  public $isDefaultForTable;
  protected $__polylineOptionsType = 'CF7GSC_Google_LineStyle';
  protected $__polylineOptionsDataType = '';
  public $polylineOptions;
  public $tableId;
  public $styleId;
  public function setMarkerOptions(CF7GSC_Google_PointStyle $markerOptions) {
  ...
  public function setPolygonOptions(CF7GSC_Google_PolygonStyle $polygonOptions) {
  ...
  public function setPolylineOptions(CF7GSC_Google_LineStyle $polylineOptions) {
...
class CF7GSC_Google_StyleSettingList extends CF7GSC_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CF7GSC_Google_StyleSetting';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $totalItems;
  ...
  public function setItems(/* array(CF7GSC_Google_StyleSetting) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_StyleSetting', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CF7GSC_Google_Table extends CF7GSC_Google_Model {
  ...
  public $sql;
  public $tableId;
  protected $__columnsType = 'CF7GSC_Google_Column';
  ...
  public function setColumns(/* array(CF7GSC_Google_Column) */ $columns) {
    $this->assertIsArray($columns, 'CF7GSC_Google_Column', __METHOD__);
    $this->columns = $columns;
  }
  public function getColumns() {
    return $this->columns;
...
class CF7GSC_Google_TableList extends CF7GSC_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CF7GSC_Google_Table';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setNextPageToken($nextPageToken) {
  ...
  public function setItems(/* array(CF7GSC_Google_Table) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_Table', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CF7GSC_Google_Template extends CF7GSC_Google_Model {
  public $body;
  public $kind;
  public $name;
...
class CF7GSC_Google_TemplateList extends CF7GSC_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CF7GSC_Google_Template';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $totalItems;
  ...
  public function setItems(/* array(CF7GSC_Google_Template) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_Template', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
