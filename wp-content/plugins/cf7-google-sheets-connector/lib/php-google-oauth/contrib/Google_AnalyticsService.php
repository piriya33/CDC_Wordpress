 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $analyticsService = new CF7GSC_Google_AnalyticsService(...);
   *   $management = $analyticsService->management;
   *  </code>
   */
  class CF7GSC_Google_ManagementServiceResource extends CF7GSC_Google_ServiceResource {
   ...
   *  </code>
   */
  class CF7GSC_Google_ManagementDailyUploadsServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @return CF7GSC_Google_DailyUploads
     */
    public function listManagementDailyUploads($accountId, $webPropertyId, $customDataSourceId, $start_date, $end_date, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CF7GSC_Google_DailyUploads($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CF7GSC_Google_DailyUploadAppend
     */
    public function upload($accountId, $webPropertyId, $customDataSourceId, $date, $appendNumber, $type, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CF7GSC_Google_DailyUploadAppend($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_ManagementSegmentsServiceResource extends CF7GSC_Google_ServiceResource {
    ...
    public function listManagementSegments($optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_Segments($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_ManagementProfilesServiceResource extends CF7GSC_Google_ServiceResource {
    ...
    public function listManagementProfiles($accountId, $webPropertyId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_Profiles($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_ManagementCustomDataSourcesServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @return CF7GSC_Google_CustomDataSources
     */
    public function listManagementCustomDataSources($accountId, $webPropertyId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_CustomDataSources($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_ManagementGoalsServiceResource extends CF7GSC_Google_ServiceResource {
    ...
    public function listManagementGoals($accountId, $webPropertyId, $profileId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_Goals($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_ManagementAccountsServiceResource extends CF7GSC_Google_ServiceResource {
    ...
    public function listManagementAccounts($optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_Accounts($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_ManagementWebpropertiesServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @opt_param int start-index An index of the first entity to retrieve. Use this parameter as a pagination mechanism along with the max-results parameter.
     * @return CF7GSC_Google_Webproperties
     */
    public function listManagementWebproperties($accountId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_Webproperties($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_DataServiceResource extends CF7GSC_Google_ServiceResource {
   ...
   *  </code>
   */
  class CF7GSC_Google_DataMcfServiceResource extends CF7GSC_Google_ServiceResource {
    ...
    public function get($ids, $start_date, $end_date, $metrics, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CF7GSC_Google_McfData($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_DataGaServiceResource extends CF7GSC_Google_ServiceResource {
    ...
    public function get($ids, $start_date, $end_date, $metrics, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_GaData($data);
      } else {
        return $data;
      }
    }
 ...
 * @author Google, Inc.
 */
class CF7GSC_Google_AnalyticsService extends CF7GSC_Google_Service {
...
class CF7GSC_Google_AccountChildLink extends CF7GSC_Google_Model {
  public $href;
  public $type;
...
class CF7GSC_Google_Accounts extends CF7GSC_Google_Model {
  public $username;
  public $kind;
  protected $__itemsType = 'CF7GSC_Google_Account';
  ...
  public function setItems(/* array(CF7GSC_Google_Account) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_Account', __METHOD__);
    $this->items = $items;
  }
...
class CF7GSC_Google_CustomDataSource extends CF7GSC_Google_Model {
  public $kind;
  public $description;
  public $created;
  ...
  public $updated;
  public $name;
  protected $__childLinkType = 'CF7GSC_Google_CustomDataSourceChildLink';
  protected $__childLinkDataType = '';
  public $childLink;
  public $webPropertyId;
  protected $__parentLinkType = 'CF7GSC_Google_CustomDataSourceParentLink';
  ...
  public function setChildLink(CF7GSC_Google_CustomDataSourceChildLink $childLink) {
    $this->childLink = $childLink;
  }
  public function getChildLink() {
    return $this->childLink;
  ...
  public function setParentLink(CF7GSC_Google_CustomDataSourceParentLink $parentLink) {
...
class CF7GSC_Google_CustomDataSourceChildLink extends CF7GSC_Google_Model {
  public $href;
  public $type;
  public function setHref($href) {
    $this->href = $href;
...
class CF7GSC_Google_CustomDataSourceParentLink extends CF7GSC_Google_Model {
  public $href;
  public $type;
  public function setHref($href) {
    $this->href = $href;
...
class CF7GSC_Google_CustomDataSources extends CF7GSC_Google_Model {
  public $username;
  public $kind;
  protected $__itemsType = 'CF7GSC_Google_CustomDataSource';
  protected $__itemsDataType = 'array';
  public $items;
  public $itemsPerPage;
  public $previousLink;
  ...
  public function setItems(/* array(CF7GSC_Google_CustomDataSource) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_CustomDataSource', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CF7GSC_Google_DailyUpload extends CF7GSC_Google_Model {
  protected $__recentChangesType = 'CF7GSC_Google_DailyUploadRecentChanges';
  ...
  public $webPropertyId;
  public $createdTime;
  protected $__parentLinkType = 'CF7GSC_Google_DailyUploadParentLink';
  protected $__parentLinkDataType = '';
  public $parentLink;
  public $selfLink;
  public $accountId;
  public function setRecentChanges(/* array(CF7GSC_Google_DailyUploadRecentChanges) */ $recentChanges) {
    $this->assertIsArray($recentChanges, 'CF7GSC_Google_DailyUploadRecentChanges', __METHOD__);
  ...
  public function setParentLink(CF7GSC_Google_DailyUploadParentLink $parentLink) {
    $this->parentLink = $parentLink;
  }
  public function getParentLink() {
    return $this->parentLink;
...
class CF7GSC_Google_DailyUploadAppend extends CF7GSC_Google_Model {
  public $kind;
  public $customDataSourceId;
  public $appendNumber;
  public $webPropertyId;
...
class CF7GSC_Google_DailyUploadParentLink extends CF7GSC_Google_Model {
  public $href;
  public $type;
  public function setHref($href) {
    $this->href = $href;
...
class CF7GSC_Google_DailyUploadRecentChanges extends CF7GSC_Google_Model {
  public $change;
  public $time;
...
class CF7GSC_Google_DailyUploads extends CF7GSC_Google_Model {
  public $username;
  public $kind;
  protected $__itemsType = 'CF7GSC_Google_DailyUpload';
  protected $__itemsDataType = 'array';
  public $items;
  public $itemsPerPage;
  public $previousLink;
  ...
  public function setItems(/* array(CF7GSC_Google_DailyUpload) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_DailyUpload', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CF7GSC_Google_GaData extends CF7GSC_Google_Model {
  public $kind;
  public $rows;
  ...
  public $nextLink;
  public $id;
  protected $__queryType = 'CF7GSC_Google_GaDataQuery';
  protected $__queryDataType = '';
  public $query;
  public $previousLink;
  protected $__profileInfoType = 'CF7GSC_Google_GaDataProfileInfo';
  protected $__profileInfoDataType = '';
  public $profileInfo;
  protected $__columnHeadersType = 'CF7GSC_Google_GaDataColumnHeaders';
  ...
  public function setQuery(CF7GSC_Google_GaDataQuery $query) {
    $this->query = $query;
  }
  ...
  public function setProfileInfo(CF7GSC_Google_GaDataProfileInfo $profileInfo) {
    $this->profileInfo = $profileInfo;
  }
  public function getProfileInfo() {
    return $this->profileInfo;
  }
  public function setColumnHeaders(/* array(CF7GSC_Google_GaDataColumnHeaders) */ $columnHeaders) {
    $this->assertIsArray($columnHeaders, 'CF7GSC_Google_GaDataColumnHeaders', __METHOD__);
...
class CF7GSC_Google_GaDataColumnHeaders extends CF7GSC_Google_Model {
  public $dataType;
  public $columnType;
  public $name;
...
class CF7GSC_Google_GaDataProfileInfo extends CF7GSC_Google_Model {
  public $webPropertyId;
...
class CF7GSC_Google_GaDataQuery extends CF7GSC_Google_Model {
  public $max_results;
  public $sort;
  public $dimensions;
  public $start_date;
...
class CF7GSC_Google_Goal extends CF7GSC_Google_Model {
  public $kind;
  protected $__visitTimeOnSiteDetailsType = 'CF7GSC_Google_GoalVisitTimeOnSiteDetails';
  protected $__visitTimeOnSiteDetailsDataType = '';
  public $visitTimeOnSiteDetails;
  public $name;
  public $created;
  protected $__urlDestinationDetailsType = 'CF7GSC_Google_GoalUrlDestinationDetails';
  protected $__urlDestinationDetailsDataType = '';
  public $urlDestinationDetails;
  public $updated;
  public $value;
  protected $__visitNumPagesDetailsType = 'CF7GSC_Google_GoalVisitNumPagesDetails';
  protected $__visitNumPagesDetailsDataType = '';
  public $visitNumPagesDetails;
  public $internalWebPropertyId;
  protected $__eventDetailsType = 'CF7GSC_Google_GoalEventDetails';
  protected $__eventDetailsDataType = '';
  public $eventDetails;
  public $webPropertyId;
  public $active;
  public $profileId;
  protected $__parentLinkType = 'CF7GSC_Google_GoalParentLink';
  protected $__parentLinkDataType = '';
  public $parentLink;
  public $type;
  public $id;
  ...
  public function setVisitTimeOnSiteDetails(CF7GSC_Google_GoalVisitTimeOnSiteDetails $visitTimeOnSiteDetails) {
  ...
  public function setUrlDestinationDetails(CF7GSC_Google_GoalUrlDestinationDetails $urlDestinationDetails) {
  ...
  public function setVisitNumPagesDetails(CF7GSC_Google_GoalVisitNumPagesDetails $visitNumPagesDetails) {
  ...
  public function setEventDetails(CF7GSC_Google_GoalEventDetails $eventDetails) {
  ...
  public function setParentLink(CF7GSC_Google_GoalParentLink $parentLink) {
    $this->parentLink = $parentLink;
  }
  public function getParentLink() {
    return $this->parentLink;
...
class CF7GSC_Google_GoalEventDetails extends CF7GSC_Google_Model {
  protected $__eventConditionsType = 'CF7GSC_Google_GoalEventDetailsEventConditions';
  protected $__eventConditionsDataType = 'array';
  public $eventConditions;
  public $useEventValue;
  public function setEventConditions(/* array(CF7GSC_Google_GoalEventDetailsEventConditions) */ $eventConditions) {
    $this->assertIsArray($eventConditions, 'CF7GSC_Google_GoalEventDetailsEventConditions', __METHOD__);
...
class CF7GSC_Google_GoalEventDetailsEventConditions extends CF7GSC_Google_Model {
  public $type;
  public $matchType;
  public $expression;
...
class CF7GSC_Google_GoalParentLink extends CF7GSC_Google_Model {
  public $href;
  public $type;
  public function setHref($href) {
    $this->href = $href;
...
class CF7GSC_Google_GoalUrlDestinationDetails extends CF7GSC_Google_Model {
  public $url;
  public $caseSensitive;
  public $matchType;
  protected $__stepsType = 'CF7GSC_Google_GoalUrlDestinationDetailsSteps';
  ...
  public function setSteps(/* array(CF7GSC_Google_GoalUrlDestinationDetailsSteps) */ $steps) {
    $this->assertIsArray($steps, 'CF7GSC_Google_GoalUrlDestinationDetailsSteps', __METHOD__);
    $this->steps = $steps;
  }
...
class CF7GSC_Google_GoalUrlDestinationDetailsSteps extends CF7GSC_Google_Model {
  public $url;
  public $name;
  public $number;
  public function setUrl($url) {
...
class CF7GSC_Google_GoalVisitNumPagesDetails extends CF7GSC_Google_Model {
  public $comparisonType;
  public $comparisonValue;
  public function setComparisonType($comparisonType) {
    $this->comparisonType = $comparisonType;
...
class CF7GSC_Google_GoalVisitTimeOnSiteDetails extends CF7GSC_Google_Model {
  public $comparisonType;
  public $comparisonValue;
  public function setComparisonType($comparisonType) {
    $this->comparisonType = $comparisonType;
...
class CF7GSC_Google_Goals extends CF7GSC_Google_Model {
  public $username;
  public $kind;
  protected $__itemsType = 'CF7GSC_Google_Goal';
  protected $__itemsDataType = 'array';
  public $items;
  public $itemsPerPage;
  public $previousLink;
  ...
  public function setItems(/* array(CF7GSC_Google_Goal) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_Goal', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CF7GSC_Google_McfData extends CF7GSC_Google_Model {
  public $kind;
  protected $__rowsType = 'CF7GSC_Google_McfDataRows';
  ...
  public $nextLink;
  public $id;
  protected $__queryType = 'CF7GSC_Google_McfDataQuery';
  protected $__queryDataType = '';
  public $query;
  public $previousLink;
  protected $__profileInfoType = 'CF7GSC_Google_McfDataProfileInfo';
  protected $__profileInfoDataType = '';
  public $profileInfo;
  protected $__columnHeadersType = 'CF7GSC_Google_McfDataColumnHeaders';
  protected $__columnHeadersDataType = 'array';
  public $columnHeaders;
  public $selfLink;
  public function setKind($kind) {
  ...
  public function setRows(/* array(CF7GSC_Google_McfDataRows) */ $rows) {
    $this->assertIsArray($rows, 'CF7GSC_Google_McfDataRows', __METHOD__);
    $this->rows = $rows;
  }
  public function getRows() {
    return $this->rows;
  ...
  public function setQuery(CF7GSC_Google_McfDataQuery $query) {
    $this->query = $query;
  }
  public function getQuery() {
    return $this->query;
  ...
  public function setProfileInfo(CF7GSC_Google_McfDataProfileInfo $profileInfo) {
    $this->profileInfo = $profileInfo;
  }
  public function getProfileInfo() {
    return $this->profileInfo;
  }
  public function setColumnHeaders(/* array(CF7GSC_Google_McfDataColumnHeaders) */ $columnHeaders) {
    $this->assertIsArray($columnHeaders, 'CF7GSC_Google_McfDataColumnHeaders', __METHOD__);
    $this->columnHeaders = $columnHeaders;
  }
  public function getColumnHeaders() {
    return $this->columnHeaders;
...
class CF7GSC_Google_McfDataColumnHeaders extends CF7GSC_Google_Model {
  public $dataType;
  public $columnType;
  public $name;
  public function setDataType($dataType) {
...
class CF7GSC_Google_McfDataProfileInfo extends CF7GSC_Google_Model {
  public $webPropertyId;
  public $internalWebPropertyId;
  public $tableId;
  public $profileId;
...
class CF7GSC_Google_McfDataQuery extends CF7GSC_Google_Model {
  public $max_results;
  public $sort;
  public $dimensions;
  public $start_date;
...
class CF7GSC_Google_McfDataRows extends CF7GSC_Google_Model {
  public $primitiveValue;
  protected $__conversionPathValueType = 'CF7GSC_Google_McfDataRowsConversionPathValue';
  ...
  public function setConversionPathValue(/* array(CF7GSC_Google_McfDataRowsConversionPathValue) */ $conversionPathValue) {
    $this->assertIsArray($conversionPathValue, 'CF7GSC_Google_McfDataRowsConversionPathValue', __METHOD__);
...
class CF7GSC_Google_McfDataRowsConversionPathValue extends CF7GSC_Google_Model {
  public $nodeValue;
...
class CF7GSC_Google_Profile extends CF7GSC_Google_Model {
  ...
  public $currency;
  public $internalWebPropertyId;
  protected $__childLinkType = 'CF7GSC_Google_ProfileChildLink';
  protected $__childLinkDataType = '';
  public $childLink;
  public $eCommerceTracking;
  public $timezone;
  public $siteSearchCategoryParameters;
  protected $__parentLinkType = 'CF7GSC_Google_ProfileParentLink';
  protected $__parentLinkDataType = '';
  public $parentLink;
  public $id;
  public $selfLink;
  ...
  public function setChildLink(CF7GSC_Google_ProfileChildLink $childLink) {
    $this->childLink = $childLink;
  }
  public function getChildLink() {
    return $this->childLink;
  ...
  public function setParentLink(CF7GSC_Google_ProfileParentLink $parentLink) {
    $this->parentLink = $parentLink;
  }
  public function getParentLink() {
    return $this->parentLink;
...
class CF7GSC_Google_ProfileChildLink extends CF7GSC_Google_Model {
  public $href;
  public $type;
  public function setHref($href) {
    $this->href = $href;
...
class CF7GSC_Google_ProfileParentLink extends CF7GSC_Google_Model {
  public $href;
  public $type;
  public function setHref($href) {
    $this->href = $href;
...
class CF7GSC_Google_Profiles extends CF7GSC_Google_Model {
  public $username;
  public $kind;
  protected $__itemsType = 'CF7GSC_Google_Profile';
  protected $__itemsDataType = 'array';
  public $items;
  public $itemsPerPage;
  public $previousLink;
  ...
  public function setItems(/* array(CF7GSC_Google_Profile) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_Profile', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CF7GSC_Google_Segment extends CF7GSC_Google_Model {
  public $definition;
  public $kind;
  public $segmentId;
  public $created;
...
class CF7GSC_Google_Segments extends CF7GSC_Google_Model {
  public $username;
  public $kind;
  protected $__itemsType = 'CF7GSC_Google_Segment';
  protected $__itemsDataType = 'array';
  public $items;
  public $itemsPerPage;
  public $previousLink;
  ...
  public function setItems(/* array(CF7GSC_Google_Segment) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_Segment', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CF7GSC_Google_Webproperties extends CF7GSC_Google_Model {
  public $username;
  public $kind;
  protected $__itemsType = 'CF7GSC_Google_Webproperty';
  protected $__itemsDataType = 'array';
  public $items;
  public $itemsPerPage;
  public $previousLink;
  ...
  public function setItems(/* array(CF7GSC_Google_Webproperty) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_Webproperty', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CF7GSC_Google_Webproperty extends CF7GSC_Google_Model {
  public $kind;
  public $name;
  public $created;
  public $updated;
  public $websiteUrl;
  public $internalWebPropertyId;
  protected $__childLinkType = 'CF7GSC_Google_WebpropertyChildLink';
  protected $__childLinkDataType = '';
  public $childLink;
  protected $__parentLinkType = 'CF7GSC_Google_WebpropertyParentLink';
  protected $__parentLinkDataType = '';
  public $parentLink;
  public $id;
  public $selfLink;
  ...
  public function setChildLink(CF7GSC_Google_WebpropertyChildLink $childLink) {
    $this->childLink = $childLink;
  }
  public function getChildLink() {
    return $this->childLink;
  }
  public function setParentLink(CF7GSC_Google_WebpropertyParentLink $parentLink) {
    $this->parentLink = $parentLink;
  }
  public function getParentLink() {
    return $this->parentLink;
...
class CF7GSC_Google_WebpropertyChildLink extends CF7GSC_Google_Model {
  public $href;
  public $type;
  public function setHref($href) {
    $this->href = $href;
...
class CF7GSC_Google_WebpropertyParentLink extends CF7GSC_Google_Model {
  public $href;
  public $type;
  public function setHref($href) {
    $this->href = $href;
