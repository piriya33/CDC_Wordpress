 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $adexchangebuyerService = new CF7GSC_Google_AdexchangebuyerService(...);
  ...
  class CF7GSC_Google_AccountsServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     *
     * @param array $optParams Optional parameters.
     * @return CF7GSC_Google_AccountsList
     */
    public function listAccounts($optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CF7GSC_Google_AccountsList($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param int $id The account id
     * @param CF7GSC_Google_Account $postBody
     * @param array $optParams Optional parameters.
     * @return CF7GSC_Google_Account
     */
    public function patch($id, CF7GSC_Google_Account $postBody, $optParams = array()) {
     ...
     * @return CF7GSC_Google_Account
     */
    public function update($id, CF7GSC_Google_Account $postBody, $optParams = array()) {
      $params = array('id' => $id, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class CF7GSC_Google_CreativesServiceResource extends CF7GSC_Google_ServiceResource {
    ...
    public function get($accountId, $buyerCreativeId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_Creative($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param CF7GSC_Google_Creative $postBody
     * @param array $optParams Optional parameters.
     * @return CF7GSC_Google_Creative
     */
    public function insert( CF7GSC_Google_Creative $postBody, $optParams = array()) {
     ...
     * @return CF7GSC_Google_CreativesList
     */
    public function listCreatives($optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_CreativesList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_DirectDealsServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @param array $optParams Optional parameters.
     * @return CF7GSC_Google_DirectDeal
     */
    public function get($id, $optParams = array()) {
      $params = array('id' => $id);
      $params = array_merge($params, $optParams);
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_DirectDeal($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param array $optParams Optional parameters.
     * @return CF7GSC_Google_DirectDealsList
     */
    public function listDirectDeals($optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_DirectDealsList($data);
      } else {
        return $data;
      }
    }
 ...
 * @author Google, Inc.
 */
class CF7GSC_Google_AdexchangebuyerService extends CF7GSC_Google_Service {
  public $accounts;
  public $creatives;
  public $directDeals;
  /**
...
class CF7GSC_Google_Account extends CF7GSC_Google_Model {
  ...
  public function setBidderLocation(/* array(CF7GSC_Google_AccountBidderLocation) */ $bidderLocation) {
    $this->assertIsArray($bidderLocation, 'CF7GSC_Google_AccountBidderLocation', __METHOD__);
...
class CF7GSC_Google_AccountBidderLocation extends CF7GSC_Google_Model {
  public $maximumQps;
  public $region;
  public $url;
...
class CF7GSC_Google_AccountsList extends CF7GSC_Google_Model {
...
class CF7GSC_Google_Creative extends CF7GSC_Google_Model {
  public $HTMLSnippet;
  public $accountId;
  public $advertiserId;
...
class CF7GSC_Google_CreativesList extends CF7GSC_Google_Model {
  protected $__itemsType = 'CF7GSC_Google_Creative';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $nextPageToken;
  public function setItems(/* array(CF7GSC_Google_Creative) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_Creative', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CF7GSC_Google_DirectDeal extends CF7GSC_Google_Model {
  public $accountId;
  public $advertiser;
  public $currencyCode;
  public $endTime;
...
class CF7GSC_Google_DirectDealsList extends CF7GSC_Google_Model {
  protected $__directDealsType = 'CF7GSC_Google_DirectDeal';
  protected $__directDealsDataType = 'array';
  public $directDeals;
  public $kind;
  public function setDirectDeals(/* array(CF7GSC_Google_DirectDeal) */ $directDeals) {
    $this->assertIsArray($directDeals, 'CF7GSC_Google_DirectDeal', __METHOD__);
