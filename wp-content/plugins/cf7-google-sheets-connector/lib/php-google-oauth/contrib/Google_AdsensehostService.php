 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $adsensehostService = new CF7GSC_Google_AdSenseHostService(...);
  ...
  class CF7GSC_Google_AccountsAdclientsServiceResource extends CF7GSC_Google_ServiceResource {
    ...
    public function get($accountId, $adClientId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_AdClient($data);
      } else {
        return $data;
      }
    }
  ...
  class CF7GSC_Google_AccountsAdunitsServiceResource extends CF7GSC_Google_ServiceResource {
    ...
    public function getAdCode($accountId, $adClientId, $adUnitId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CF7GSC_Google_AdCode($data);
      } else {
        return $data;
      }
    }
     ...
     * @param CF7GSC_Google_AdUnit $postBody
     * @param array $optParams Optional parameters.
     * @return CF7GSC_Google_AdUnit
     */
    public function insert($accountId, $adClientId, CF7GSC_Google_AdUnit $postBody, $optParams = array()) {
     ...
     * @return CF7GSC_Google_AdUnit
     */
    public function patch($accountId, $adClientId, $adUnitId, CF7GSC_Google_AdUnit $postBody, $optParams = array()) {
     ...
     * @return CF7GSC_Google_AdUnit
     */
    public function update($accountId, $adClientId, CF7GSC_Google_AdUnit $postBody, $optParams = array()) {
      $params = array('accountId' => $accountId, 'adClientId' => $adClientId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class CF7GSC_Google_AssociationSessionsServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @return CF7GSC_Google_AssociationSession
     */
    public function start($productCode, $websiteUrl, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CF7GSC_Google_AssociationSession($data);
      } else {
        return $data;
      }
    }
  ...
  class CF7GSC_Google_CustomchannelsServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @param CF7GSC_Google_CustomChannel $postBody
     * @param array $optParams Optional parameters.
     * @return CF7GSC_Google_CustomChannel
     */
    public function insert($adClientId, CF7GSC_Google_CustomChannel $postBody, $optParams = array()) {
     ...
     * @return CF7GSC_Google_CustomChannel
     */
    public function patch($adClientId, $customChannelId, CF7GSC_Google_CustomChannel $postBody, $optParams = array()) {
     ...
     * @return CF7GSC_Google_CustomChannel
     */
    public function update($adClientId, CF7GSC_Google_CustomChannel $postBody, $optParams = array()) {
      $params = array('adClientId' => $adClientId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('update', array($params));
      if ($this->useObjects()) {
  ...
  class CF7GSC_Google_UrlchannelsServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @param array $optParams Optional parameters.
     * @return CF7GSC_Google_UrlChannel
     */
    public function delete($adClientId, $urlChannelId, $optParams = array()) {
      ...
      $data = $this->__call('delete', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_UrlChannel($data);
      } else {
        return $data;
      }
    }
     ...
     * @param CF7GSC_Google_UrlChannel $postBody
     * @param array $optParams Optional parameters.
     * @return CF7GSC_Google_UrlChannel
     */
    public function insert($adClientId, CF7GSC_Google_UrlChannel $postBody, $optParams = array()) {
      $params = array('adClientId' => $adClientId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
 ...
 * @author Google, Inc.
 */
class CF7GSC_Google_AdSenseHostService extends CF7GSC_Google_Service {
  public $accounts;
...
class CF7GSC_Google_AdCode extends CF7GSC_Google_Model {
  public $adCode;
  public $kind;
...
class CF7GSC_Google_AssociationSession extends CF7GSC_Google_Model {
  public $accountId;
  public $id;
  public $kind;
  public $productCodes;
...
class CF7GSC_Google_Report extends CF7GSC_Google_Model {
  public $averages;
  protected $__headersType = 'CF7GSC_Google_ReportHeaders';
  ...
  public function setHeaders(/* array(CF7GSC_Google_ReportHeaders) */ $headers) {
    $this->assertIsArray($headers, 'CF7GSC_Google_ReportHeaders', __METHOD__);
...
class CF7GSC_Google_ReportHeaders extends CF7GSC_Google_Model {
  public $currency;
  public $name;
  public $type;
