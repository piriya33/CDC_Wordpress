 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $ganService = new CF7GSC_Google_GanService(...);
   *   $advertisers = $ganService->advertisers;
   *  </code>
   */
  class CF7GSC_Google_AdvertisersServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @return CF7GSC_Google_Advertisers
     */
    public function listAdvertisers($role, $roleId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CF7GSC_Google_Advertisers($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CF7GSC_Google_Advertiser
     */
    public function get($role, $roleId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CF7GSC_Google_Advertiser($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_CcOffersServiceResource extends CF7GSC_Google_ServiceResource {
    ...
    public function listCcOffers($publisher, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_CcOffers($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_LinksServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @param string $role The role of the requester. Valid values: 'advertisers' or 'publishers'.
     * @param string $roleId The ID of the requesting advertiser or publisher.
     * @param CF7GSC_Google_Link $postBody
     * @param array $optParams Optional parameters.
     * @return CF7GSC_Google_Link
     */
    public function insert($role, $roleId, CF7GSC_Google_Link $postBody, $optParams = array()) {
      $params = array('role' => $role, 'roleId' => $roleId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_Link($data);
      } else {
        return $data;
      }
    }
    ...
    public function listLinks($role, $roleId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_Links($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_PublishersServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @return CF7GSC_Google_Publishers
     */
    public function listPublishers($role, $roleId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_Publishers($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CF7GSC_Google_Publisher
     */
    public function get($role, $roleId, $optParams = array()) {
      $params = array('role' => $role, 'roleId' => $roleId);
      $params = array_merge($params, $optParams);
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_Publisher($data);
      } else {
        return $data;
      }
    }
 ...
 * @author Google, Inc.
 */
class CF7GSC_Google_GanService extends CF7GSC_Google_Service {
  public $advertisers;
  public $ccOffers;
  public $events;
  public $links;
...
class CF7GSC_Google_Advertiser extends CF7GSC_Google_Model {
  ...
  public function setEpcSevenDayAverage(CF7GSC_Google_Money $epcSevenDayAverage) {
  ...
  public function setEpcNinetyDayAverage(CF7GSC_Google_Money $epcNinetyDayAverage) {
  ...
  public function setItem(CF7GSC_Google_Advertiser $item) {
    $this->item = $item;
  }
...
class CF7GSC_Google_Advertisers extends CF7GSC_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CF7GSC_Google_Advertiser';
  ...
  public function setItems(/* array(CF7GSC_Google_Advertiser) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_Advertiser', __METHOD__);
    $this->items = $items;
  }
...
class CF7GSC_Google_CcOffer extends CF7GSC_Google_Model {
  ...
  public $cardBenefits;
  protected $__rewardsType = 'CF7GSC_Google_CcOfferRewards';
  ...
  protected $__defaultFeesType = 'CF7GSC_Google_CcOfferDefaultFees';
  ...
  protected $__bonusRewardsType = 'CF7GSC_Google_CcOfferBonusRewards';
  ...
  public function setRewards(/* array(CF7GSC_Google_CcOfferRewards) */ $rewards) {
    $this->assertIsArray($rewards, 'CF7GSC_Google_CcOfferRewards', __METHOD__);
  ...
  public function setDefaultFees(/* array(CF7GSC_Google_CcOfferDefaultFees) */ $defaultFees) {
    $this->assertIsArray($defaultFees, 'CF7GSC_Google_CcOfferDefaultFees', __METHOD__);
  ...
  public function setBonusRewards(/* array(CF7GSC_Google_CcOfferBonusRewards) */ $bonusRewards) {
    $this->assertIsArray($bonusRewards, 'CF7GSC_Google_CcOfferBonusRewards', __METHOD__);
...
class CF7GSC_Google_CcOfferBonusRewards extends CF7GSC_Google_Model {
  public $amount;
  public $details;
...
class CF7GSC_Google_CcOfferDefaultFees extends CF7GSC_Google_Model {
  public $category;
  public $maxRate;
  public $minRate;
  public $rateType;
...
class CF7GSC_Google_CcOfferRewards extends CF7GSC_Google_Model {
  public $category;
...
class CF7GSC_Google_CcOffers extends CF7GSC_Google_Model {
  protected $__itemsType = 'CF7GSC_Google_CcOffer';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(CF7GSC_Google_CcOffer) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_CcOffer', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CF7GSC_Google_Event extends CF7GSC_Google_Model {
  protected $__networkFeeType = 'CF7GSC_Google_Money';
  ...
  public $status;
  public $chargeId;
  protected $__productsType = 'CF7GSC_Google_EventProducts';
  protected $__productsDataType = 'array';
  public $products;
  protected $__earningsType = 'CF7GSC_Google_Money';
  protected $__earningsDataType = '';
  public $earnings;
  public $chargeType;
  protected $__publisherFeeType = 'CF7GSC_Google_Money';
  protected $__publisherFeeDataType = '';
  public $publisherFee;
  protected $__commissionableSalesType = 'CF7GSC_Google_Money';
  protected $__commissionableSalesDataType = '';
  public $commissionableSales;
  public $publisherId;
  public $eventDate;
  public function setNetworkFee(CF7GSC_Google_Money $networkFee) {
  ...
  public function setProducts(/* array(CF7GSC_Google_EventProducts) */ $products) {
    $this->assertIsArray($products, 'CF7GSC_Google_EventProducts', __METHOD__);
    $this->products = $products;
  }
  public function getProducts() {
    return $this->products;
  }
  public function setEarnings(CF7GSC_Google_Money $earnings) {
  ...
  public function setPublisherFee(CF7GSC_Google_Money $publisherFee) {
    $this->publisherFee = $publisherFee;
  }
  public function getPublisherFee() {
    return $this->publisherFee;
  }
  public function setCommissionableSales(CF7GSC_Google_Money $commissionableSales) {
...
class CF7GSC_Google_EventProducts extends CF7GSC_Google_Model {
  protected $__networkFeeType = 'CF7GSC_Google_Money';
  protected $__networkFeeDataType = '';
  public $networkFee;
  public $sku;
  ...
  protected $__earningsDataType = '';
  public $earnings;
  protected $__unitPriceType = 'CF7GSC_Google_Money';
  ...
  public function setUnitPrice(CF7GSC_Google_Money $unitPrice) {
...
class CF7GSC_Google_Link extends CF7GSC_Google_Model {
  public $isActive;
  public $linkType;
  public $kind;
  public $endDate;
  public $description;
  public $name;
  protected $__specialOffersType = 'CF7GSC_Google_LinkSpecialOffers';
  ...
  public function setSpecialOffers(CF7GSC_Google_LinkSpecialOffers $specialOffers) {
...
class CF7GSC_Google_LinkSpecialOffers extends CF7GSC_Google_Model {
  protected $__priceCutType = 'CF7GSC_Google_Money';
  protected $__priceCutDataType = '';
  public $priceCut;
  protected $__priceCutMinType = 'CF7GSC_Google_Money';
  protected $__priceCutMinDataType = '';
  public $priceCutMin;
  public $freeShipping;
  public $promotionCodes;
  public $percentOff;
  protected $__percentOffMinType = 'CF7GSC_Google_Money';
  protected $__percentOffMinDataType = '';
  public $percentOffMin;
  public $freeGift;
  protected $__freeShippingMinType = 'CF7GSC_Google_Money';
  protected $__freeShippingMinDataType = '';
  public $freeShippingMin;
  public function setPriceCut(CF7GSC_Google_Money $priceCut) {
    $this->priceCut = $priceCut;
  }
  public function getPriceCut() {
    return $this->priceCut;
  }
  public function setPriceCutMin(CF7GSC_Google_Money $priceCutMin) {
  ...
  public function setPercentOffMin(CF7GSC_Google_Money $percentOffMin) {
  ...
  public function setFreeShippingMin(CF7GSC_Google_Money $freeShippingMin) {
...
class CF7GSC_Google_Links extends CF7GSC_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CF7GSC_Google_Link';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setNextPageToken($nextPageToken) {
  ...
  public function setItems(/* array(CF7GSC_Google_Link) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_Link', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CF7GSC_Google_Money extends CF7GSC_Google_Model {
  public $amount;
  public $currencyCode;
  public function setAmount($amount) {
    $this->amount = $amount;
...
class CF7GSC_Google_Publisher extends CF7GSC_Google_Model {
  public $status;
  public $kind;
  public $name;
  ...
  protected $__epcNinetyDayAverageDataType = '';
  public $epcNinetyDayAverage;
  protected $__itemType = 'CF7GSC_Google_Publisher';
  protected $__itemDataType = '';
  public $item;
  public $joinDate;
  public $sites;
  ...
  public function setItem(CF7GSC_Google_Publisher $item) {
    $this->item = $item;
  }
  public function getItem() {
    return $this->item;
...
class CF7GSC_Google_Publishers extends CF7GSC_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CF7GSC_Google_Publisher';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setNextPageToken($nextPageToken) {
  ...
  public function setItems(/* array(CF7GSC_Google_Publisher) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_Publisher', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
