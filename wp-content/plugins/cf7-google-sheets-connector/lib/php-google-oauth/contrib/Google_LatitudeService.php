 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $latitudeService = new CF7GSC_Google_LatitudeService(...);
   *   $currentLocation = $latitudeService->currentLocation;
   *  </code>
   */
  class CF7GSC_Google_CurrentLocationServiceResource extends CF7GSC_Google_ServiceResource {


    /**
     * Updates or creates the user's current location. (currentLocation.insert)
     *
     * @param CF7GSC_Google_Location $postBody
     * @param array $optParams Optional parameters.
     * @return CF7GSC_Google_Location
     */
    public function insert(CF7GSC_Google_Location $postBody, $optParams = array()) {
      $params = array('postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_Location($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_LocationServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @return CF7GSC_Google_LocationFeed
     */
    public function listLocation($optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CF7GSC_Google_LocationFeed($data);
      } else {
        return $data;
      }
    }
 ...
 * @author Google, Inc.
 */
class CF7GSC_Google_LatitudeService extends CF7GSC_Google_Service {
...
class CF7GSC_Google_LocationFeed extends CF7GSC_Google_Model {
  protected $__itemsType = 'CF7GSC_Google_Location';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(CF7GSC_Google_Location) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_Location', __METHOD__);
    $this->items = $items;
  }
