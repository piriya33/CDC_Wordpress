 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $licensingService = new CF7GSC_Google_LicensingService(...);
   *   $licenseAssignments = $licensingService->licenseAssignments;
   *  </code>
   */
  class CF7GSC_Google_LicenseAssignmentsServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @param CF7GSC_Google_LicenseAssignmentInsert $postBody
     * @param array $optParams Optional parameters.
     * @return CF7GSC_Google_LicenseAssignment
     */
    public function insert($productId, $skuId, CF7GSC_Google_LicenseAssignmentInsert $postBody, $optParams = array()) {
      $params = array('productId' => $productId, 'skuId' => $skuId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_LicenseAssignment($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CF7GSC_Google_LicenseAssignmentList
     */
    public function listForProductAndSku($productId, $skuId, $customerId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CF7GSC_Google_LicenseAssignmentList($data);
      } else {
        return $data;
      }
    }
     ...
     * @param string $userId email id or unique Id of the user
     * @param CF7GSC_Google_LicenseAssignment $postBody
     * @param array $optParams Optional parameters.
     * @return CF7GSC_Google_LicenseAssignment
     */
    public function update($productId, $skuId, $userId, CF7GSC_Google_LicenseAssignment $postBody, $optParams = array()) {
     ...
     * @return CF7GSC_Google_LicenseAssignment
     */
    public function patch($productId, $skuId, $userId, CF7GSC_Google_LicenseAssignment $postBody, $optParams = array()) {
      $params = array('productId' => $productId, 'skuId' => $skuId, 'userId' => $userId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
 ...
 * @author Google, Inc.
 */
class CF7GSC_Google_LicensingService extends CF7GSC_Google_Service {
...
class CF7GSC_Google_LicenseAssignmentInsert extends CF7GSC_Google_Model {
  public $userId;
  public function setUserId($userId) {
    $this->userId = $userId;
  }
...
class CF7GSC_Google_LicenseAssignmentList extends CF7GSC_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CF7GSC_Google_LicenseAssignment';
  ...
  public function setItems(/* array(CF7GSC_Google_LicenseAssignment) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_LicenseAssignment', __METHOD__);
    $this->items = $items;
  }
