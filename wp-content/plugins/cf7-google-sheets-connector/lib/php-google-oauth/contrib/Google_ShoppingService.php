 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $shoppingService = new CF7GSC_Google_ShoppingService(...);
   *   $products = $shoppingService->products;
   *  </code>
   */
  class CF7GSC_Google_ProductsServiceResource extends CF7GSC_Google_ServiceResource {
    ...
    public function listProducts($source, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CF7GSC_Google_Products($data);
      } else {
        return $data;
      }
    }
    ...
    public function get($source, $accountId, $productIdType, $productId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CF7GSC_Google_Product($data);
      } else {
        return $data;
      }
    }
 ...
 * @author Google, Inc.
 */
class CF7GSC_Google_ShoppingService extends CF7GSC_Google_Service {
  public $products;
  /**
...
class CF7GSC_Google_Product extends CF7GSC_Google_Model {
  public $selfLink;
  public $kind;
  protected $__productType = 'CF7GSC_Google_ShoppingModelProductJsonV1';
  protected $__productDataType = '';
  public $product;
  public $requestId;
  protected $__recommendationsType = 'CF7GSC_Google_ShoppingModelRecommendationsJsonV1';
  protected $__recommendationsDataType = 'array';
  public $recommendations;
  protected $__debugType = 'CF7GSC_Google_ShoppingModelDebugJsonV1';
  protected $__debugDataType = '';
  public $debug;
  public $id;
  protected $__categoriesType = 'CF7GSC_Google_ShoppingModelCategoryJsonV1';
  ...
  public function setProduct(CF7GSC_Google_ShoppingModelProductJsonV1 $product) {
  ...
  public function setRecommendations(/* array(CF7GSC_Google_ShoppingModelRecommendationsJsonV1) */ $recommendations) {
    $this->assertIsArray($recommendations, 'CF7GSC_Google_ShoppingModelRecommendationsJsonV1', __METHOD__);
    $this->recommendations = $recommendations;
  }
  public function getRecommendations() {
    return $this->recommendations;
  }
  public function setDebug(CF7GSC_Google_ShoppingModelDebugJsonV1 $debug) {
    $this->debug = $debug;
  }
  ...
  public function setCategories(/* array(CF7GSC_Google_ShoppingModelCategoryJsonV1) */ $categories) {
    $this->assertIsArray($categories, 'CF7GSC_Google_ShoppingModelCategoryJsonV1', __METHOD__);
...
class CF7GSC_Google_Products extends CF7GSC_Google_Model {
  protected $__promotionsType = 'CF7GSC_Google_ProductsPromotions';
  protected $__promotionsDataType = 'array';
  public $promotions;
  public $selfLink;
  public $kind;
  protected $__storesType = 'CF7GSC_Google_ProductsStores';
  protected $__storesDataType = 'array';
  public $stores;
  public $currentItemCount;
  protected $__itemsType = 'CF7GSC_Google_Product';
  protected $__itemsDataType = 'array';
  public $items;
  protected $__facetsType = 'CF7GSC_Google_ProductsFacets';
  ...
  public $etag;
  public $requestId;
  protected $__categoryRecommendationsType = 'CF7GSC_Google_ShoppingModelRecommendationsJsonV1';
  protected $__categoryRecommendationsDataType = 'array';
  public $categoryRecommendations;
  protected $__debugType = 'CF7GSC_Google_ShoppingModelDebugJsonV1';
  protected $__debugDataType = '';
  public $debug;
  protected $__spellingType = 'CF7GSC_Google_ProductsSpelling';
  ...
  protected $__categoriesDataType = 'array';
  public $categories;
  public function setPromotions(/* array(CF7GSC_Google_ProductsPromotions) */ $promotions) {
    $this->assertIsArray($promotions, 'CF7GSC_Google_ProductsPromotions', __METHOD__);
  ...
  public function setStores(/* array(CF7GSC_Google_ProductsStores) */ $stores) {
    $this->assertIsArray($stores, 'CF7GSC_Google_ProductsStores', __METHOD__);
    $this->stores = $stores;
  }
  ...
  public function setItems(/* array(CF7GSC_Google_Product) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_Product', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
  }
  public function setFacets(/* array(CF7GSC_Google_ProductsFacets) */ $facets) {
    $this->assertIsArray($facets, 'CF7GSC_Google_ProductsFacets', __METHOD__);
    $this->facets = $facets;
  }
  ...
  public function setCategoryRecommendations(/* array(CF7GSC_Google_ShoppingModelRecommendationsJsonV1) */ $categoryRecommendations) {
    $this->assertIsArray($categoryRecommendations, 'CF7GSC_Google_ShoppingModelRecommendationsJsonV1', __METHOD__);
  ...
  public function setSpelling(CF7GSC_Google_ProductsSpelling $spelling) {
...
class CF7GSC_Google_ProductsFacets extends CF7GSC_Google_Model {
  public $count;
  public $displayName;
  public $name;
  protected $__bucketsType = 'CF7GSC_Google_ProductsFacetsBuckets';
  ...
  public function setBuckets(/* array(CF7GSC_Google_ProductsFacetsBuckets) */ $buckets) {
    $this->assertIsArray($buckets, 'CF7GSC_Google_ProductsFacetsBuckets', __METHOD__);
...
class CF7GSC_Google_ProductsFacetsBuckets extends CF7GSC_Google_Model {
  public $count;
  public $minExclusive;
  public $min;
  public $max;
...
class CF7GSC_Google_ProductsPromotions extends CF7GSC_Google_Model {
  protected $__productType = 'CF7GSC_Google_ShoppingModelProductJsonV1';
  protected $__productDataType = '';
  public $product;
  public $description;
  ...
  public $destLink;
  public $customHtml;
  protected $__customFieldsType = 'CF7GSC_Google_ProductsPromotionsCustomFields';
  ...
  public function setCustomFields(/* array(CF7GSC_Google_ProductsPromotionsCustomFields) */ $customFields) {
    $this->assertIsArray($customFields, 'CF7GSC_Google_ProductsPromotionsCustomFields', __METHOD__);
...
class CF7GSC_Google_ProductsPromotionsCustomFields extends CF7GSC_Google_Model {
  public $name;
  public $value;
  public function setName($name) {
    $this->name = $name;
...
class CF7GSC_Google_ProductsSpelling extends CF7GSC_Google_Model {
  public $suggestion;
...
class CF7GSC_Google_ProductsStores extends CF7GSC_Google_Model {
  public $storeCode;
  public $name;
  public $storeName;
  public $storeId;
...
class CF7GSC_Google_ShoppingModelCategoryJsonV1 extends CF7GSC_Google_Model {
  public $url;
  public $shortName;
  public $parents;
  public $id;
...
class CF7GSC_Google_ShoppingModelDebugJsonV1 extends CF7GSC_Google_Model {
  ...
  protected $__backendTimesType = 'CF7GSC_Google_ShoppingModelDebugJsonV1BackendTimes';
  ...
  public function setBackendTimes(/* array(CF7GSC_Google_ShoppingModelDebugJsonV1BackendTimes) */ $backendTimes) {
    $this->assertIsArray($backendTimes, 'CF7GSC_Google_ShoppingModelDebugJsonV1BackendTimes', __METHOD__);
...
class CF7GSC_Google_ShoppingModelDebugJsonV1BackendTimes extends CF7GSC_Google_Model {
  public $serverMillis;
  public $hostName;
  public $name;
  public $elapsedMillis;
...
class CF7GSC_Google_ShoppingModelProductJsonV1 extends CF7GSC_Google_Model {
  public $queryMatched;
  public $gtin;
  protected $__imagesType = 'CF7GSC_Google_ShoppingModelProductJsonV1Images';
  protected $__imagesDataType = 'array';
  public $images;
  protected $__inventoriesType = 'CF7GSC_Google_ShoppingModelProductJsonV1Inventories';
  protected $__inventoriesDataType = 'array';
  public $inventories;
  protected $__authorType = 'CF7GSC_Google_ShoppingModelProductJsonV1Author';
  ...
  public $brand;
  public $internal3;
  protected $__internal4Type = 'CF7GSC_Google_ShoppingModelProductJsonV1Internal4';
  ...
  public $link;
  public $mpns;
  protected $__attributesType = 'CF7GSC_Google_ShoppingModelProductJsonV1Attributes';
  protected $__attributesDataType = 'array';
  public $attributes;
  public $totalMatchingVariants;
  protected $__variantsType = 'CF7GSC_Google_ShoppingModelProductJsonV1Variants';
  ...
  public function setImages(/* array(CF7GSC_Google_ShoppingModelProductJsonV1Images) */ $images) {
    $this->assertIsArray($images, 'CF7GSC_Google_ShoppingModelProductJsonV1Images', __METHOD__);
    $this->images = $images;
  }
  public function getImages() {
    return $this->images;
  }
  public function setInventories(/* array(CF7GSC_Google_ShoppingModelProductJsonV1Inventories) */ $inventories) {
    $this->assertIsArray($inventories, 'CF7GSC_Google_ShoppingModelProductJsonV1Inventories', __METHOD__);
    $this->inventories = $inventories;
  }
  public function getInventories() {
    return $this->inventories;
  }
  public function setAuthor(CF7GSC_Google_ShoppingModelProductJsonV1Author $author) {
    $this->author = $author;
  }
  ...
  public function setInternal4(/* array(CF7GSC_Google_ShoppingModelProductJsonV1Internal4) */ $internal4) {
    $this->assertIsArray($internal4, 'CF7GSC_Google_ShoppingModelProductJsonV1Internal4', __METHOD__);
  ...
  public function setAttributes(/* array(CF7GSC_Google_ShoppingModelProductJsonV1Attributes) */ $attributes) {
    $this->assertIsArray($attributes, 'CF7GSC_Google_ShoppingModelProductJsonV1Attributes', __METHOD__);
  ...
  public function setVariants(/* array(CF7GSC_Google_ShoppingModelProductJsonV1Variants) */ $variants) {
    $this->assertIsArray($variants, 'CF7GSC_Google_ShoppingModelProductJsonV1Variants', __METHOD__);
...
class CF7GSC_Google_ShoppingModelProductJsonV1Attributes extends CF7GSC_Google_Model {
  public $type;
  public $value;
  public $displayName;
  public $name;
...
class CF7GSC_Google_ShoppingModelProductJsonV1Author extends CF7GSC_Google_Model {
  public $name;
  public $accountId;
  public function setName($name) {
    $this->name = $name;
...
class CF7GSC_Google_ShoppingModelProductJsonV1Images extends CF7GSC_Google_Model {
  public $status;
  public $link;
  protected $__thumbnailsType = 'CF7GSC_Google_ShoppingModelProductJsonV1ImagesThumbnails';
  ...
  public function setThumbnails(/* array(CF7GSC_Google_ShoppingModelProductJsonV1ImagesThumbnails) */ $thumbnails) {
    $this->assertIsArray($thumbnails, 'CF7GSC_Google_ShoppingModelProductJsonV1ImagesThumbnails', __METHOD__);
...
class CF7GSC_Google_ShoppingModelProductJsonV1ImagesThumbnails extends CF7GSC_Google_Model {
  public $content;
  public $width;
  public $link;
  public $height;
...
class CF7GSC_Google_ShoppingModelProductJsonV1Internal4 extends CF7GSC_Google_Model {
  public $node;
  public $confidence;
...
class CF7GSC_Google_ShoppingModelProductJsonV1Inventories extends CF7GSC_Google_Model {
...
class CF7GSC_Google_ShoppingModelProductJsonV1Variants extends CF7GSC_Google_Model {
  protected $__variantType = 'CF7GSC_Google_ShoppingModelProductJsonV1';
  protected $__variantDataType = '';
  public $variant;
  public function setVariant(CF7GSC_Google_ShoppingModelProductJsonV1 $variant) {
...
class CF7GSC_Google_ShoppingModelRecommendationsJsonV1 extends CF7GSC_Google_Model {
  protected $__recommendationListType = 'CF7GSC_Google_ShoppingModelRecommendationsJsonV1RecommendationList';
  protected $__recommendationListDataType = 'array';
  public $recommendationList;
  public $type;
  public function setRecommendationList(/* array(CF7GSC_Google_ShoppingModelRecommendationsJsonV1RecommendationList) */ $recommendationList) {
    $this->assertIsArray($recommendationList, 'CF7GSC_Google_ShoppingModelRecommendationsJsonV1RecommendationList', __METHOD__);
...
class CF7GSC_Google_ShoppingModelRecommendationsJsonV1RecommendationList extends CF7GSC_Google_Model {
  protected $__productType = 'CF7GSC_Google_ShoppingModelProductJsonV1';
  protected $__productDataType = '';
  public $product;
  public function setProduct(CF7GSC_Google_ShoppingModelProductJsonV1 $product) {
