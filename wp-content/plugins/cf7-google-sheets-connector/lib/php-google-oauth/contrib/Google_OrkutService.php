 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $orkutService = new CF7GSC_Google_OrkutService(...);
   *   $communityMembers = $orkutService->communityMembers;
   *  </code>
   */
  class CF7GSC_Google_CommunityMembersServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @return CF7GSC_Google_CommunityMembers
     */
    public function insert($communityId, $userId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CF7GSC_Google_CommunityMembers($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
     * @return CF7GSC_Google_CommunityMembersList
     */
    public function listCommunityMembers($communityId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CF7GSC_Google_CommunityMembersList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_ActivitiesServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
     * @return CF7GSC_Google_ActivityList
     */
    public function listActivities($userId, $collection, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_ActivityList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_CommunityPollCommentsServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @param CF7GSC_Google_CommunityPollComment $postBody
     * @param array $optParams Optional parameters.
     * @return CF7GSC_Google_CommunityPollComment
     */
    public function insert($communityId, $pollId, CF7GSC_Google_CommunityPollComment $postBody, $optParams = array()) {
      $params = array('communityId' => $communityId, 'pollId' => $pollId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_CommunityPollComment($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
     * @return CF7GSC_Google_CommunityPollCommentList
     */
    public function listCommunityPollComments($communityId, $pollId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_CommunityPollCommentList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_CommunityPollsServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
     * @return CF7GSC_Google_CommunityPollList
     */
    public function listCommunityPolls($communityId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_CommunityPollList($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
     * @return CF7GSC_Google_CommunityPoll
     */
    public function get($communityId, $pollId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_CommunityPoll($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_CommunityMessagesServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @param CF7GSC_Google_CommunityMessage $postBody
     * @param array $optParams Optional parameters.
     * @return CF7GSC_Google_CommunityMessage
     */
    public function insert($communityId, $topicId, CF7GSC_Google_CommunityMessage $postBody, $optParams = array()) {
      $params = array('communityId' => $communityId, 'topicId' => $topicId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_CommunityMessage($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
     * @return CF7GSC_Google_CommunityMessageList
     */
    public function listCommunityMessages($communityId, $topicId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_CommunityMessageList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_CommunityTopicsServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @param CF7GSC_Google_CommunityTopic $postBody
     * @param array $optParams Optional parameters.
     *
     * @opt_param bool isShout Whether this topic is a shout.
     * @return CF7GSC_Google_CommunityTopic
     */
    public function insert($communityId, CF7GSC_Google_CommunityTopic $postBody, $optParams = array()) {
      $params = array('communityId' => $communityId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_CommunityTopic($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
     * @return CF7GSC_Google_CommunityTopicList
     */
    public function listCommunityTopics($communityId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_CommunityTopicList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_CommentsServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @param CF7GSC_Google_Comment $postBody
     * @param array $optParams Optional parameters.
     * @return CF7GSC_Google_Comment
     */
    public function insert($activityId, CF7GSC_Google_Comment $postBody, $optParams = array()) {
      $params = array('activityId' => $activityId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_Comment($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string maxResults The maximum number of activities to include in the response.
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
     * @return CF7GSC_Google_CommentList
     */
    public function listComments($activityId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_CommentList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_CommunityRelatedServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     *
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
     * @return CF7GSC_Google_CommunityList
     */
    public function listCommunityRelated($communityId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_CommunityList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_ScrapsServiceResource extends CF7GSC_Google_ServiceResource {


    /**
     * Creates a new scrap. (scraps.insert)
     *
     * @param CF7GSC_Google_Activity $postBody
     * @param array $optParams Optional parameters.
     * @return CF7GSC_Google_Activity
     */
    public function insert(CF7GSC_Google_Activity $postBody, $optParams = array()) {
      $params = array('postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_Activity($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_CommunityPollVotesServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @param CF7GSC_Google_CommunityPollVote $postBody
     * @param array $optParams Optional parameters.
     * @return CF7GSC_Google_CommunityPollVote
     */
    public function insert($communityId, $pollId, CF7GSC_Google_CommunityPollVote $postBody, $optParams = array()) {
      $params = array('communityId' => $communityId, 'pollId' => $pollId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_CommunityPollVote($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_CommunitiesServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     *
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
     * @return CF7GSC_Google_Community
     */
    public function get($communityId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_Community($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_CommunityFollowServiceResource extends CF7GSC_Google_ServiceResource {
   ...
   *  </code>
   */
  class CF7GSC_Google_ActivityVisibilityServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     *
     * @param string $activityId ID of the activity.
     * @param CF7GSC_Google_Visibility $postBody
     * @param array $optParams Optional parameters.
     * @return CF7GSC_Google_Visibility
     */
    public function patch($activityId, CF7GSC_Google_Visibility $postBody, $optParams = array()) {
      $params = array('activityId' => $activityId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_Visibility($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CF7GSC_Google_Visibility
     */
    public function update($activityId, CF7GSC_Google_Visibility $postBody, $optParams = array()) {
      $params = array('activityId' => $activityId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class CF7GSC_Google_BadgesServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @param array $optParams Optional parameters.
     * @return CF7GSC_Google_BadgeList
     */
    public function listBadges($userId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_BadgeList($data);
      } else {
        return $data;
      }
    }
    ...
    public function get($userId, $badgeId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_Badge($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class CF7GSC_Google_CountersServiceResource extends CF7GSC_Google_ServiceResource {
    ...
    public function listCounters($userId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_Counters($data);
      } else {
        return $data;
      }
    }
 ...
 * @author Google, Inc.
 */
class CF7GSC_Google_OrkutService extends CF7GSC_Google_Service {
...
class CF7GSC_Google_AclItems extends CF7GSC_Google_Model {
  public $type;
  public $id;
...
class CF7GSC_Google_Activity extends CF7GSC_Google_Model {
  public $kind;
  protected $__linksType = 'CF7GSC_Google_OrkutLinkResource';
  protected $__linksDataType = 'array';
  public $links;
  public $title;
  protected $__objectType = 'CF7GSC_Google_ActivityObject';
  protected $__objectDataType = '';
  public $object;
  public $updated;
  protected $__actorType = 'CF7GSC_Google_OrkutAuthorResource';
  protected $__actorDataType = '';
  public $actor;
  protected $__accessType = 'CF7GSC_Google_Acl';
  ...
  public function setLinks(/* array(CF7GSC_Google_OrkutLinkResource) */ $links) {
    $this->assertIsArray($links, 'CF7GSC_Google_OrkutLinkResource', __METHOD__);
    $this->links = $links;
  }
  ...
  public function setObject(CF7GSC_Google_ActivityObject $object) {
    $this->object = $object;
  }
  ...
  public function setActor(CF7GSC_Google_OrkutAuthorResource $actor) {
    $this->actor = $actor;
  }
  public function getActor() {
    return $this->actor;
  }
  public function setAccess(CF7GSC_Google_Acl $access) {
    $this->access = $access;
  }
...
class CF7GSC_Google_ActivityList extends CF7GSC_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CF7GSC_Google_Activity';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  ...
  public function setItems(/* array(CF7GSC_Google_Activity) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_Activity', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CF7GSC_Google_ActivityObject extends CF7GSC_Google_Model {
  public $content;
  protected $__itemsType = 'CF7GSC_Google_OrkutActivityobjectsResource';
  protected $__itemsDataType = 'array';
  public $items;
  protected $__repliesType = 'CF7GSC_Google_ActivityObjectReplies';
  ...
  public function setItems(/* array(CF7GSC_Google_OrkutActivityobjectsResource) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_OrkutActivityobjectsResource', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
  }
  public function setReplies(CF7GSC_Google_ActivityObjectReplies $replies) {
...
class CF7GSC_Google_ActivityObjectReplies extends CF7GSC_Google_Model {
  public $totalItems;
  protected $__itemsType = 'CF7GSC_Google_Comment';
  protected $__itemsDataType = 'array';
  public $items;
  public $url;
  ...
  public function setItems(/* array(CF7GSC_Google_Comment) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_Comment', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CF7GSC_Google_Badge extends CF7GSC_Google_Model {
...
class CF7GSC_Google_BadgeList extends CF7GSC_Google_Model {
  protected $__itemsType = 'CF7GSC_Google_Badge';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(CF7GSC_Google_Badge) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_Badge', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CF7GSC_Google_Comment extends CF7GSC_Google_Model {
  protected $__inReplyToType = 'CF7GSC_Google_CommentInReplyTo';
  ...
  public $published;
  public $id;
  public function setInReplyTo(CF7GSC_Google_CommentInReplyTo $inReplyTo) {
...
class CF7GSC_Google_CommentInReplyTo extends CF7GSC_Google_Model {
  public $type;
  public $href;
  public $ref;
  public $rel;
...
class CF7GSC_Google_CommentList extends CF7GSC_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CF7GSC_Google_Comment';
  protected $__itemsDataType = 'array';
  public $items;
...
class CF7GSC_Google_Community extends CF7GSC_Google_Model {
  public $category;
  public $kind;
  public $member_count;
  public $description;
  ...
  protected $__ownerType = 'CF7GSC_Google_OrkutAuthorResource';
  protected $__ownerDataType = '';
  public $owner;
  protected $__moderatorsType = 'CF7GSC_Google_OrkutAuthorResource';
  protected $__moderatorsDataType = 'array';
  public $moderators;
  public $location;
  protected $__co_ownersType = 'CF7GSC_Google_OrkutAuthorResource';
  ...
  public function setOwner(CF7GSC_Google_OrkutAuthorResource $owner) {
    $this->owner = $owner;
  }
  public function getOwner() {
    return $this->owner;
  }
  public function setModerators(/* array(CF7GSC_Google_OrkutAuthorResource) */ $moderators) {
    $this->assertIsArray($moderators, 'CF7GSC_Google_OrkutAuthorResource', __METHOD__);
  ...
  public function setCo_owners(/* array(CF7GSC_Google_OrkutAuthorResource) */ $co_owners) {
    $this->assertIsArray($co_owners, 'CF7GSC_Google_OrkutAuthorResource', __METHOD__);
...
class CF7GSC_Google_CommunityList extends CF7GSC_Google_Model {
  protected $__itemsType = 'CF7GSC_Google_Community';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(CF7GSC_Google_Community) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_Community', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CF7GSC_Google_CommunityMembers extends CF7GSC_Google_Model {
  protected $__communityMembershipStatusType = 'CF7GSC_Google_CommunityMembershipStatus';
  protected $__communityMembershipStatusDataType = '';
  public $communityMembershipStatus;
  protected $__personType = 'CF7GSC_Google_OrkutActivitypersonResource';
  protected $__personDataType = '';
  public $person;
  public $kind;
  public function setCommunityMembershipStatus(CF7GSC_Google_CommunityMembershipStatus $communityMembershipStatus) {
  ...
  public function setPerson(CF7GSC_Google_OrkutActivitypersonResource $person) {
    $this->person = $person;
  }
...
class CF7GSC_Google_CommunityMembersList extends CF7GSC_Google_Model {
  public $nextPageToken;
  public $kind;
  protected $__itemsType = 'CF7GSC_Google_CommunityMembers';
  protected $__itemsDataType = 'array';
  public $items;
  ...
  public function setItems(/* array(CF7GSC_Google_CommunityMembers) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_CommunityMembers', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CF7GSC_Google_CommunityMembershipStatus extends CF7GSC_Google_Model {
  public $status;
  public $isFollowing;
...
class CF7GSC_Google_CommunityMessage extends CF7GSC_Google_Model {
  public $body;
  public $kind;
  protected $__linksType = 'CF7GSC_Google_OrkutLinkResource';
  protected $__linksDataType = 'array';
  public $links;
  protected $__authorType = 'CF7GSC_Google_OrkutAuthorResource';
  ...
  public function setAuthor(CF7GSC_Google_OrkutAuthorResource $author) {
    $this->author = $author;
  }
...
class CF7GSC_Google_CommunityMessageList extends CF7GSC_Google_Model {
  public $nextPageToken;
  public $kind;
  protected $__itemsType = 'CF7GSC_Google_CommunityMessage';
  protected $__itemsDataType = 'array';
  public $items;
  public $prevPageToken;
  public $lastPageToken;
  ...
  public function setItems(/* array(CF7GSC_Google_CommunityMessage) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_CommunityMessage', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CF7GSC_Google_CommunityPoll extends CF7GSC_Google_Model {
  protected $__linksType = 'CF7GSC_Google_OrkutLinkResource';
  protected $__linksDataType = 'array';
  public $links;
  public $isMultipleAnswers;
  protected $__imageType = 'CF7GSC_Google_CommunityPollImage';
  ...
  public $kind;
  public $creationTime;
  protected $__optionsType = 'CF7GSC_Google_OrkutCommunitypolloptionResource';
  ...
  public function setImage(CF7GSC_Google_CommunityPollImage $image) {
    $this->image = $image;
  }
  ...
  public function setOptions(/* array(CF7GSC_Google_OrkutCommunitypolloptionResource) */ $options) {
    $this->assertIsArray($options, 'CF7GSC_Google_OrkutCommunitypolloptionResource', __METHOD__);
...
class CF7GSC_Google_CommunityPollComment extends CF7GSC_Google_Model {
  public $body;
  public $kind;
  public $addedDate;
  public $id;
...
class CF7GSC_Google_CommunityPollCommentList extends CF7GSC_Google_Model {
  public $nextPageToken;
  public $kind;
  protected $__itemsType = 'CF7GSC_Google_CommunityPollComment';
  protected $__itemsDataType = 'array';
  public $items;
  public $prevPageToken;
  public $lastPageToken;
  ...
  public function setItems(/* array(CF7GSC_Google_CommunityPollComment) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_CommunityPollComment', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CF7GSC_Google_CommunityPollImage extends CF7GSC_Google_Model {
  public $url;
  public function setUrl($url) {
    $this->url = $url;
  }
...
class CF7GSC_Google_CommunityPollList extends CF7GSC_Google_Model {
  public $nextPageToken;
  public $kind;
  protected $__itemsType = 'CF7GSC_Google_CommunityPoll';
  protected $__itemsDataType = 'array';
  public $items;
  public $prevPageToken;
  public $lastPageToken;
  ...
  public function setItems(/* array(CF7GSC_Google_CommunityPoll) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_CommunityPoll', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CF7GSC_Google_CommunityPollVote extends CF7GSC_Google_Model {
  public $kind;
  public $optionIds;
...
class CF7GSC_Google_CommunityTopic extends CF7GSC_Google_Model {
  public $body;
  public $lastUpdate;
  public $kind;
  protected $__linksType = 'CF7GSC_Google_OrkutLinkResource';
  ...
  public $author;
  public $title;
  protected $__messagesType = 'CF7GSC_Google_CommunityMessage';
  ...
  public function setMessages(/* array(CF7GSC_Google_CommunityMessage) */ $messages) {
    $this->assertIsArray($messages, 'CF7GSC_Google_CommunityMessage', __METHOD__);
...
class CF7GSC_Google_CommunityTopicList extends CF7GSC_Google_Model {
  public $nextPageToken;
  public $kind;
  protected $__itemsType = 'CF7GSC_Google_CommunityTopic';
  protected $__itemsDataType = 'array';
  public $items;
  public $prevPageToken;
  public $lastPageToken;
  ...
  public function setItems(/* array(CF7GSC_Google_CommunityTopic) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_CommunityTopic', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CF7GSC_Google_Counters extends CF7GSC_Google_Model {
  protected $__itemsType = 'CF7GSC_Google_OrkutCounterResource';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(CF7GSC_Google_OrkutCounterResource) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_OrkutCounterResource', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CF7GSC_Google_OrkutActivityobjectsResource extends CF7GSC_Google_Model {
  public $displayName;
  protected $__linksType = 'CF7GSC_Google_OrkutLinkResource';
  protected $__linksDataType = 'array';
  public $links;
  protected $__communityType = 'CF7GSC_Google_Community';
  ...
  public function setCommunity(CF7GSC_Google_Community $community) {
...
class CF7GSC_Google_OrkutActivitypersonResource extends CF7GSC_Google_Model {
  protected $__nameType = 'CF7GSC_Google_OrkutActivitypersonResourceName';
  protected $__nameDataType = '';
  public $name;
  public $url;
  public $gender;
  protected $__imageType = 'CF7GSC_Google_OrkutActivitypersonResourceImage';
  protected $__imageDataType = '';
  public $image;
  public $birthday;
  public $id;
  public function setName(CF7GSC_Google_OrkutActivitypersonResourceName $name) {
    $this->name = $name;
  }
  public function getName() {
    return $this->name;
  ...
  public function setImage(CF7GSC_Google_OrkutActivitypersonResourceImage $image) {
    $this->image = $image;
  }
  public function getImage() {
    return $this->image;
...
class CF7GSC_Google_OrkutActivitypersonResourceImage extends CF7GSC_Google_Model {
  public $url;
  public function setUrl($url) {
    $this->url = $url;
  }
...
class CF7GSC_Google_OrkutActivitypersonResourceName extends CF7GSC_Google_Model {
  public $givenName;
  public $familyName;
...
class CF7GSC_Google_OrkutAuthorResource extends CF7GSC_Google_Model {
  public $url;
  protected $__imageType = 'CF7GSC_Google_OrkutAuthorResourceImage';
  protected $__imageDataType = '';
  public $image;
  public $displayName;
  public $id;
  ...
  public function setImage(CF7GSC_Google_OrkutAuthorResourceImage $image) {
    $this->image = $image;
  }
  public function getImage() {
    return $this->image;
...
class CF7GSC_Google_OrkutAuthorResourceImage extends CF7GSC_Google_Model {
  public $url;
  public function setUrl($url) {
    $this->url = $url;
  }
...
class CF7GSC_Google_OrkutCommunitypolloptionResource extends CF7GSC_Google_Model {
  protected $__imageType = 'CF7GSC_Google_OrkutCommunitypolloptionResourceImage';
  protected $__imageDataType = '';
  public $image;
  public $optionId;
  public $description;
  public $numberOfVotes;
  public function setImage(CF7GSC_Google_OrkutCommunitypolloptionResourceImage $image) {
    $this->image = $image;
  }
  public function getImage() {
    return $this->image;
...
class CF7GSC_Google_OrkutCommunitypolloptionResourceImage extends CF7GSC_Google_Model {
  public $url;
  public function setUrl($url) {
    $this->url = $url;
  }
...
class CF7GSC_Google_OrkutCounterResource extends CF7GSC_Google_Model {
  public $total;
  protected $__linkType = 'CF7GSC_Google_OrkutLinkResource';
  ...
  public function setLink(CF7GSC_Google_OrkutLinkResource $link) {
    $this->link = $link;
  }
...
class CF7GSC_Google_OrkutLinkResource extends CF7GSC_Google_Model {
  public $href;
  public $type;
  public $rel;
  public $title;
...
class CF7GSC_Google_Visibility extends CF7GSC_Google_Model {
  public $kind;
  public $visibility;
  protected $__linksType = 'CF7GSC_Google_OrkutLinkResource';
  protected $__linksDataType = 'array';
