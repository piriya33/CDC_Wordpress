 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $dfareportingService = new CF7GSC_Google_DfareportingService(...);
   *   $dimensionValues = $dfareportingService->dimensionValues;
   *  </code>
   */
  class CF7GSC_Google_DimensionValuesServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @param CF7GSC_Google_DimensionValueRequest $postBody
     * @param array $optParams Optional parameters.
     *
     * @opt_param int maxResults Maximum number of results to return.
     * @opt_param string pageToken The value of the nextToken from the previous result page.
     * @return CF7GSC_Google_DimensionValueList
     */
    public function query($profileId, CF7GSC_Google_DimensionValueRequest $postBody, $optParams = array()) {
      $params = array('profileId' => $profileId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('query', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_DimensionValueList($data);
      } else {
        return $data;
      }
    }
  ...
  class CF7GSC_Google_ReportsServiceResource extends CF7GSC_Google_ServiceResource {
    ...
    public function get($profileId, $reportId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CF7GSC_Google_Report($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param string $profileId The DFA user profile ID.
     * @param CF7GSC_Google_Report $postBody
     * @param array $optParams Optional parameters.
     * @return CF7GSC_Google_Report
     */
    public function insert($profileId, CF7GSC_Google_Report $postBody, $optParams = array()) {
      $params = array('profileId' => $profileId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
     ...
     * @opt_param string sortField The field by which to sort the list.
     * @opt_param string sortOrder Order of sorted results, default is 'DESCENDING'.
     * @return CF7GSC_Google_ReportList
     */
    public function listReports($profileId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_ReportList($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CF7GSC_Google_Report
     */
    public function patch($profileId, $reportId, CF7GSC_Google_Report $postBody, $optParams = array()) {
     ...
     * @return CF7GSC_Google_DfareportingFile
     */
    public function run($profileId, $reportId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CF7GSC_Google_DfareportingFile($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CF7GSC_Google_Report
     */
    public function update($profileId, $reportId, CF7GSC_Google_Report $postBody, $optParams = array()) {
      $params = array('profileId' => $profileId, 'reportId' => $reportId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class CF7GSC_Google_ReportsFilesServiceResource extends CF7GSC_Google_ServiceResource {
   ...
   *  </code>
   */
  class CF7GSC_Google_UserProfilesServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @param array $optParams Optional parameters.
     * @return CF7GSC_Google_UserProfile
     */
    public function get($profileId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_UserProfile($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param array $optParams Optional parameters.
     * @return CF7GSC_Google_UserProfileList
     */
    public function listUserProfiles($optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_UserProfileList($data);
      } else {
        return $data;
      }
    }
 ...
 * @author Google, Inc.
 */
class CF7GSC_Google_DfareportingService extends CF7GSC_Google_Service {
...
class CF7GSC_Google_CustomRichMediaEvents extends CF7GSC_Google_Model {
  protected $__filteredEventIdsType = 'CF7GSC_Google_DimensionValue';
  protected $__filteredEventIdsDataType = 'array';
  public $filteredEventIds;
  public $kind;
  public function setFilteredEventIds(/* array(CF7GSC_Google_DimensionValue) */ $filteredEventIds) {
    $this->assertIsArray($filteredEventIds, 'CF7GSC_Google_DimensionValue', __METHOD__);
...
class CF7GSC_Google_DateRange extends CF7GSC_Google_Model {
  public $endDate;
  public $kind;
...
class CF7GSC_Google_DfareportingFile extends CF7GSC_Google_Model {
  protected $__dateRangeType = 'CF7GSC_Google_DateRange';
  ...
  public $reportId;
  public $status;
  protected $__urlsType = 'CF7GSC_Google_DfareportingFileUrls';
  protected $__urlsDataType = '';
  public $urls;
  public function setDateRange(CF7GSC_Google_DateRange $dateRange) {
  ...
  public function setUrls(CF7GSC_Google_DfareportingFileUrls $urls) {
    $this->urls = $urls;
  }
...
class CF7GSC_Google_DfareportingFileUrls extends CF7GSC_Google_Model {
  public $apiUrl;
  public $browserUrl;
...
class CF7GSC_Google_DimensionFilter extends CF7GSC_Google_Model {
...
class CF7GSC_Google_DimensionValue extends CF7GSC_Google_Model {
  public $dimensionName;
  public $etag;
  public $id;
  public $kind;
...
class CF7GSC_Google_DimensionValueList extends CF7GSC_Google_Model {
  public $etag;
  protected $__itemsType = 'CF7GSC_Google_DimensionValue';
  ...
  public function setItems(/* array(CF7GSC_Google_DimensionValue) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_DimensionValue', __METHOD__);
    $this->items = $items;
  }
...
class CF7GSC_Google_DimensionValueRequest extends CF7GSC_Google_Model {
  public $dimensionName;
  public $endDate;
  protected $__filtersType = 'CF7GSC_Google_DimensionFilter';
  protected $__filtersDataType = 'array';
  public $filters;
  public $kind;
  public $startDate;
  ...
  public function setFilters(/* array(CF7GSC_Google_DimensionFilter) */ $filters) {
    $this->assertIsArray($filters, 'CF7GSC_Google_DimensionFilter', __METHOD__);
    $this->filters = $filters;
  }
  public function getFilters() {
    return $this->filters;
...
class CF7GSC_Google_FileList extends CF7GSC_Google_Model {
  public $etag;
  protected $__itemsType = 'CF7GSC_Google_DfareportingFile';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $nextPageToken;
  ...
  public function setItems(/* array(CF7GSC_Google_DfareportingFile) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_DfareportingFile', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CF7GSC_Google_Recipient extends CF7GSC_Google_Model {
  public $deliveryType;
  public $email;
  public $kind;
...
class CF7GSC_Google_Report extends CF7GSC_Google_Model {
  public $accountId;
  protected $__activeGrpCriteriaType = 'CF7GSC_Google_ReportActiveGrpCriteria';
  protected $__activeGrpCriteriaDataType = '';
  public $activeGrpCriteria;
  protected $__criteriaType = 'CF7GSC_Google_ReportCriteria';
  protected $__criteriaDataType = '';
  public $criteria;
  protected $__crossDimensionReachCriteriaType = 'CF7GSC_Google_ReportCrossDimensionReachCriteria';
  protected $__crossDimensionReachCriteriaDataType = '';
  public $crossDimensionReachCriteria;
  protected $__deliveryType = 'CF7GSC_Google_ReportDelivery';
  protected $__deliveryDataType = '';
  public $delivery;
  public $etag;
  public $fileName;
  protected $__floodlightCriteriaType = 'CF7GSC_Google_ReportFloodlightCriteria';
  ...
  protected $__pathToConversionCriteriaType = 'CF7GSC_Google_ReportPathToConversionCriteria';
  protected $__pathToConversionCriteriaDataType = '';
  public $pathToConversionCriteria;
  protected $__reachCriteriaType = 'CF7GSC_Google_ReportReachCriteria';
  protected $__reachCriteriaDataType = '';
  public $reachCriteria;
  protected $__scheduleType = 'CF7GSC_Google_ReportSchedule';
  ...
  public function setActiveGrpCriteria(CF7GSC_Google_ReportActiveGrpCriteria $activeGrpCriteria) {
    $this->activeGrpCriteria = $activeGrpCriteria;
  }
  public function getActiveGrpCriteria() {
    return $this->activeGrpCriteria;
  }
  public function setCriteria(CF7GSC_Google_ReportCriteria $criteria) {
    $this->criteria = $criteria;
  }
  public function getCriteria() {
    return $this->criteria;
  }
  public function setCrossDimensionReachCriteria(CF7GSC_Google_ReportCrossDimensionReachCriteria $crossDimensionReachCriteria) {
  ...
  public function setDelivery(CF7GSC_Google_ReportDelivery $delivery) {
  ...
  public function setFloodlightCriteria(CF7GSC_Google_ReportFloodlightCriteria $floodlightCriteria) {
  ...
  public function setPathToConversionCriteria(CF7GSC_Google_ReportPathToConversionCriteria $pathToConversionCriteria) {
  ...
  public function setReachCriteria(CF7GSC_Google_ReportReachCriteria $reachCriteria) {
    $this->reachCriteria = $reachCriteria;
  }
  public function getReachCriteria() {
    return $this->reachCriteria;
  }
  public function setSchedule(CF7GSC_Google_ReportSchedule $schedule) {
...
class CF7GSC_Google_ReportActiveGrpCriteria extends CF7GSC_Google_Model {
  protected $__dateRangeType = 'CF7GSC_Google_DateRange';
  protected $__dateRangeDataType = '';
  public $dateRange;
  protected $__dimensionFiltersType = 'CF7GSC_Google_DimensionValue';
  protected $__dimensionFiltersDataType = 'array';
  public $dimensionFilters;
  protected $__dimensionsType = 'CF7GSC_Google_SortedDimension';
  ...
  public function setDimensionFilters(/* array(CF7GSC_Google_DimensionValue) */ $dimensionFilters) {
    $this->assertIsArray($dimensionFilters, 'CF7GSC_Google_DimensionValue', __METHOD__);
    $this->dimensionFilters = $dimensionFilters;
  }
  public function getDimensionFilters() {
    return $this->dimensionFilters;
  }
  public function setDimensions(/* array(CF7GSC_Google_SortedDimension) */ $dimensions) {
    $this->assertIsArray($dimensions, 'CF7GSC_Google_SortedDimension', __METHOD__);
...
class CF7GSC_Google_ReportCriteria extends CF7GSC_Google_Model {
  protected $__activitiesType = 'CF7GSC_Google_Activities';
  protected $__activitiesDataType = '';
  public $activities;
  protected $__customRichMediaEventsType = 'CF7GSC_Google_CustomRichMediaEvents';
  ...
  public $dimensions;
  public $metricNames;
  public function setActivities(CF7GSC_Google_Activities $activities) {
    $this->activities = $activities;
  }
  public function getActivities() {
    return $this->activities;
  }
  public function setCustomRichMediaEvents(CF7GSC_Google_CustomRichMediaEvents $customRichMediaEvents) {
...
class CF7GSC_Google_ReportCrossDimensionReachCriteria extends CF7GSC_Google_Model {
  protected $__breakdownType = 'CF7GSC_Google_SortedDimension';
  ...
  public $pivoted;
  public function setBreakdown(/* array(CF7GSC_Google_SortedDimension) */ $breakdown) {
    $this->assertIsArray($breakdown, 'CF7GSC_Google_SortedDimension', __METHOD__);
...
class CF7GSC_Google_ReportDelivery extends CF7GSC_Google_Model {
  public $emailOwner;
  public $emailOwnerDeliveryType;
  public $message;
  protected $__recipientsType = 'CF7GSC_Google_Recipient';
  ...
  public function setRecipients(/* array(CF7GSC_Google_Recipient) */ $recipients) {
    $this->assertIsArray($recipients, 'CF7GSC_Google_Recipient', __METHOD__);
...
class CF7GSC_Google_ReportFloodlightCriteria extends CF7GSC_Google_Model {
  protected $__dateRangeType = 'CF7GSC_Google_DateRange';
  protected $__dateRangeDataType = '';
  public $dateRange;
  protected $__dimensionFiltersType = 'CF7GSC_Google_DimensionValue';
  ...
  protected $__dimensionsDataType = 'array';
  public $dimensions;
  protected $__floodlightConfigIdType = 'CF7GSC_Google_DimensionValue';
  protected $__floodlightConfigIdDataType = '';
  public $floodlightConfigId;
  public $metricNames;
  protected $__reportPropertiesType = 'CF7GSC_Google_ReportFloodlightCriteriaReportProperties';
  ...
  public function setFloodlightConfigId(CF7GSC_Google_DimensionValue $floodlightConfigId) {
  ...
  public function setReportProperties(CF7GSC_Google_ReportFloodlightCriteriaReportProperties $reportProperties) {
...
class CF7GSC_Google_ReportFloodlightCriteriaReportProperties extends CF7GSC_Google_Model {
...
class CF7GSC_Google_ReportList extends CF7GSC_Google_Model {
  public $etag;
  protected $__itemsType = 'CF7GSC_Google_Report';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $nextPageToken;
  ...
  public function setItems(/* array(CF7GSC_Google_Report) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_Report', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class CF7GSC_Google_ReportPathToConversionCriteria extends CF7GSC_Google_Model {
  protected $__activityFiltersType = 'CF7GSC_Google_DimensionValue';
  protected $__activityFiltersDataType = 'array';
  public $activityFilters;
  protected $__conversionDimensionsType = 'CF7GSC_Google_SortedDimension';
  protected $__conversionDimensionsDataType = 'array';
  public $conversionDimensions;
  protected $__customFloodlightVariablesType = 'CF7GSC_Google_SortedDimension';
  ...
  public $floodlightConfigId;
  public $metricNames;
  protected $__perInteractionDimensionsType = 'CF7GSC_Google_SortedDimension';
  protected $__perInteractionDimensionsDataType = 'array';
  public $perInteractionDimensions;
  protected $__reportPropertiesType = 'CF7GSC_Google_ReportPathToConversionCriteriaReportProperties';
  protected $__reportPropertiesDataType = '';
  public $reportProperties;
  public function setActivityFilters(/* array(CF7GSC_Google_DimensionValue) */ $activityFilters) {
    $this->assertIsArray($activityFilters, 'CF7GSC_Google_DimensionValue', __METHOD__);
    $this->activityFilters = $activityFilters;
  }
  public function getActivityFilters() {
    return $this->activityFilters;
  }
  public function setConversionDimensions(/* array(CF7GSC_Google_SortedDimension) */ $conversionDimensions) {
    $this->assertIsArray($conversionDimensions, 'CF7GSC_Google_SortedDimension', __METHOD__);
    $this->conversionDimensions = $conversionDimensions;
  }
  public function getConversionDimensions() {
    return $this->conversionDimensions;
  }
  public function setCustomFloodlightVariables(/* array(CF7GSC_Google_SortedDimension) */ $customFloodlightVariables) {
    $this->assertIsArray($customFloodlightVariables, 'CF7GSC_Google_SortedDimension', __METHOD__);
  ...
  public function setPerInteractionDimensions(/* array(CF7GSC_Google_SortedDimension) */ $perInteractionDimensions) {
    $this->assertIsArray($perInteractionDimensions, 'CF7GSC_Google_SortedDimension', __METHOD__);
    $this->perInteractionDimensions = $perInteractionDimensions;
  }
  public function getPerInteractionDimensions() {
    return $this->perInteractionDimensions;
  }
  public function setReportProperties(CF7GSC_Google_ReportPathToConversionCriteriaReportProperties $reportProperties) {
    $this->reportProperties = $reportProperties;
  }
  public function getReportProperties() {
    return $this->reportProperties;
...
class CF7GSC_Google_ReportPathToConversionCriteriaReportProperties extends CF7GSC_Google_Model {
...
class CF7GSC_Google_ReportReachCriteria extends CF7GSC_Google_Model {
  protected $__activitiesType = 'CF7GSC_Google_Activities';
  protected $__activitiesDataType = '';
  public $activities;
  protected $__customRichMediaEventsType = 'CF7GSC_Google_CustomRichMediaEvents';
...
class CF7GSC_Google_ReportSchedule extends CF7GSC_Google_Model {
  public $active;
  public $every;
...
class CF7GSC_Google_SortedDimension extends CF7GSC_Google_Model {
  public $kind;
  public $name;
  public $sortOrder;
  public function setKind($kind) {
...
class CF7GSC_Google_UserProfile extends CF7GSC_Google_Model {
  public $accountId;
  public $accountName;
  public $etag;
  public $kind;
...
class CF7GSC_Google_UserProfileList extends CF7GSC_Google_Model {
  public $etag;
  protected $__itemsType = 'CF7GSC_Google_UserProfile';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setEtag($etag) {
  ...
  public function setItems(/* array(CF7GSC_Google_UserProfile) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_UserProfile', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
