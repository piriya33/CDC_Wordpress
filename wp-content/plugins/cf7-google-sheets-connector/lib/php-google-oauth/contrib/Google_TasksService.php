 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $tasksService = new CF7GSC_Google_TasksService(...);
   *   $tasks = $tasksService->tasks;
   *  </code>
   */
  class CF7GSC_Google_TasksServiceResource extends CF7GSC_Google_ServiceResource {
     ...
     * @param CF7GSC_Google_Task $postBody
     ...
     * @return CF7GSC_Google_Task
     */
    public function insert($tasklist, CF7GSC_Google_Task $postBody, $optParams = array()) {
      $params = array('tasklist' => $tasklist, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_Task($data);
      } else {
        return $data;
      }
    }
    ...
    public function listTasks($tasklist, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new CF7GSC_Google_Tasks($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CF7GSC_Google_Task
     */
    public function update($tasklist, $task, CF7GSC_Google_Task $postBody, $optParams = array()) {
     ...
     * @return CF7GSC_Google_Task
     */
    public function patch($tasklist, $task, CF7GSC_Google_Task $postBody, $optParams = array()) {
      $params = array('tasklist' => $tasklist, 'task' => $task, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class CF7GSC_Google_TasklistsServiceResource extends CF7GSC_Google_ServiceResource {


    /**
     * Creates a new task list and adds it to the authenticated user's task lists. (tasklists.insert)
     *
     * @param CF7GSC_Google_TaskList $postBody
     * @param array $optParams Optional parameters.
     * @return CF7GSC_Google_TaskList
     */
    public function insert(CF7GSC_Google_TaskList $postBody, $optParams = array()) {
      $params = array('postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_TaskList($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string pageToken Token specifying the result page to return. Optional.
     * @opt_param string maxResults Maximum number of task lists returned on one page. Optional. The default is 100.
     * @return CF7GSC_Google_TaskLists
     */
    public function listTasklists($optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new CF7GSC_Google_TaskLists($data);
      } else {
        return $data;
      }
    }
     ...
     * @return CF7GSC_Google_TaskList
     */
    public function update($tasklist, CF7GSC_Google_TaskList $postBody, $optParams = array()) {
      $params = array('tasklist' => $tasklist, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('update', array($params));
      if ($this->useObjects()) {
     ...
     * @return CF7GSC_Google_TaskList
     */
    public function patch($tasklist, CF7GSC_Google_TaskList $postBody, $optParams = array()) {
      $params = array('tasklist' => $tasklist, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
...
/**
 * Service definition for CF7GSC_Google_Tasks (v1).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class CF7GSC_Google_TasksService extends CF7GSC_Google_Service {
  public $tasks;
  public $tasklists;
  /**
...
class CF7GSC_Google_Task extends CF7GSC_Google_Model {
  ...
  public function setLinks(/* array(CF7GSC_Google_TaskLinks) */ $links) {
    $this->assertIsArray($links, 'CF7GSC_Google_TaskLinks', __METHOD__);
    $this->links = $links;
  }
...
class CF7GSC_Google_TaskLinks extends CF7GSC_Google_Model {
  public $type;
  public $link;
  public $description;
...
class CF7GSC_Google_TaskList extends CF7GSC_Google_Model {
  public $kind;
  public $title;
  public $updated;
  public $etag;
...
class CF7GSC_Google_TaskLists extends CF7GSC_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CF7GSC_Google_TaskList';
  ...
  public function setItems(/* array(CF7GSC_Google_TaskList) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_TaskList', __METHOD__);
    $this->items = $items;
  }
...
class CF7GSC_Google_Tasks extends CF7GSC_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'CF7GSC_Google_Task';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $etag;
  ...
  public function setItems(/* array(CF7GSC_Google_Task) */ $items) {
    $this->assertIsArray($items, 'CF7GSC_Google_Task', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
